                ...
                <td className="align-middle w-80">
                    {this.state.renaming ? (
                        <React.Fragment>
                            ...
                            <React.Fragment>
                                <Link to={Hrefs.worksheetState(new WorksheetStateMark({ worksheetStateId: this.props.worksheetStateId }))} title="Open this worksheet">{this.props.worksheetState.id.toString()}</Link>
