...
export class WorksheetStateMark {
    ...
    static fromThryftJsonObject(json: any): WorksheetStateMark {
        var worksheetStateId: WorksheetStateId | undefined;
        var featureId: WorksheetFeatureId | undefined;
        var featureSetId: WorksheetFeatureSetId | undefined;
        var review: boolean | undefined;
