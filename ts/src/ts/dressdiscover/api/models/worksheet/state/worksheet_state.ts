...
export class WorksheetState {
    constructor(kwds: {ctime: Date, featureSets: WorksheetFeatureSetState[], id: WorksheetStateId, mtime: Date, text?: string}) {
    ...
    public deepCopy(): WorksheetState {
        return new WorksheetState({ ctime: this.ctime, featureSets: (this.featureSets).map((value0) => value0.deepCopy()), id: this.id, mtime: this.mtime, text: this.text });
    }
    ...
    public toJsonObject(): {ctime: number, feature_sets: Array<{features: Array<{id: string, selected_value_ids: Array<string> | undefined, text: string | undefined}>, id: string}>, id: string, mtime: number, text: string | undefined} {
        return {
    ...
    public toThryftJsonObject(): {ctime: number, feature_sets: Array<{features: Array<{id: string, selected_value_ids: Array<string> | undefined, text: string | undefined}>, id: string}>, id: string, mtime: number, text: string | undefined} {
        return {
            ctime: this.ctime.getTime(),
