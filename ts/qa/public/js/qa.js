...
/***/ function(module, exports, __webpack_require__) {
	...
	var session_1 = __webpack_require__(72);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var user_id_input_view_1 = __webpack_require__(69);
	var Router = (function () {
	    function Router() {
	        this._sammy = Sammy();
	        var self = this;
	    ...
	    Router.prototype.onGetQuestion = function (context) {
	        this.checkAuthentication(function () {
	            ...
	            var object = application_1.Application.instance.services.objectQueryService.getObjectByIdSync({ id: objectId });
	            var questionSet = application_1.Application.instance.services.questionSetQueryService.getQuestionSetsSync({ ids: [questionSetId] })[0];
	            var questions = application_1.Application.instance.services.questionQueryService.getQuestionsSync({ ids: questionSet.questionIds });
	            var currentQuestion;
	            if (context.params.questionId) {
	                var currentQuestionId = question_id_1.QuestionId.parse(context.params.questionId);
	                currentQuestion = application_1.Application.instance.services.questionQueryService.getQuestionsSync({ ids: [currentQuestionId] })[0];
	            }
	    ...
	    Router.prototype.onGetRoot = function (context) {
	        this.checkAuthentication(function () {
	            var objects = application_1.Application.instance.services.objectQueryService.getObjectsSync();
	            var questionSetIds = {};
	            ...
	            var questionSets = application_1.Application.instance.services.questionSetQueryService.getQuestionSetsSync({ ids: _.values(questionSetIds) });
...
/***/ function(module, exports) {
	...
	(function (QuestionType) {
	    QuestionType[QuestionType["DATE_RANGE"] = 0] = "DATE_RANGE";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var answer_value_1 = __webpack_require__(66);
	var application_1 = __webpack_require__(1);
	var question_type_1 = __webpack_require__(61);
	var view_model_1 = __webpack_require__(13);
	var QuestionViewModel = (function (_super) {
	    ...
	    function QuestionViewModel(object, questionSet, questions, currentQuestion) {
	        ...
	        _this.selectedValueI32s = ko.observableArray();
	        _this.selectedValueIds = ko.observableArray();
	        _this._currentQuestionValueRange = [];
	        if (currentQuestion) {
	            ...
	            if (currentQuestion.valueRange) {
	                for (var i = currentQuestion.valueRange.start; i < currentQuestion.valueRange.stop; i += currentQuestion.valueRange.step) {
	                    _this._currentQuestionValueRange.push({ i32: currentQuestion.valueRange.step > 1 ? (i + currentQuestion.valueRange.step / 2) : i, text: i + "-" + (i + currentQuestion.valueRange.step) });
	                }
	            }
	        }
	        return _this;
	    ...
	    Object.defineProperty(QuestionViewModel.prototype, "currentQuestionValueRange", {
	        get: function () {
	    ...
	    QuestionViewModel.prototype.onClickNextButton = function () {
	        var _this = this;
	        this._submit(function () { return _this._goToNext(); });
	        return false;
	    };
	    ...
	    QuestionViewModel.prototype.onClickPreviousQuestionButton = function () {
	        var _this = this;
	        this._submit(function () { return _this._goToPreviousQuestion(); });
	        return false;
	    };
	    ...
	    QuestionViewModel.prototype._submit = function (complete) {
	        if (!this.currentQuestion) {
	            return;
	        }
	        var values = [];
	        switch (this.currentQuestion.type_) {
	            case question_type_1.QuestionType.DATE_RANGE:
	                {
	                    if (this.selectedValueI32s().length == 0) {
	                        return;
	                    }
	                    for (var _i = 0, _a = this.selectedValueI32s(); _i < _a.length; _i++) {
	                        var selectedValueI32 = _a[_i];
	                        values.push(new answer_value_1.AnswerValue({ valueI32: selectedValueI32 }));
	                    }
	                }
	                break;
	            case question_type_1.QuestionType.SELECT_MULTIPLE:
	            case question_type_1.QuestionType.SELECT_ONE:
	                {
	                    if (this.selectedValueIds().length == 0) {
	                        return;
	                    }
	                    for (var _b = 0, _c = this.selectedValueIds(); _b < _c.length; _b++) {
	                        var selectedValueId = _c[_b];
	                        values.push(new answer_value_1.AnswerValue({ valueId: selectedValueId }));
	                    }
	                }
	                break;
	            case question_type_1.QuestionType.TEXT:
	                {
	                    ...
	                    values.push(new answer_value_1.AnswerValue({ valueString: answerText }));
	                }
	                break;
	            default:
	                throw new Error("not implemented: " + this.currentQuestionType);
	        }
	        var answer = new answer_1.Answer({ objectId: this.object.id, questionId: this.currentQuestion.id, userId: application_1.Application.instance.session.currentUserId, values: values });
	        application_1.Application.instance.services.answerCommandService.putAnswerAsync({
	            answer: answer
	        });
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var answer_value_1 = __webpack_require__(66);
	var qa_object_id_1 = __webpack_require__(57);
	var qa_user_id_1 = __webpack_require__(68);
	var question_id_1 = __webpack_require__(58);
	var Answer = (function () {
	    ...
	    Object.defineProperty(Answer.prototype, "values", {
	        get: function () {
	            return this._values;
	        },
	        set: function (values) {
	        ...
	        for (var fieldName in json) {
	            if (fieldName == "object_id") {
	                ...
	                values = function (json) { var sequence = []; for (var i = 0; i < json.length; i++) {
	                    sequence.push(answer_value_1.AnswerValue.fromThryftJSON(json[i]));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AnswerValue = (function () {
	    function AnswerValue(kwds) {
	        this.valueI32 = kwds.valueI32;
	        this.valueId = kwds.valueId;
	        this.valueString = kwds.valueString;
	    }
	    Object.defineProperty(AnswerValue.prototype, "valueI32", {
	        get: function () {
	            return this._valueI32;
	        },
	        set: function (valueI32) {
	            if (valueI32 != null) {
	            }
	    ...
	    Object.defineProperty(AnswerValue.prototype, "valueId", {
	        get: function () {
	            return this._valueId;
	        },
	        set: function (valueId) {
	            if (valueId != null) {
	            }
	    ...
	    Object.defineProperty(AnswerValue.prototype, "valueString", {
	        get: function () {
	            return this._valueString;
	        },
	        set: function (valueString) {
	            if (valueString != null) {
	    ...
	    AnswerValue.fromThryftJSON = function (json) {
	        var valueI32;
	        var valueId;
	        var valueString;
	        for (var fieldName in json) {
	            if (fieldName == "value_i32") {
	                ...
	                valueId = question_value_id_1.QuestionValueId.parse(json[fieldName]);
	            }
	    ...
	    AnswerValue.prototype.toThryftJSON = function () {
	        var json = {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var modal_view_1 = __webpack_require__(70);
	var user_id_input_view_model_1 = __webpack_require__(71);
	var UserIdInputView = (function (_super) {
	    __extends(UserIdInputView, _super);
	    function UserIdInputView(onHide) {
	        return _super.call(this, "user_id_input_view.html", new user_id_input_view_model_1.UserIdInputViewModel(onHide)) || this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var json_rpc_answer_command_service_1 = __webpack_require__(74);
	var json_rpc_answer_Query_service_1 = __webpack_require__(75);
	var local_qa_object_query_service_1 = __webpack_require__(76);
	var local_question_query_service_1 = __webpack_require__(82);
	var local_question_set_query_service_1 = __webpack_require__(88);
	var Services = (function () {
	    function Services() {
	        this._answerCommandService = new json_rpc_answer_command_service_1.JsonRpcAnswerCommandService("http://api.dressdiscover.org");
	        this._answerQueryService = new json_rpc_answer_Query_service_1.JsonRpcAnswerQueryService("http://api.dressdiscover.org");
	        this._objectQueryService = new local_qa_object_query_service_1.LocalQaObjectQueryService();
	        this._questionQueryService = new local_question_query_service_1.LocalQuestionQueryService();
	        this._questionSetQueryService = new local_question_set_query_service_1.LocalQuestionSetQueryService();
	    }
	    Object.defineProperty(Services.prototype, "answerCommandService", {
	        get: function () {
	    ...
	    Object.defineProperty(Services.prototype, "answerQueryService", {
	        get: function () {
	    ...
	    Object.defineProperty(Services.prototype, "objectQueryService", {
	        get: function () {
	    ...
	    Object.defineProperty(Services.prototype, "questionQueryService", {
	        get: function () {
	    ...
	    Object.defineProperty(Services.prototype, "questionSetQueryService", {
	        get: function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {"use strict";
	var JsonRpcAnswerCommandService = (function () {
	    function JsonRpcAnswerCommandService(baseUrl) {
	        this.baseUrl = baseUrl;
	    }
	    JsonRpcAnswerCommandService.prototype.putAnswerAsync = function (kwds) {
	        ...
	        $.ajax({
	            ...
	            error: function (jqXHR, textStatus, errorThrown) {
	                if (kwds.error) {
	                    kwds.error({ jqXHR: jqXHR, textStatus: textStatus, errorThrown: errorThrown });
	                }
	            },
	    ...
	    JsonRpcAnswerCommandService.prototype.putAnswerSync = function (kwds) {
	        var __jsonrpc_params = {};
	        __jsonrpc_params["answer"] = kwds.answer.toThryftJSON();
	        $.ajax({
	            async: false,
	    ...
	    return JsonRpcAnswerCommandService;
	}());
	exports.JsonRpcAnswerCommandService = JsonRpcAnswerCommandService;
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {"use strict";
	var answer_1 = __webpack_require__(65);
	var JsonRpcAnswerQueryService = (function () {
	    function JsonRpcAnswerQueryService(baseUrl) {
	        this.baseUrl = baseUrl;
	    }
	    JsonRpcAnswerQueryService.prototype.getAnswersAsync = function (kwds) {
	        var __jsonrpc_params = {};
	        ...
	        if (typeof kwds.questionIds !== "undefined") {
	            __jsonrpc_params["question_ids"] = function (__inArray) { var __outArray = []; for (var __i = 0; __i < __inArray.length; __i++) {
	                __outArray.push(__inArray[__i].toString());
	            } return __outArray; }(kwds.questionIds);
	        }
	                ...
	                if (typeof data.result !== "undefined") {
	                    if (kwds.success) {
	                        kwds.success(function (json) { var sequence = []; for (var i = 0; i < json.length; i++) {
	                            sequence.push(answer_1.Answer.fromThryftJSON(json[i]));
	                        } return sequence; }(data.result));
	                    }
	                }
	                else {
	                    if (kwds.error) {
	    ...
	    JsonRpcAnswerQueryService.prototype.getAnswersSync = function (kwds) {
	        var __jsonrpc_params = {};
	        __jsonrpc_params["object_id"] = kwds.objectId.toString();
	        __jsonrpc_params["question_set_id"] = kwds.questionSetId.toString();
	        if (typeof kwds.questionIds !== "undefined") {
	    ...
	    return JsonRpcAnswerQueryService;
	}());
	exports.JsonRpcAnswerQueryService = JsonRpcAnswerQueryService;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var no_such_object_exception_1 = __webpack_require__(77);
	var qa_object_1 = __webpack_require__(78);
	var async_to_sync_qa_object_query_service_1 = __webpack_require__(81);
	var LocalQaObjectQueryService = (function (_super) {
	    __extends(LocalQaObjectQueryService, _super);
	    function LocalQaObjectQueryService() {
	        var _this = _super.call(this) || this;
	        _this._objects = [];
	        _this._objectsById = {};
	        for (var _i = 0, OBJECTS_1 = OBJECTS; _i < OBJECTS_1.length; _i++) {
	    ...
	    LocalQaObjectQueryService.prototype.getObjectByIdSync = function (kwds) {
	    ...
	    LocalQaObjectQueryService.prototype.getObjectsSync = function () {
	        return this._objects;
	    };
	    return LocalQaObjectQueryService;
	}(async_to_sync_qa_object_query_service_1.AsyncToSyncQaObjectQueryService));
	exports.LocalQaObjectQueryService = LocalQaObjectQueryService;
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var qa_image_1 = __webpack_require__(79);
	var qa_object_id_1 = __webpack_require__(57);
	var question_set_id_1 = __webpack_require__(59);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var qa_image_rights_1 = __webpack_require__(80);
...
/***/ function(module, exports) {
	...
	"use strict";
	var AsyncToSyncQaObjectQueryService = (function () {
	    function AsyncToSyncQaObjectQueryService() {
	    }
	    AsyncToSyncQaObjectQueryService.prototype.getObjectByIdAsync = function (kwds) {
	        try {
	            if (kwds.success) {
	    ...
	    AsyncToSyncQaObjectQueryService.prototype.getObjectsAsync = function (kwds) {
	        try {
	            if (kwds.success) {
	    ...
	    return AsyncToSyncQaObjectQueryService;
	}());
	exports.AsyncToSyncQaObjectQueryService = AsyncToSyncQaObjectQueryService;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var no_such_question_exception_1 = __webpack_require__(83);
	var question_1 = __webpack_require__(84);
	var async_to_sync_question_query_service_1 = __webpack_require__(87);
	var LocalQuestionQueryService = (function (_super) {
	    __extends(LocalQuestionQueryService, _super);
	    function LocalQuestionQueryService() {
	        var _this = _super.call(this) || this;
	        _this._questionsById = {};
	        for (var _i = 0, QUESTIONS_1 = QUESTIONS; _i < QUESTIONS_1.length; _i++) {
	            var questionJson = QUESTIONS_1[_i];
	            var question = question_1.Question.fromThryftJSON(questionJson);
	            _this._questionsById[question.id.toString()] = question;
	        }
	        return _this;
	    }
	    LocalQuestionQueryService.prototype.getQuestionsSync = function (kwds) {
	        var result = [];
	    ...
	    return LocalQuestionQueryService;
	}(async_to_sync_question_query_service_1.AsyncToSyncQuestionQueryService));
	exports.LocalQuestionQueryService = LocalQuestionQueryService;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var question_id_1 = __webpack_require__(58);
	var question_type_1 = __webpack_require__(61);
	var question_value_1 = __webpack_require__(85);
	var question_value_range_1 = __webpack_require__(86);
	var Question = (function () {
	    ...
	    Object.defineProperty(Question.prototype, "valueRange", {
	        get: function () {
	    ...
	    Question.fromThryftJSON = function (json) {
	        ...
	        for (var fieldName in json) {
	            if (fieldName == "id") {
	                ...
	                valueRange = question_value_range_1.QuestionValueRange.fromThryftJSON(json[fieldName]);
	            }
	            else if (fieldName == "values") {
	                values = function (json) { var sequence = []; for (var i = 0; i < json.length; i++) {
...
/***/ function(module, exports) {
	...
	"use strict";
	var QuestionValueRange = (function () {
	    function QuestionValueRange(kwds) {
	        this.start = kwds.start;
	        this.step = kwds.step;
	        this.stop = kwds.stop;
	    }
	    Object.defineProperty(QuestionValueRange.prototype, "start", {
	        get: function () {
	            return this._start;
	        },
	        set: function (start) {
	    ...
	    Object.defineProperty(QuestionValueRange.prototype, "step", {
	        get: function () {
	            return this._step;
	        },
	        set: function (step) {
	    ...
	    Object.defineProperty(QuestionValueRange.prototype, "stop", {
	        get: function () {
	            return this._stop;
	        },
	        set: function (stop) {
	    ...
	    QuestionValueRange.fromThryftJSON = function (json) {
	        var start;
	        var step;
	        var stop;
	        for (var fieldName in json) {
	    ...
	    QuestionValueRange.prototype.toThryftJSON = function () {
	        var json = {};
	    ...
	    return QuestionValueRange;
	}());
	exports.QuestionValueRange = QuestionValueRange;
...
/***/ function(module, exports) {
	...
	"use strict";
	var AsyncToSyncQuestionQueryService = (function () {
	    function AsyncToSyncQuestionQueryService() {
	    }
	    AsyncToSyncQuestionQueryService.prototype.getQuestionsAsync = function (kwds) {
	        try {
	            if (kwds.success) {
	    ...
	    return AsyncToSyncQuestionQueryService;
	}());
	exports.AsyncToSyncQuestionQueryService = AsyncToSyncQuestionQueryService;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var no_such_question_set_exception_1 = __webpack_require__(89);
	var question_set_1 = __webpack_require__(90);
	var async_to_sync_question_set_query_service_1 = __webpack_require__(91);
	var LocalQuestionSetQueryService = (function (_super) {
	    __extends(LocalQuestionSetQueryService, _super);
	    function LocalQuestionSetQueryService() {
	        var _this = _super.call(this) || this;
	        _this._questionSetsById = {};
	        for (var _i = 0, QUESTION_SETS_1 = QUESTION_SETS; _i < QUESTION_SETS_1.length; _i++) {
	            var questionSetJson = QUESTION_SETS_1[_i];
	    ...
	    LocalQuestionSetQueryService.prototype.getQuestionSetsSync = function (kwds) {
	        var result = [];
	        for (var _i = 0, _a = kwds.ids; _i < _a.length; _i++) {
	            var id = _a[_i];
	    ...
	    return LocalQuestionSetQueryService;
	}(async_to_sync_question_set_query_service_1.AsyncToSyncQuestionSetQueryService));
	exports.LocalQuestionSetQueryService = LocalQuestionSetQueryService;
...
/***/ function(module, exports) {
	...
	"use strict";
	var AsyncToSyncQuestionSetQueryService = (function () {
	    function AsyncToSyncQuestionSetQueryService() {
	    }
	    AsyncToSyncQuestionSetQueryService.prototype.getQuestionSetsAsync = function (kwds) {
	        try {
	            if (kwds.success) {
	    ...
	    return AsyncToSyncQuestionSetQueryService;
	}());
	exports.AsyncToSyncQuestionSetQueryService = AsyncToSyncQuestionSetQueryService;
