...
export class WorksheetState {
    ...
    deepCopy(): WorksheetState {
        return new WorksheetState({ featureSets: function(__value0: WorksheetFeatureSetState[]) { let __copy0: WorksheetFeatureSetState[] = []; for (var __i0 = 0; __i0 < __value0.length; __i0++) { __copy0.push(__value0[__i0].deepCopy()); } return __copy0; }(this.featureSets), id: this.id, text: this.text });
    }
