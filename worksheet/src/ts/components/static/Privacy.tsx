...
export class Privacy extends React.Component {
  render() {
    return (
      <Frame activeNavItem={ActiveNavbarItem.Home} id="privacy">
        <Container fluid>
          <Row>
            <Col md="12">
                ...
                <CardBody>
                  <Container fluid>
                    <p>
                      ...
                      DressDiscover (https://dressdiscover.org). This privacy
                      notice applies solely to information collected by this
                      website.
                    </p>
                    ...
                    <p>
                      Wherever we collect sensitive information such as your
                      account password, that information is encrypted and
