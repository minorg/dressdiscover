...
export class WorksheetFeatureValueDefinition {
  constructor(kwds: {
    ...
    id: WorksheetFeatureValueId;
    description?: WorksheetDescription;
    image?: WorksheetFeatureValueImage;
  }) {
    this.displayNameEn = WorksheetFeatureValueDefinition.validateDisplayNameEn(
      kwds.displayNameEn
    );
  ...
  public deepCopy(): WorksheetFeatureValueDefinition {
    return new WorksheetFeatureValueDefinition({
      ...
      image: this.image ? this.image.deepCopy() : undefined,
    });
  }
  ...
  public equals(other: WorksheetFeatureValueDefinition): boolean {
    ...
    if (
      ...
      !(typeof other.image === "undefined")
        ? (this.image as WorksheetFeatureValueImage).equals(
            other.image as WorksheetFeatureValueImage
          )
        : typeof this.image === "undefined" &&
          typeof other.image === "undefined")
    ) {
  ...
  public static fromThryftJsonObject(
    json: any
    ...
    for (const fieldName in json) {
      if (fieldName === "display_name_en") {
        ...
        image = WorksheetFeatureValueImage.fromThryftJsonObject(
          json[fieldName]
        );
      }
    }
