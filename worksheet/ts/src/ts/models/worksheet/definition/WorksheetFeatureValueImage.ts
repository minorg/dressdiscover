...
export class WorksheetFeatureValueImage {
  constructor(kwds: {
    rights: WorksheetRights;
    thumbnailUrl: WorksheetFeatureValueImageUrl;
    fullSizeUrl?: WorksheetFeatureValueImageUrl;
  }) {
    this.rights = WorksheetFeatureValueImage.validateRights(kwds.rights);
    this.thumbnailUrl = WorksheetFeatureValueImage.validateThumbnailUrl(
      kwds.thumbnailUrl
    );
  ...
  public deepCopy(): WorksheetFeatureValueImage {
    return new WorksheetFeatureValueImage({
      rights: this.rights.deepCopy(),
      thumbnailUrl: this.thumbnailUrl.deepCopy(),
      fullSizeUrl: this.fullSizeUrl ? this.fullSizeUrl.deepCopy() : undefined,
    });
  }
  ...
  public equals(other: WorksheetFeatureValueImage): boolean {
    ...
    if (
      !(!(typeof this.fullSizeUrl === "undefined") &&
      !(typeof other.fullSizeUrl === "undefined")
        ? (this.fullSizeUrl as WorksheetFeatureValueImageUrl).equals(
            other.fullSizeUrl as WorksheetFeatureValueImageUrl
          )
        : typeof this.fullSizeUrl === "undefined" &&
          typeof other.fullSizeUrl === "undefined")
    ) {
  ...
  public static fromThryftJsonObject(json: any): WorksheetFeatureValueImage {
    ...
    for (const fieldName in json) {
      if (fieldName === "rights") {
        ...
        thumbnailUrl = WorksheetFeatureValueImageUrl.fromThryftJsonObject(
          json[fieldName]
        );
      } else if (fieldName === "full_size_url") {
        fullSizeUrl = WorksheetFeatureValueImageUrl.fromThryftJsonObject(
          json[fieldName]
        );
      }
    }
  ...
  public toJsonObject(): {
    ...
    thumbnail_url: {absolute: string | undefined; relative: string | undefined};
  } {
    return {
      full_size_url:
        this.fullSizeUrl != null ? this.fullSizeUrl.toJsonObject() : undefined,
    ...
    return {
      full_size_url:
        this.fullSizeUrl != null
          ? this.fullSizeUrl.toThryftJsonObject()
          : undefined,
  ...
  private static validateThumbnailUrl(
    thumbnailUrl: WorksheetFeatureValueImageUrl
