...
> {
  constructor(props: Props) {
    super(props);
    this.onChangeNewWorksheetStateId = this.onChangeNewWorksheetStateId.bind(
      this
    );
    this.onKeypressNewWorksheetStateId = this.onKeypressNewWorksheetStateId.bind(
      this
    );
  ...
  onChangeNewWorksheetStateId(event: React.ChangeEvent<HTMLInputElement>) {
    ...
    this.setState((prevState) =>
      Object.assign({}, prevState, {newWorksheetStateId: value})
    );
  }
  ...
  onSubmit() {
    ...
    while (
      this.props.existingWorksheetStateIds.some(
        (existingWorksheetStateId) =>
          existingWorksheetStateId.toString() === newWorksheetStateId
      )
    ) {
      newWorksheetStateId =
                ...
                <Row>
                  <Col xs="10">
                    <Input
                      ...
                      onChange={this.onChangeNewWorksheetStateId}
                      onKeyPress={this.onKeypressNewWorksheetStateId}
                      placeholder="Object id or accession number (optional)"
                      type="text"
                      value={this.state.newWorksheetStateId}
                    />
                  </Col>
                  <Col xs="2">
