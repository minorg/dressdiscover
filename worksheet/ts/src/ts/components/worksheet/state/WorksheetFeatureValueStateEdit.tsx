  ...
  if (definition.image && definition.image.thumbnailUrl) {
    if (definition.image.thumbnailUrl.absolute) {
      ...
      thumbnailImgSrc =
        ...
        "/img/worksheet/" +
        definition.image.thumbnailUrl.relative;
    }
  }
  if (!thumbnailImgSrc) {
  ...
  return (
    <Card
      className={classnames({
        ...
        "mb-4": true,
        "mr-4": true,
        "worksheet-feature-value-state": true,
      })}
    >
      <CardHeader>
        <Button color="link" onClick={onToggleSelectedWrapper}>
            ...
            >
              ...
              <span>
                <WorksheetRightsLicenseComponent
                  license={definition.image.rights.license}
                ></WorksheetRightsLicenseComponent>
              </span>
            </figcaption>
          ) : null}
