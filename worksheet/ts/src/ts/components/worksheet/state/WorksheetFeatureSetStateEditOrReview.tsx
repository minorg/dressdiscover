...
export class WorksheetFeatureSetStateEditOrReview extends React.Component<
    ...
    return (
      <WorksheetStateGetter
        ...
        render={(worksheetState) => (
          <WorksheetFeatureSetStateEditOrReviewImpl
            history={this.props.history}
...
class WorksheetFeatureSetStateEditOrReviewImpl extends React.Component<{
  history: History;
    ...
    return (
      ...
      >
        ...
        <WorksheetFeatureSetStateTable
          featureSetDefinition={worksheetState.currentFeatureSetDefinition!}
          featureSetState={worksheetState.currentFeatureSetState}
          includeFeatureDescriptions={!worksheetState.currentStateMark.review}
          worksheetState={worksheetState}
        />
      </WorksheetStateFrame>
    );
