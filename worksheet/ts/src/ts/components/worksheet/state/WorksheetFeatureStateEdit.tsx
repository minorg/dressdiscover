...
export class WorksheetFeatureStateEdit extends React.Component<
  ...
  render() {
    return (
      <WorksheetStateGetter
        ...
        render={(worksheetState) => (
          <WorksheetFeatureStateEditImpl
            history={this.props.history}
...
class WorksheetFeatureStateEditImpl extends React.Component<
  WorksheetFeatureStateEditImplProps
> {
  ...
  onToggleFeatureValue(featureValueId: string) {
    ...
    let selectedValueIds =
      ...
      featureState.selectedValueIds.length
        ? featureState.selectedValueIds
        : undefined;
    if (!selectedValueIds) {
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Container fluid>
          <Row>
            {worksheetState.currentFeatureDefinition!.values.map(
