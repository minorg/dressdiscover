...
export class UserSettingsComponent extends React.Component<Props, State> {
  constructor(props: Props) {
    super(props);
    this.onChangeWorksheetConfiguration = this.onChangeWorksheetConfiguration.bind(
      this
    );
  ...
  onChangeWorksheetConfiguration(
    newWorksheetConfiguration: WorksheetConfiguration
  ) {
    this.setState((prevState) => ({
      unsavedWorksheetConfiguration: newWorksheetConfiguration,
    }));
  }
  ...
  onClickSaveButton() {
    ...
    this.props.currentUserStore.setCurrentUserSettings({
      worksheetConfiguration: unsavedWorksheetConfiguration,
    });
