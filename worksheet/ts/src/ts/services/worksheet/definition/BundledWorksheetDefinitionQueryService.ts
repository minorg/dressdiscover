...
export class BundledWorksheetDefinitionQueryService
  implements WorksheetDefinitionQueryService {
  ...
  constructor() {
    this._worksheetDefinition = new WorksheetDefinitionValidator().validateWorksheetDefinition(
      new WorksheetDefinitionCsvParser().parseWorksheetDefinitionCsv({
