...
public class UserBookmarkEntry implements org.thryft.Struct, org.thryft.waf.api.models.ModelEntry<net.lab1318.costume.api.models.user.UserBookmark, net.lab1318.costume.api.models.user.UserBookmarkId> {
    public static class Builder {
        ...
        protected UserBookmarkEntry _build(final net.lab1318.costume.api.models.user.UserBookmarkId id, final net.lab1318.costume.api.models.user.UserBookmark model) {
            return new UserBookmarkEntry(id, model);
        }

        public UserBookmarkEntry build() {
            return _build(com.google.common.base.Preconditions.checkNotNull(id, "net.lab1318.costume.api.models.user.UserBookmarkEntry: missing id"), com.google.common.base.Preconditions.checkNotNull(model, "net.lab1318.costume.api.models.user.UserBookmarkEntry: missing model"));
        }
        ...
        public final net.lab1318.costume.api.models.user.UserBookmark getModel() {
            return model;
        }
        ...
        public Builder readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
            ...
            model = net.lab1318.costume.api.models.user.UserBookmark.readAsStruct(iprot);
            iprot.readListEnd();
            return this;
        }
        ...
        public Builder setModel(final net.lab1318.costume.api.models.user.UserBookmark model) {
        ...
        public Builder set(final String name, @javax.annotation.Nullable final java.lang.Object value) {
            ...
            case "model": setModel((net.lab1318.costume.api.models.user.UserBookmark)value); return this;
            default:
        ...
        private net.lab1318.costume.api.models.user.UserBookmark model;
    }
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        ...
        MODEL("model", new com.google.common.reflect.TypeToken<net.lab1318.costume.api.models.user.UserBookmark>() {}, true, 0, "model", org.thryft.protocol.Type.STRUCT);
     ...
     */
    public UserBookmarkEntry(final net.lab1318.costume.api.models.user.UserBookmarkId id, final net.lab1318.costume.api.models.user.UserBookmark model) {
        this.id = com.google.common.base.Preconditions.checkNotNull(id, "net.lab1318.costume.api.models.user.UserBookmarkEntry: missing id");
        this.model = com.google.common.base.Preconditions.checkNotNull(model, "net.lab1318.costume.api.models.user.UserBookmarkEntry: missing model");
    }
    ...
    public static UserBookmarkEntry readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
        ...
        net.lab1318.costume.api.models.user.UserBookmark model = null;
    ...
    public UserBookmarkEntry replaceId(final net.lab1318.costume.api.models.user.UserBookmarkId id) {
        return new UserBookmarkEntry(id, this.model);
    }

    public UserBookmarkEntry replaceModel(final net.lab1318.costume.api.models.user.UserBookmark model) {
    ...
    public void writeAsStruct(final org.thryft.protocol.OutputProtocol oprot) throws org.thryft.protocol.OutputProtocolException {
        oprot.writeStructBegin("net.lab1318.costume.api.models.user.UserBookmarkEntry");
        writeFields(oprot);
    ...
    private final net.lab1318.costume.api.models.user.UserBookmark model;
}
