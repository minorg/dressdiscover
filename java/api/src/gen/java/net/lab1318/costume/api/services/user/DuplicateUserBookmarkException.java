...
public class DuplicateUserBookmarkException extends org.thryft.Exception {
    public static class Builder {
        ...
        public DuplicateUserBookmarkException build() {
            return _build(com.google.common.base.Preconditions.checkNotNull(causeMessage, "net.lab1318.costume.api.services.user.DuplicateUserBookmarkException: missing causeMessage"));
        }
    ...
    public DuplicateUserBookmarkException(final String causeMessage) {
        this.causeMessage = com.google.common.base.Preconditions.checkNotNull(causeMessage, "net.lab1318.costume.api.services.user.DuplicateUserBookmarkException: missing causeMessage");
    }
    ...
    public String getThriftQualifiedClassName() {
        return "costume.api.services.user.duplicate_user_bookmark_exception.DuplicateUserBookmarkException";
    }
    ...
    public void writeAsMessage(final org.thryft.protocol.OutputProtocol oprot) throws org.thryft.protocol.OutputProtocolException {
        oprot.writeMessageBegin("net.lab1318.costume.api.services.user.DuplicateUserBookmarkException", org.thryft.protocol.MessageType.EXCEPTION, null);
    ...
    public void writeAsStruct(final org.thryft.protocol.OutputProtocol oprot) throws org.thryft.protocol.OutputProtocolException {
        oprot.writeStructBegin("net.lab1318.costume.api.services.user.DuplicateUserBookmarkException");
        writeFields(oprot);
