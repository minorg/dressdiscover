...
public class ClosurePlacement implements org.thryft.Struct {
    public static class Builder {
        ...
        protected ClosurePlacement _build(final String text, final com.google.common.base.Optional<net.lab1318.costume.api.models.VocabRef> vocabRef) {
            return new ClosurePlacement(text, vocabRef);
        }

        public ClosurePlacement build() {
            return _build(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.closure.ClosurePlacement: missing text"), com.google.common.base.Preconditions.checkNotNull(vocabRef, "net.lab1318.costume.api.models.closure.ClosurePlacement: missing vocabRef"));
        }
    ...
    public ClosurePlacement(final String text) {
        this.text = org.thryft.Preconditions.checkStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.closure.ClosurePlacement: missing text"), "net.lab1318.costume.api.models.closure.ClosurePlacement: text is empty");
        this.vocabRef = com.google.common.base.Optional.absent();
    }
     ...
     */
    public ClosurePlacement(final String text, final @javax.annotation.Nullable net.lab1318.costume.api.models.VocabRef vocabRef) {
        this.text = org.thryft.Preconditions.checkStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.closure.ClosurePlacement: missing text"), "net.lab1318.costume.api.models.closure.ClosurePlacement: text is empty");
        this.vocabRef = com.google.common.base.Optional.fromNullable(vocabRef);
    }
     ...
     */
    public ClosurePlacement(final String text, final com.google.common.base.Optional<net.lab1318.costume.api.models.VocabRef> vocabRef) {
        this.text = org.thryft.Preconditions.checkStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.closure.ClosurePlacement: missing text"), "net.lab1318.costume.api.models.closure.ClosurePlacement: text is empty");
        this.vocabRef = com.google.common.base.Preconditions.checkNotNull(vocabRef, "net.lab1318.costume.api.models.closure.ClosurePlacement: missing vocabRef");
    }
    ...
    public ClosurePlacement replaceVocabRef(final com.google.common.base.Optional<net.lab1318.costume.api.models.VocabRef> vocabRef) {
        return new ClosurePlacement(this.text, vocabRef);
    }

    public ClosurePlacement replaceVocabRef(final net.lab1318.costume.api.models.VocabRef vocabRef) {
    ...
    public void writeAsStruct(final org.thryft.protocol.OutputProtocol oprot) throws org.thryft.protocol.OutputProtocolException {
        oprot.writeStructBegin("net.lab1318.costume.api.models.closure.ClosurePlacement");
        writeFields(oprot);
