...
public class UserEntry implements org.thryft.Struct, org.thryft.waf.api.models.ModelEntry<net.lab1318.costume.api.models.user.User, net.lab1318.costume.api.models.user.UserId> {
    public static class Builder {
        ...
        protected UserEntry _build(final net.lab1318.costume.api.models.user.UserId id, final net.lab1318.costume.api.models.user.User model) {
            return new UserEntry(id, model);
        }

        public UserEntry build() {
            return _build(com.google.common.base.Preconditions.checkNotNull(id, "net.lab1318.costume.api.models.user.UserEntry: missing id"), com.google.common.base.Preconditions.checkNotNull(model, "net.lab1318.costume.api.models.user.UserEntry: missing model"));
        }
        ...
        public final net.lab1318.costume.api.models.user.User getModel() {
            return model;
        }
        ...
        public Builder readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
            ...
            model = net.lab1318.costume.api.models.user.User.readAsStruct(iprot);
            iprot.readListEnd();
            return this;
        }
        ...
        public Builder setModel(final net.lab1318.costume.api.models.user.User model) {
        ...
        public Builder set(final String name, @javax.annotation.Nullable final java.lang.Object value) {
            ...
            case "model": setModel((net.lab1318.costume.api.models.user.User)value); return this;
            default:
        ...
        private net.lab1318.costume.api.models.user.User model;
    }
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        ...
        MODEL("model", new com.google.common.reflect.TypeToken<net.lab1318.costume.api.models.user.User>() {}, true, 0, "model", org.thryft.protocol.Type.STRUCT);
     ...
     */
    public UserEntry(final net.lab1318.costume.api.models.user.UserId id, final net.lab1318.costume.api.models.user.User model) {
        this.id = com.google.common.base.Preconditions.checkNotNull(id, "net.lab1318.costume.api.models.user.UserEntry: missing id");
        this.model = com.google.common.base.Preconditions.checkNotNull(model, "net.lab1318.costume.api.models.user.UserEntry: missing model");
    }
    ...
    public static UserEntry readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
        ...
        net.lab1318.costume.api.models.user.User model = null;
    ...
    public UserEntry replaceModel(final net.lab1318.costume.api.models.user.User model) {
    ...
    public void writeAsStruct(final org.thryft.protocol.OutputProtocol oprot) throws org.thryft.protocol.OutputProtocolException {
        oprot.writeStructBegin("net.lab1318.costume.api.models.user.UserEntry");
        writeFields(oprot);
    ...
    private final net.lab1318.costume.api.models.user.User model;
}
