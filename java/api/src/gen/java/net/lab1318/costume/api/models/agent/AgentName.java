...
public class AgentName implements org.thryft.Struct {
    public static class Builder {
        ...
        protected AgentName _build(final String text, final net.lab1318.costume.api.models.agent.AgentNameType type, final com.google.common.base.Optional<String> refid, final com.google.common.base.Optional<net.lab1318.costume.api.models.Vocab> vocab) {
            return new AgentName(text, type, refid, vocab);
        }

        public AgentName build() {
            return _build(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.agent.AgentName: missing text"), com.google.common.base.Preconditions.checkNotNull(type, "net.lab1318.costume.api.models.agent.AgentName: missing type"), com.google.common.base.Preconditions.checkNotNull(refid, "net.lab1318.costume.api.models.agent.AgentName: missing refid"), com.google.common.base.Preconditions.checkNotNull(vocab, "net.lab1318.costume.api.models.agent.AgentName: missing vocab"));
        }
     ...
     */
    public AgentName(final String text, final net.lab1318.costume.api.models.agent.AgentNameType type, final @javax.annotation.Nullable String refid, final @javax.annotation.Nullable net.lab1318.costume.api.models.Vocab vocab) {
        this.text = org.thryft.Preconditions.checkStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.agent.AgentName: missing text"), "net.lab1318.costume.api.models.agent.AgentName: text is empty");
        this.type = com.google.common.base.Preconditions.checkNotNull(type, "net.lab1318.costume.api.models.agent.AgentName: missing type");
        this.refid = org.thryft.Preconditions.checkOptionalStringNotEmpty(com.google.common.base.Optional.fromNullable(refid), "net.lab1318.costume.api.models.agent.AgentName: refid is empty");
        this.vocab = com.google.common.base.Optional.fromNullable(vocab);
    }
     ...
     */
    public AgentName(final String text, final net.lab1318.costume.api.models.agent.AgentNameType type, final com.google.common.base.Optional<String> refid, final com.google.common.base.Optional<net.lab1318.costume.api.models.Vocab> vocab) {
        this.text = org.thryft.Preconditions.checkStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.agent.AgentName: missing text"), "net.lab1318.costume.api.models.agent.AgentName: text is empty");
        this.type = com.google.common.base.Preconditions.checkNotNull(type, "net.lab1318.costume.api.models.agent.AgentName: missing type");
        this.refid = org.thryft.Preconditions.checkOptionalStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(refid, "net.lab1318.costume.api.models.agent.AgentName: missing refid"), "net.lab1318.costume.api.models.agent.AgentName: refid is empty");
        this.vocab = com.google.common.base.Preconditions.checkNotNull(vocab, "net.lab1318.costume.api.models.agent.AgentName: missing vocab");
    }
    ...
    public AgentName replaceRefid(final com.google.common.base.Optional<String> refid) {
        return new AgentName(this.text, this.type, refid, this.vocab);
    }

    public AgentName replaceRefid(final String refid) {
        return replaceRefid(com.google.common.base.Optional.fromNullable(refid));
    }

    public AgentName replaceText(final String text) {
        return new AgentName(text, this.type, this.refid, this.vocab);
    }

    public AgentName replaceType(final net.lab1318.costume.api.models.agent.AgentNameType type) {
        return new AgentName(this.text, type, this.refid, this.vocab);
    }

    public AgentName replaceVocab(final com.google.common.base.Optional<net.lab1318.costume.api.models.Vocab> vocab) {
        return new AgentName(this.text, this.type, this.refid, vocab);
    }

    public AgentName replaceVocab(final net.lab1318.costume.api.models.Vocab vocab) {
