 ...
 */
public class Color implements org.thryft.Struct, net.lab1318.costume.api.models.Element {
    public static class Builder {
        ...
        protected Color _build(final String text, final net.lab1318.costume.api.models.color.ColorType type, final com.google.common.base.Optional<net.lab1318.costume.api.models.VocabRef> vocabRef) {
            return new Color(text, type, vocabRef);
        }

        public Color build() {
            return _build(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.color.Color: missing text"), com.google.common.base.Preconditions.checkNotNull(type, "net.lab1318.costume.api.models.color.Color: missing type"), com.google.common.base.Preconditions.checkNotNull(vocabRef, "net.lab1318.costume.api.models.color.Color: missing vocabRef"));
        }
        ...
        public final net.lab1318.costume.api.models.color.ColorType getType() {
            return type;
        }
        ...
        public Builder readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
            ...
            type = iprot.readEnum(net.lab1318.costume.api.models.color.ColorType.class);
            if (__list.getSize() > 2) {
        ...
        public Builder setType(final net.lab1318.costume.api.models.color.ColorType type) {
        ...
        public Builder set(final String name, @javax.annotation.Nullable final java.lang.Object value) {
            ...
            case "type": setType((net.lab1318.costume.api.models.color.ColorType)value); return this;
        ...
        private String text;
        private net.lab1318.costume.api.models.color.ColorType type;
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        ...
        TYPE("type", new com.google.common.reflect.TypeToken<net.lab1318.costume.api.models.color.ColorType>() {}, true, 2, "type", org.thryft.protocol.Type.STRING),
     ...
     */
    public Color(final String text, final net.lab1318.costume.api.models.color.ColorType type) {
        this.text = org.thryft.Preconditions.checkStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.color.Color: missing text"), "net.lab1318.costume.api.models.color.Color: text is empty");
        this.type = com.google.common.base.Preconditions.checkNotNull(type, "net.lab1318.costume.api.models.color.Color: missing type");
        this.vocabRef = com.google.common.base.Optional.absent();
    }
     ...
     */
    public Color(final String text, final net.lab1318.costume.api.models.color.ColorType type, final @javax.annotation.Nullable net.lab1318.costume.api.models.VocabRef vocabRef) {
        this.text = org.thryft.Preconditions.checkStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.color.Color: missing text"), "net.lab1318.costume.api.models.color.Color: text is empty");
        this.type = com.google.common.base.Preconditions.checkNotNull(type, "net.lab1318.costume.api.models.color.Color: missing type");
        this.vocabRef = com.google.common.base.Optional.fromNullable(vocabRef);
    }
     ...
     */
    public Color(final String text, final net.lab1318.costume.api.models.color.ColorType type, final com.google.common.base.Optional<net.lab1318.costume.api.models.VocabRef> vocabRef) {
        this.text = org.thryft.Preconditions.checkStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.color.Color: missing text"), "net.lab1318.costume.api.models.color.Color: text is empty");
        this.type = com.google.common.base.Preconditions.checkNotNull(type, "net.lab1318.costume.api.models.color.Color: missing type");
        this.vocabRef = com.google.common.base.Preconditions.checkNotNull(vocabRef, "net.lab1318.costume.api.models.color.Color: missing vocabRef");
    }
    ...
    public static Color readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
        String text = null;
        net.lab1318.costume.api.models.color.ColorType type = null;
    ...
    public Color replaceType(final net.lab1318.costume.api.models.color.ColorType type) {
        return new Color(this.text, type, this.vocabRef);
    }

    public Color replaceVocabRef(final com.google.common.base.Optional<net.lab1318.costume.api.models.VocabRef> vocabRef) {
        return new Color(this.text, this.type, vocabRef);
    }

    public Color replaceVocabRef(final net.lab1318.costume.api.models.VocabRef vocabRef) {
    ...
    public void writeAsStruct(final org.thryft.protocol.OutputProtocol oprot) throws org.thryft.protocol.OutputProtocolException {
        oprot.writeStructBegin("net.lab1318.costume.api.models.color.Color");
        writeFields(oprot);
    ...
    private final net.lab1318.costume.api.models.color.ColorType type;
