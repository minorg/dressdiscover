...
public class ComponentTerm implements org.thryft.Struct {
    public static class Builder {
        ...
        protected ComponentTerm _build(final String text, final com.google.common.base.Optional<net.lab1318.costume.api.models.VocabRef> vocabRef) {
            return new ComponentTerm(text, vocabRef);
        }

        public ComponentTerm build() {
            return _build(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.component.ComponentTerm: missing text"), com.google.common.base.Preconditions.checkNotNull(vocabRef, "net.lab1318.costume.api.models.component.ComponentTerm: missing vocabRef"));
        }
    ...
    public ComponentTerm(final String text) {
        this.text = org.thryft.Preconditions.checkStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.component.ComponentTerm: missing text"), "net.lab1318.costume.api.models.component.ComponentTerm: text is empty");
        this.vocabRef = com.google.common.base.Optional.absent();
    }
     ...
     */
    public ComponentTerm(final String text, final @javax.annotation.Nullable net.lab1318.costume.api.models.VocabRef vocabRef) {
        this.text = org.thryft.Preconditions.checkStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.component.ComponentTerm: missing text"), "net.lab1318.costume.api.models.component.ComponentTerm: text is empty");
        this.vocabRef = com.google.common.base.Optional.fromNullable(vocabRef);
    }
     ...
     */
    public ComponentTerm(final String text, final com.google.common.base.Optional<net.lab1318.costume.api.models.VocabRef> vocabRef) {
        this.text = org.thryft.Preconditions.checkStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.component.ComponentTerm: missing text"), "net.lab1318.costume.api.models.component.ComponentTerm: text is empty");
        this.vocabRef = com.google.common.base.Preconditions.checkNotNull(vocabRef, "net.lab1318.costume.api.models.component.ComponentTerm: missing vocabRef");
    }
    ...
    public boolean equals(final java.lang.Object otherObject) {
        if (otherObject == this) {
            return true;
        } else if (!(otherObject instanceof ComponentTerm)) {
            return false;
        }
    ...
    public ComponentTerm replaceVocabRef(final com.google.common.base.Optional<net.lab1318.costume.api.models.VocabRef> vocabRef) {
        return new ComponentTerm(this.text, vocabRef);
    }

    public ComponentTerm replaceVocabRef(final net.lab1318.costume.api.models.VocabRef vocabRef) {
    ...
    public void writeAsStruct(final org.thryft.protocol.OutputProtocol oprot) throws org.thryft.protocol.OutputProtocolException {
        oprot.writeStructBegin("net.lab1318.costume.api.models.component.ComponentTerm");
        writeFields(oprot);
