...
public class Material implements org.thryft.Struct {
    public static class Builder {
        ...
        protected Material _build(final net.lab1318.costume.api.models.material.MaterialType type, final String title, final com.google.common.base.Optional<String> refid, final com.google.common.base.Optional<net.lab1318.costume.api.models.Vocab> vocab) {
            return new Material(type, title, refid, vocab);
        }

        public Material build() {
            return _build(com.google.common.base.Preconditions.checkNotNull(type, "net.lab1318.costume.api.models.material.Material: missing type"), com.google.common.base.Preconditions.checkNotNull(title, "net.lab1318.costume.api.models.material.Material: missing title"), com.google.common.base.Preconditions.checkNotNull(refid, "net.lab1318.costume.api.models.material.Material: missing refid"), com.google.common.base.Preconditions.checkNotNull(vocab, "net.lab1318.costume.api.models.material.Material: missing vocab"));
        }
    ...
    public Material(final Material other) {
        this(other.getType(), other.getTitle(), other.getRefid(), other.getVocab());
    }

    /**
     * Required constructor
     */
    public Material(final net.lab1318.costume.api.models.material.MaterialType type, final String title) {
        ...
        this.title = org.thryft.Preconditions.checkStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(title, "net.lab1318.costume.api.models.material.Material: missing title"), "net.lab1318.costume.api.models.material.Material: title is empty");
        this.refid = com.google.common.base.Optional.absent();
        this.vocab = com.google.common.base.Optional.absent();
    }
     ...
     */
    public Material(final net.lab1318.costume.api.models.material.MaterialType type, final String title, final @javax.annotation.Nullable String refid, final @javax.annotation.Nullable net.lab1318.costume.api.models.Vocab vocab) {
        this.type = com.google.common.base.Preconditions.checkNotNull(type, "net.lab1318.costume.api.models.material.Material: missing type");
        this.title = org.thryft.Preconditions.checkStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(title, "net.lab1318.costume.api.models.material.Material: missing title"), "net.lab1318.costume.api.models.material.Material: title is empty");
     ...
     */
    public Material(final net.lab1318.costume.api.models.material.MaterialType type, final String title, final com.google.common.base.Optional<String> refid, final com.google.common.base.Optional<net.lab1318.costume.api.models.Vocab> vocab) {
        this.type = com.google.common.base.Preconditions.checkNotNull(type, "net.lab1318.costume.api.models.material.Material: missing type");
        this.title = org.thryft.Preconditions.checkStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(title, "net.lab1318.costume.api.models.material.Material: missing title"), "net.lab1318.costume.api.models.material.Material: title is empty");
    ...
    public Material replaceRefid(final com.google.common.base.Optional<String> refid) {
        return new Material(this.type, this.title, refid, this.vocab);
    }
    ...
    public Material replaceTitle(final String title) {
        return new Material(this.type, title, this.refid, this.vocab);
    }

    public Material replaceType(final net.lab1318.costume.api.models.material.MaterialType type) {
        return new Material(type, this.title, this.refid, this.vocab);
    }

    public Material replaceVocab(final com.google.common.base.Optional<net.lab1318.costume.api.models.Vocab> vocab) {
        return new Material(this.type, this.title, this.refid, vocab);
    }
    ...
    public String toString() {
        return com.google.common.base.MoreObjects.toStringHelper(this).omitNullValues().add("type", getType()).add("title", getTitle()).add("refid", getRefid().orNull()).add("vocab", getVocab().orNull()).toString();
    }
