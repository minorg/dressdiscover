...
public class ClosureType implements org.thryft.Struct {
    public static class Builder {
        ...
        protected ClosureType _build(final String text, final com.google.common.base.Optional<net.lab1318.costume.api.models.VocabRef> vocabRef) {
            return new ClosureType(text, vocabRef);
        }

        public ClosureType build() {
            return _build(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.closure.ClosureType: missing text"), com.google.common.base.Preconditions.checkNotNull(vocabRef, "net.lab1318.costume.api.models.closure.ClosureType: missing vocabRef"));
        }
    ...
    public ClosureType(final String text) {
        this.text = org.thryft.Preconditions.checkStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.closure.ClosureType: missing text"), "net.lab1318.costume.api.models.closure.ClosureType: text is empty");
        this.vocabRef = com.google.common.base.Optional.absent();
    }
     ...
     */
    public ClosureType(final String text, final @javax.annotation.Nullable net.lab1318.costume.api.models.VocabRef vocabRef) {
        this.text = org.thryft.Preconditions.checkStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.closure.ClosureType: missing text"), "net.lab1318.costume.api.models.closure.ClosureType: text is empty");
        this.vocabRef = com.google.common.base.Optional.fromNullable(vocabRef);
    }
     ...
     */
    public ClosureType(final String text, final com.google.common.base.Optional<net.lab1318.costume.api.models.VocabRef> vocabRef) {
        this.text = org.thryft.Preconditions.checkStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.closure.ClosureType: missing text"), "net.lab1318.costume.api.models.closure.ClosureType: text is empty");
        this.vocabRef = com.google.common.base.Preconditions.checkNotNull(vocabRef, "net.lab1318.costume.api.models.closure.ClosureType: missing vocabRef");
    }
    ...
    public ClosureType replaceVocabRef(final com.google.common.base.Optional<net.lab1318.costume.api.models.VocabRef> vocabRef) {
        return new ClosureType(this.text, vocabRef);
    }

    public ClosureType replaceVocabRef(final net.lab1318.costume.api.models.VocabRef vocabRef) {
    ...
    public void writeAsStruct(final org.thryft.protocol.OutputProtocol oprot) throws org.thryft.protocol.OutputProtocolException {
        oprot.writeStructBegin("net.lab1318.costume.api.models.closure.ClosureType");
        writeFields(oprot);
