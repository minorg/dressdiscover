...
public class Object implements org.thryft.Struct, org.notaweb.api.models.Model {
    public static class Builder {
        ...
        protected Object _build(final net.lab1318.costume.api.models.collection.CollectionId collectionId, final net.lab1318.costume.api.models.institution.InstitutionId institutionId, final net.lab1318.costume.api.models.ModelMetadata modelMetadata, final String title, final com.google.common.base.Optional<com.google.common.collect.ImmutableList<String>> categories, final com.google.common.base.Optional<java.util.Date> date, final com.google.common.base.Optional<String> dateText, final com.google.common.base.Optional<String> description, final com.google.common.base.Optional<String> historyNotes, final com.google.common.base.Optional<net.lab1318.costume.api.models.inscription.InscriptionSet> inscriptions, final com.google.common.base.Optional<net.lab1318.costume.api.models.material.MaterialSet> materials, final com.google.common.base.Optional<String> physicalDescription, final com.google.common.base.Optional<String> provenance, final com.google.common.base.Optional<String> summary, final com.google.common.base.Optional<net.lab1318.costume.api.models.technique.TechniqueSet> techniques, final com.google.common.base.Optional<net.lab1318.costume.api.models.image.Image> thumbnail, final com.google.common.base.Optional<org.thryft.native_.Url> url) {
            return new Object(collectionId, institutionId, modelMetadata, title, categories, date, dateText, description, historyNotes, inscriptions, materials, physicalDescription, provenance, summary, techniques, thumbnail, url);
        }
    ...
    public Object(final Object other) {
        this(other.getCollectionId(), other.getInstitutionId(), other.getModelMetadata(), other.getTitle(), other.getCategories(), other.getDate(), other.getDateText(), other.getDescription(), other.getHistoryNotes(), other.getInscriptions(), other.getMaterials(), other.getPhysicalDescription(), other.getProvenance(), other.getSummary(), other.getTechniques(), other.getThumbnail(), other.getUrl());
    }
    ...
    public Object replaceCategories(final com.google.common.base.Optional<com.google.common.collect.ImmutableList<String>> categories) {
        return new Object(this.collectionId, this.institutionId, this.modelMetadata, this.title, categories, this.date, this.dateText, this.description, this.historyNotes, this.inscriptions, this.materials, this.physicalDescription, this.provenance, this.summary, this.techniques, this.thumbnail, this.url);
    }
    ...
    public Object replaceCollectionId(final net.lab1318.costume.api.models.collection.CollectionId collectionId) {
        return new Object(collectionId, this.institutionId, this.modelMetadata, this.title, this.categories, this.date, this.dateText, this.description, this.historyNotes, this.inscriptions, this.materials, this.physicalDescription, this.provenance, this.summary, this.techniques, this.thumbnail, this.url);
    }

    public Object replaceDate(final com.google.common.base.Optional<java.util.Date> date) {
        return new Object(this.collectionId, this.institutionId, this.modelMetadata, this.title, this.categories, date, this.dateText, this.description, this.historyNotes, this.inscriptions, this.materials, this.physicalDescription, this.provenance, this.summary, this.techniques, this.thumbnail, this.url);
    }
    ...
    public Object replaceDateText(final com.google.common.base.Optional<String> dateText) {
        return new Object(this.collectionId, this.institutionId, this.modelMetadata, this.title, this.categories, this.date, dateText, this.description, this.historyNotes, this.inscriptions, this.materials, this.physicalDescription, this.provenance, this.summary, this.techniques, this.thumbnail, this.url);
    }
    ...
    public Object replaceDescription(final com.google.common.base.Optional<String> description) {
        return new Object(this.collectionId, this.institutionId, this.modelMetadata, this.title, this.categories, this.date, this.dateText, description, this.historyNotes, this.inscriptions, this.materials, this.physicalDescription, this.provenance, this.summary, this.techniques, this.thumbnail, this.url);
    }
    ...
    public Object replaceHistoryNotes(final com.google.common.base.Optional<String> historyNotes) {
        return new Object(this.collectionId, this.institutionId, this.modelMetadata, this.title, this.categories, this.date, this.dateText, this.description, historyNotes, this.inscriptions, this.materials, this.physicalDescription, this.provenance, this.summary, this.techniques, this.thumbnail, this.url);
    }
    ...
    public Object replaceInscriptions(final com.google.common.base.Optional<net.lab1318.costume.api.models.inscription.InscriptionSet> inscriptions) {
        return new Object(this.collectionId, this.institutionId, this.modelMetadata, this.title, this.categories, this.date, this.dateText, this.description, this.historyNotes, inscriptions, this.materials, this.physicalDescription, this.provenance, this.summary, this.techniques, this.thumbnail, this.url);
    }
    ...
    public Object replaceInstitutionId(final net.lab1318.costume.api.models.institution.InstitutionId institutionId) {
        return new Object(this.collectionId, institutionId, this.modelMetadata, this.title, this.categories, this.date, this.dateText, this.description, this.historyNotes, this.inscriptions, this.materials, this.physicalDescription, this.provenance, this.summary, this.techniques, this.thumbnail, this.url);
    }
    ...
    public Object replaceMaterials(final com.google.common.base.Optional<net.lab1318.costume.api.models.material.MaterialSet> materials) {
        return new Object(this.collectionId, this.institutionId, this.modelMetadata, this.title, this.categories, this.date, this.dateText, this.description, this.historyNotes, this.inscriptions, materials, this.physicalDescription, this.provenance, this.summary, this.techniques, this.thumbnail, this.url);
    }
    ...
    public Object replaceModelMetadata(final net.lab1318.costume.api.models.ModelMetadata modelMetadata) {
        return new Object(this.collectionId, this.institutionId, modelMetadata, this.title, this.categories, this.date, this.dateText, this.description, this.historyNotes, this.inscriptions, this.materials, this.physicalDescription, this.provenance, this.summary, this.techniques, this.thumbnail, this.url);
    }

    public Object replacePhysicalDescription(final com.google.common.base.Optional<String> physicalDescription) {
        return new Object(this.collectionId, this.institutionId, this.modelMetadata, this.title, this.categories, this.date, this.dateText, this.description, this.historyNotes, this.inscriptions, this.materials, physicalDescription, this.provenance, this.summary, this.techniques, this.thumbnail, this.url);
    }
    ...
    public Object replaceProvenance(final com.google.common.base.Optional<String> provenance) {
        return new Object(this.collectionId, this.institutionId, this.modelMetadata, this.title, this.categories, this.date, this.dateText, this.description, this.historyNotes, this.inscriptions, this.materials, this.physicalDescription, provenance, this.summary, this.techniques, this.thumbnail, this.url);
    }
    ...
    public Object replaceSummary(final com.google.common.base.Optional<String> summary) {
        return new Object(this.collectionId, this.institutionId, this.modelMetadata, this.title, this.categories, this.date, this.dateText, this.description, this.historyNotes, this.inscriptions, this.materials, this.physicalDescription, this.provenance, summary, this.techniques, this.thumbnail, this.url);
    }
    ...
    public Object replaceTechniques(final com.google.common.base.Optional<net.lab1318.costume.api.models.technique.TechniqueSet> techniques) {
        return new Object(this.collectionId, this.institutionId, this.modelMetadata, this.title, this.categories, this.date, this.dateText, this.description, this.historyNotes, this.inscriptions, this.materials, this.physicalDescription, this.provenance, this.summary, techniques, this.thumbnail, this.url);
    }
    ...
    public Object replaceThumbnail(final com.google.common.base.Optional<net.lab1318.costume.api.models.image.Image> thumbnail) {
        return new Object(this.collectionId, this.institutionId, this.modelMetadata, this.title, this.categories, this.date, this.dateText, this.description, this.historyNotes, this.inscriptions, this.materials, this.physicalDescription, this.provenance, this.summary, this.techniques, thumbnail, this.url);
    }
    ...
    public Object replaceTitle(final String title) {
        return new Object(this.collectionId, this.institutionId, this.modelMetadata, title, this.categories, this.date, this.dateText, this.description, this.historyNotes, this.inscriptions, this.materials, this.physicalDescription, this.provenance, this.summary, this.techniques, this.thumbnail, this.url);
    }

    public Object replaceUrl(final com.google.common.base.Optional<org.thryft.native_.Url> url) {
        return new Object(this.collectionId, this.institutionId, this.modelMetadata, this.title, this.categories, this.date, this.dateText, this.description, this.historyNotes, this.inscriptions, this.materials, this.physicalDescription, this.provenance, this.summary, this.techniques, this.thumbnail, url);
    }
    ...
    public String toString() {
        return com.google.common.base.MoreObjects.toStringHelper(this).omitNullValues().add("collection_id", getCollectionId()).add("institution_id", getInstitutionId()).add("model_metadata", getModelMetadata()).add("title", getTitle()).add("categories", getCategories().orNull()).add("date", getDate().orNull()).add("date_text", getDateText().orNull()).add("description", getDescription().orNull()).add("history_notes", getHistoryNotes().orNull()).add("inscriptions", getInscriptions().orNull()).add("materials", getMaterials().orNull()).add("physical_description", getPhysicalDescription().orNull()).add("provenance", getProvenance().orNull()).add("summary", getSummary().orNull()).add("techniques", getTechniques().orNull()).add("thumbnail", getThumbnail().orNull()).add("url", getUrl().orNull()).toString();
    }
