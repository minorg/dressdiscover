...
public class AgentRole implements org.thryft.Struct {
    public static class Builder {
        ...
        protected AgentRole _build(final String text, final com.google.common.base.Optional<net.lab1318.costume.api.models.VocabRef> vocabRef) {
            return new AgentRole(text, vocabRef);
        }

        public AgentRole build() {
            return _build(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.agent.AgentRole: missing text"), com.google.common.base.Preconditions.checkNotNull(vocabRef, "net.lab1318.costume.api.models.agent.AgentRole: missing vocabRef"));
        }
     ...
     */
    public AgentRole(final String text, final @javax.annotation.Nullable net.lab1318.costume.api.models.VocabRef vocabRef) {
        this.text = org.thryft.Preconditions.checkStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.agent.AgentRole: missing text"), "net.lab1318.costume.api.models.agent.AgentRole: text is empty");
        this.vocabRef = com.google.common.base.Optional.fromNullable(vocabRef);
    }
     ...
     */
    public AgentRole(final String text, final com.google.common.base.Optional<net.lab1318.costume.api.models.VocabRef> vocabRef) {
        this.text = org.thryft.Preconditions.checkStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.agent.AgentRole: missing text"), "net.lab1318.costume.api.models.agent.AgentRole: text is empty");
        this.vocabRef = com.google.common.base.Preconditions.checkNotNull(vocabRef, "net.lab1318.costume.api.models.agent.AgentRole: missing vocabRef");
    }
    ...
    public AgentRole replaceVocabRef(final com.google.common.base.Optional<net.lab1318.costume.api.models.VocabRef> vocabRef) {
        return new AgentRole(this.text, vocabRef);
    }

    public AgentRole replaceVocabRef(final net.lab1318.costume.api.models.VocabRef vocabRef) {
