package net.lab1318.costume.api.services;
...
public class IoException extends org.thryft.Exception {
    public static class Builder {
        ...
        public IoException build() {
            return _build(com.google.common.base.Preconditions.checkNotNull(causeMessage, "net.lab1318.costume.api.services.IoException: missing causeMessage"));
        }
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        CAUSE_MESSAGE(new com.google.common.reflect.TypeToken<String>() {}, true, 0, "cause_message", org.thryft.protocol.Type.STRING);
    ...
    public IoException(final String causeMessage) {
        this.causeMessage = com.google.common.base.Preconditions.checkNotNull(causeMessage, "net.lab1318.costume.api.services.IoException: missing causeMessage");
    }
    ...
    public String getThriftQualifiedClassName() {
        return "costume.api.services.io_exception.IoException";
    }
    ...
    public void writeAsMessage(final org.thryft.protocol.OutputProtocol oprot) throws org.thryft.protocol.OutputProtocolException {
        oprot.writeMessageBegin("net.lab1318.costume.api.services.IoException", org.thryft.protocol.MessageType.EXCEPTION, null);
    ...
    public void writeAsStruct(final org.thryft.protocol.OutputProtocol oprot) throws org.thryft.protocol.OutputProtocolException {
        oprot.writeStructBegin("net.lab1318.costume.api.services.IoException");
        writeFields(oprot);
