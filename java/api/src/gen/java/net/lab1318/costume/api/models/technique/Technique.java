 ...
 */
public class Technique implements org.thryft.Struct, net.lab1318.costume.api.models.Element {
    public static class Builder {
        ...
        protected Technique _build(final String text, final com.google.common.base.Optional<net.lab1318.costume.api.models.VocabRef> vocabRef) {
            return new Technique(text, vocabRef);
        }

        public Technique build() {
            return _build(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.technique.Technique: missing text"), com.google.common.base.Preconditions.checkNotNull(vocabRef, "net.lab1318.costume.api.models.technique.Technique: missing vocabRef"));
        }
     ...
     */
    public Technique(final String text, final @javax.annotation.Nullable net.lab1318.costume.api.models.VocabRef vocabRef) {
        this.text = org.thryft.Preconditions.checkStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.technique.Technique: missing text"), "net.lab1318.costume.api.models.technique.Technique: text is empty");
        this.vocabRef = com.google.common.base.Optional.fromNullable(vocabRef);
    }
     ...
     */
    public Technique(final String text, final com.google.common.base.Optional<net.lab1318.costume.api.models.VocabRef> vocabRef) {
        this.text = org.thryft.Preconditions.checkStringNotEmpty(com.google.common.base.Preconditions.checkNotNull(text, "net.lab1318.costume.api.models.technique.Technique: missing text"), "net.lab1318.costume.api.models.technique.Technique: text is empty");
        this.vocabRef = com.google.common.base.Preconditions.checkNotNull(vocabRef, "net.lab1318.costume.api.models.technique.Technique: missing vocabRef");
    }
    ...
    public Technique replaceVocabRef(final com.google.common.base.Optional<net.lab1318.costume.api.models.VocabRef> vocabRef) {
        return new Technique(this.text, vocabRef);
    }

    public Technique replaceVocabRef(final net.lab1318.costume.api.models.VocabRef vocabRef) {
