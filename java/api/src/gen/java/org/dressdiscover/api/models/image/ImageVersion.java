...
public final class ImageVersion implements org.thryft.Struct {
    ...
    public boolean equals(final java.lang.Object otherObject) {
        ...
        if (!(((getHeightPx().isPresent() && other.getHeightPx().isPresent()) ? (getHeightPx().get().equals(other.getHeightPx().get())) : (!getHeightPx().isPresent() && !other.getHeightPx().isPresent())))) {
            return false;
        }

        if (!(((getWidthPx().isPresent() && other.getWidthPx().isPresent()) ? (getWidthPx().get().equals(other.getWidthPx().get())) : (!getWidthPx().isPresent() && !other.getWidthPx().isPresent())))) {
            return false;
        }
