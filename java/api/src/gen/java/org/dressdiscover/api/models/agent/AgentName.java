...
public final class AgentName implements org.thryft.Struct {
    public final static class Builder {
        ...
        protected AgentName _build(final String text, final org.dressdiscover.api.models.agent.AgentNameType type, final com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> vocabRef) {
        ...
        public final org.dressdiscover.api.models.agent.AgentNameType getType() {
            return type;
        }
        ...
        public Builder readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
            ...
            type = iprot.readEnum(org.dressdiscover.api.models.agent.AgentNameType.class);
            if (__list.getSize() > 2) {
        ...
        public Builder set(final FieldMetadata fieldMetadata, @javax.annotation.Nullable final java.lang.Object value) {
            ...
            case TYPE: setType((org.dressdiscover.api.models.agent.AgentNameType)value); return this;
        ...
        public Builder setType(final org.dressdiscover.api.models.agent.AgentNameType type) {
    ...
    public interface Validator<ExceptionT extends Exception> {
        ...
        public org.dressdiscover.api.models.agent.AgentNameType validateType(final org.dressdiscover.api.models.agent.AgentNameType type) throws ExceptionT;
    ...
    public static class DefaultConstructionValidator implements ConstructionValidator {
        ...
        public String validateText(final String text) throws RuntimeException {
            if (text == null) {
                throw new NullPointerException("org.dressdiscover.api.models.agent.AgentName: text is null");
            }
            if (text.isEmpty()) {
                throw new IllegalArgumentException("org.dressdiscover.api.models.agent.AgentName: text is less than min length 1");
            }
            return text;
        }

        @Override
        public org.dressdiscover.api.models.agent.AgentNameType validateType(final org.dressdiscover.api.models.agent.AgentNameType type) throws RuntimeException {
            if (type == null) {
                throw new NullPointerException("org.dressdiscover.api.models.agent.AgentName: type is null");
            }
            return type;
        }
        ...
        public com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> validateVocabRef(final com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> vocabRef) throws RuntimeException {
            if (vocabRef == null) {
                throw new NullPointerException("org.dressdiscover.api.models.agent.AgentName: vocabRef is null");
            }
    ...
    public static class NopConstructionValidator implements ConstructionValidator {
        ...
        @Override
        public org.dressdiscover.api.models.agent.AgentNameType validateType(final org.dressdiscover.api.models.agent.AgentNameType type) {
            return type;
        }
    ...
    public static class DefaultReadValidator implements ReadValidator {
        ...
        public String validateText(final String text) throws org.thryft.protocol.InputProtocolException {
            if (text == null) {
                throw new org.thryft.protocol.MissingFieldInputProtocolException(FieldMetadata.TEXT, "org.dressdiscover.api.models.agent.AgentName: text is null");
            }
            if (text.isEmpty()) {
                throw new org.thryft.protocol.InvalidFieldInputProtocolException(FieldMetadata.TEXT, "org.dressdiscover.api.models.agent.AgentName: text is less than min length 1");
            }
            return text;
        }

        @Override
        public org.dressdiscover.api.models.agent.AgentNameType validateType(final org.dressdiscover.api.models.agent.AgentNameType type) throws org.thryft.protocol.InputProtocolException {
            if (type == null) {
                throw new org.thryft.protocol.MissingFieldInputProtocolException(FieldMetadata.TYPE, "org.dressdiscover.api.models.agent.AgentName: type is null");
            }
            return type;
        }
        ...
        public com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> validateVocabRef(final com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> vocabRef) throws org.thryft.protocol.InputProtocolException {
            if (vocabRef == null) {
                throw new org.thryft.protocol.MissingFieldInputProtocolException(FieldMetadata.VOCAB_REF, "org.dressdiscover.api.models.agent.AgentName: vocabRef is null");
            }
            if (!vocabRef.isPresent()) {
                return vocabRef;
            }
    ...
    protected AgentName(final String text, final org.dressdiscover.api.models.agent.AgentNameType type, final com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> vocabRef, ConstructionValidator validator) {
     ...
     */
    public static AgentName create(final String text, final org.dressdiscover.api.models.agent.AgentNameType type) {
     ...
     */
    public static AgentName create(final String text, final org.dressdiscover.api.models.agent.AgentNameType type, final @javax.annotation.Nullable org.dressdiscover.api.models.VocabRef vocabRef) {
     ...
     */
    public static AgentName create(final String text, final org.dressdiscover.api.models.agent.AgentNameType type, final com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> vocabRef) {
        return new AgentName(text, type, vocabRef, DefaultConstructionValidator.getInstance());
    }
    ...
    public static AgentName readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
        String text = null;
        org.dressdiscover.api.models.agent.AgentNameType type = null;
    ...
    public AgentName replaceType(final org.dressdiscover.api.models.agent.AgentNameType type) {
    ...
    public void writeAsStruct(final org.thryft.protocol.OutputProtocol oprot) throws org.thryft.protocol.OutputProtocolException {
        oprot.writeStructBegin("org.dressdiscover.api.models.agent.AgentName");
        writeFields(oprot);
    ...
    private final org.dressdiscover.api.models.agent.AgentNameType type;
