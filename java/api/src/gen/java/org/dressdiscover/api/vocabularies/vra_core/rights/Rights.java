 ...
 */
public final class Rights implements org.thryft.Struct, org.dressdiscover.api.vocabularies.vra_core.Element {
    public final static class Builder {
        ...
        public Builder readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
            try {
                ...
                type = iprot.readEnum(org.dressdiscover.api.vocabularies.vra_core.rights.RightsType.class);
                if (__list.getSize() > 2) {
        ...
        private String text;
        private org.dressdiscover.api.vocabularies.vra_core.rights.RightsType type;
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        ...
        TYPE("type", new com.google.common.reflect.TypeToken<org.dressdiscover.api.vocabularies.vra_core.rights.RightsType>() {}, true, 3, "type", org.thryft.protocol.Type.STRING),
    ...
    public interface Validator<ExceptionT extends Exception> {
        ...
        public org.dressdiscover.api.vocabularies.vra_core.rights.RightsType validateType(final org.dressdiscover.api.vocabularies.vra_core.rights.RightsType type) throws ExceptionT;
    ...
    public static class DefaultConstructionValidator implements ConstructionValidator {
        ...
        public String validateText(final String text) throws RuntimeException {
            ...
            if (text.isEmpty()) {
                throw new IllegalArgumentException("org.dressdiscover.api.vocabularies.vra_core.rights.Rights: text is less than min length 1");
            }
            return text;
        }

        @Override
        public org.dressdiscover.api.vocabularies.vra_core.rights.RightsType validateType(final org.dressdiscover.api.vocabularies.vra_core.rights.RightsType type) throws RuntimeException {
            if (type == null) {
        ...
        public com.google.common.base.Optional<String> validateNotes(final com.google.common.base.Optional<String> notes) throws RuntimeException {
            ...
            if (notes.get().isEmpty()) {
                throw new IllegalArgumentException("org.dressdiscover.api.vocabularies.vra_core.rights.Rights: notes is less than min length 1");
            }
            return notes;
        }
        ...
        public com.google.common.base.Optional<String> validateRightsHolder(final com.google.common.base.Optional<String> rightsHolder) throws RuntimeException {
            ...
            if (rightsHolder.get().isEmpty()) {
                throw new IllegalArgumentException("org.dressdiscover.api.vocabularies.vra_core.rights.Rights: rightsHolder is less than min length 1");
            }
            return rightsHolder;
        }
    ...
    public static class NopConstructionValidator implements ConstructionValidator {
        ...
        @Override
        public org.dressdiscover.api.vocabularies.vra_core.rights.RightsType validateType(final org.dressdiscover.api.vocabularies.vra_core.rights.RightsType type) {
            return type;
        }
    ...
    public static class DefaultReadValidator implements ReadValidator {
        ...
        public String validateText(final String text) throws org.thryft.protocol.InputProtocolException {
            ...
            if (text.isEmpty()) {
                throw new org.thryft.protocol.InvalidFieldInputProtocolException(FieldMetadata.TEXT, "org.dressdiscover.api.vocabularies.vra_core.rights.Rights: text is less than min length 1");
            }
            return text;
        }

        @Override
        public org.dressdiscover.api.vocabularies.vra_core.rights.RightsType validateType(final org.dressdiscover.api.vocabularies.vra_core.rights.RightsType type) throws org.thryft.protocol.InputProtocolException {
            if (type == null) {
        ...
        public com.google.common.base.Optional<String> validateNotes(final com.google.common.base.Optional<String> notes) throws org.thryft.protocol.InputProtocolException {
            ...
            if (notes.get().isEmpty()) {
                throw new org.thryft.protocol.InvalidFieldInputProtocolException(FieldMetadata.NOTES, "org.dressdiscover.api.vocabularies.vra_core.rights.Rights: notes is less than min length 1");
            }
            return notes;
        }
        ...
        public com.google.common.base.Optional<String> validateRightsHolder(final com.google.common.base.Optional<String> rightsHolder) throws org.thryft.protocol.InputProtocolException {
            ...
            if (rightsHolder.get().isEmpty()) {
                throw new org.thryft.protocol.InvalidFieldInputProtocolException(FieldMetadata.RIGHTS_HOLDER, "org.dressdiscover.api.vocabularies.vra_core.rights.Rights: rightsHolder is less than min length 1");
            }
            return rightsHolder;
        }
     ...
     */
    public static Rights create(final String text, final org.dressdiscover.api.vocabularies.vra_core.rights.RightsType type, final @javax.annotation.Nullable org.dressdiscover.api.models.VocabRef licenseVocabRef, final @javax.annotation.Nullable String notes, final @javax.annotation.Nullable String rightsHolder) {
    ...
    public static Rights readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
        String text = null;
        org.dressdiscover.api.vocabularies.vra_core.rights.RightsType type = null;
