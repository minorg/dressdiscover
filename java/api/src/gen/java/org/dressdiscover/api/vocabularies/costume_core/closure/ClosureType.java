...
public final class ClosureType implements org.thryft.Struct {
    ...
    public final static class ReadValidator {
        ...
        public static void validateText(final String text) throws org.thryft.protocol.InputProtocolException {
            ...
            if (text.isEmpty()) {
                throw new org.thryft.protocol.InvalidFieldInputProtocolException(FieldMetadata.TEXT, "org.dressdiscover.api.vocabularies.costume_core.closure.ClosureType: text: less than min length 1");
            }
        }
    ...
    public final static class UncheckedValidator {
        ...
        public static void validateText(final String text) {
            ...
            if (text.isEmpty()) {
                throw new IllegalArgumentException("org.dressdiscover.api.vocabularies.costume_core.closure.ClosureType: text: less than min length 1");
            }
        }
     ...
     */
    protected ClosureType(final String text, final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
        this.text = text;
        this.vocabRef = vocabRef;
    }
    ...
    public static ClosureType create(final String text) {
        ...
        return new ClosureType(text, com.google.common.base.Optional.<org.dressdiscover.api.vocabularies.vra_core.VocabRef> absent());
    }

    /**
     * Total Nullable factory method
     */
    public static ClosureType create(final String text, @javax.annotation.Nullable final org.dressdiscover.api.vocabularies.vra_core.VocabRef vocabRef) {
        ...
        return new ClosureType(text, vocabRefOptional);
    }

    /**
     * Optional factory method
     */
    public static ClosureType create(final String text, final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
        UncheckedValidator.validate(text, vocabRef);
        return new ClosureType(text, vocabRef);
    }
