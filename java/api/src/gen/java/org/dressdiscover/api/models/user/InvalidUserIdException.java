...
public class InvalidUserIdException extends org.thryft.Exception {
    public static class Builder {
        public Builder() {
            causeMessage = null;
        }

        public Builder(final InvalidUserIdException other) {
        ...
        public InvalidUserIdException build() {
            return _build(com.google.common.base.Preconditions.checkNotNull(causeMessage, "org.dressdiscover.api.models.user.InvalidUserIdException: missing causeMessage"));
        }
        ...
        public Builder setIfPresent(final InvalidUserIdException other) {
    ...
    public final static class Factory implements org.thryft.CompoundType.Factory<InvalidUserIdException> {
        @Override
        public InvalidUserIdException readAs(final org.thryft.protocol.InputProtocol iprot, final org.thryft.protocol.Type type) throws org.thryft.protocol.InputProtocolException {
            return InvalidUserIdException.readAs(iprot, type);
        }

        @Override
        public InvalidUserIdException readAs(final org.thryft.protocol.InputProtocol iprot, final org.thryft.protocol.Type type,
                final com.google.common.base.Optional<org.thryft.CompoundType.UnknownFieldCallback> unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
            return InvalidUserIdException.readAs(iprot, type, unknownFieldCallback);
        }

        @Override
        public InvalidUserIdException readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
            return InvalidUserIdException.readAsList(iprot);
        }

        @Override
        public InvalidUserIdException readAsStruct(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
            return InvalidUserIdException.readAsStruct(iprot);
        }

        @Override
        public InvalidUserIdException readAsStruct(final org.thryft.protocol.InputProtocol iprot,
                final com.google.common.base.Optional<org.thryft.CompoundType.UnknownFieldCallback> unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
            return InvalidUserIdException.readAsStruct(iprot, unknownFieldCallback);
        }
    }
    ...
    public static Builder builder(final InvalidUserIdException other) {
    ...
    public boolean equals(final java.lang.Object otherObject) {
        if (otherObject == this) {
            return true;
        } else if (!(otherObject instanceof InvalidUserIdException)) {
            return false;
        }

        final InvalidUserIdException other = (InvalidUserIdException)otherObject;
        return
    ...
    public String getThriftQualifiedClassName() {
        return "dressdiscover.api.models.user.invalid_user_id_exception.InvalidUserIdException";
    }
    ...
    public static InvalidUserIdException readAs(final org.thryft.protocol.InputProtocol iprot, final org.thryft.protocol.Type type) throws org.thryft.protocol.InputProtocolException {
        return readAs(iprot, type, com.google.common.base.Optional.<UnknownFieldCallback> absent());
    }

    public static InvalidUserIdException readAs(final org.thryft.protocol.InputProtocol iprot, final org.thryft.protocol.Type type, final com.google.common.base.Optional<UnknownFieldCallback> unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
        switch (type) {
        case LIST:
            return readAsList(iprot);
        case STRUCT:
    ...
    public void writeAsStruct(final org.thryft.protocol.OutputProtocol oprot) throws org.thryft.protocol.OutputProtocolException {
        oprot.writeStructBegin("org.dressdiscover.api.models.user.InvalidUserIdException");
        writeFields(oprot);
