 ...
 */
public final class CulturalContext implements org.thryft.Struct, org.dressdiscover.api.vocabularies.vra_core.Element {
    ...
    public static class DefaultConstructionValidator implements ConstructionValidator {
        ...
        public String validateText(final String text) throws RuntimeException {
            ...
            if (text.isEmpty()) {
                throw new IllegalArgumentException("org.dressdiscover.api.vocabularies.vra_core.cultural_context.CulturalContext: text is less than min length 1");
            }
            return text;
        }
    ...
    public static class DefaultReadValidator implements ReadValidator {
        ...
        public String validateText(final String text) throws org.thryft.protocol.InputProtocolException {
            ...
            if (text.isEmpty()) {
                throw new org.thryft.protocol.InvalidFieldInputProtocolException(FieldMetadata.TEXT, "org.dressdiscover.api.vocabularies.vra_core.cultural_context.CulturalContext: text is less than min length 1");
            }
            return text;
        }
    ...
    public boolean equals(final java.lang.Object otherObject) {
        ...
        if (!(otherObject instanceof CulturalContext)) {
            return false;
        }
