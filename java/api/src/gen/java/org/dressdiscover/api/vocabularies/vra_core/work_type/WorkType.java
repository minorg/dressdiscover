 ...
 */
public final class WorkType implements org.dressdiscover.api.vocabularies.vra_core.Element {
    public final static class Builder {
        ...
        protected WorkType _build(final String text, final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
    ...
    public final static class ReadValidator {
        ...
        public static void validateText(final String text) throws org.thryft.protocol.InputProtocolException {
            if (text == null) {
                throw new org.thryft.protocol.MissingFieldInputProtocolException(FieldMetadata.TEXT, "org.dressdiscover.api.vocabularies.vra_core.work_type.WorkType: text is null");
            }
            if (text.isEmpty()) {
                throw new org.thryft.protocol.InvalidFieldInputProtocolException(FieldMetadata.TEXT, "org.dressdiscover.api.vocabularies.vra_core.work_type.WorkType: text: less than min length 1");
            }
        }
        ...
        public static void validateVocabRef(final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) throws org.thryft.protocol.InputProtocolException {
            if (vocabRef == null) {
                throw new org.thryft.protocol.MissingFieldInputProtocolException(FieldMetadata.VOCAB_REF, "org.dressdiscover.api.vocabularies.vra_core.work_type.WorkType: vocabRef is null");
            }
        }
    }
    ...
    public final static class UncheckedValidator {
        ...
        public static void validateText(final String text) {
            if (text == null) {
                throw new NullPointerException("org.dressdiscover.api.vocabularies.vra_core.work_type.WorkType: text is null");
            }
            if (text.isEmpty()) {
                throw new IllegalArgumentException("org.dressdiscover.api.vocabularies.vra_core.work_type.WorkType: text: less than min length 1");
            }
        }
        ...
        public static void validateVocabRef(final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
            if (vocabRef == null) {
                throw new NullPointerException("org.dressdiscover.api.vocabularies.vra_core.work_type.WorkType: vocabRef is null");
            }
        }
    }
     ...
     */
    protected WorkType(final String text, final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
        this.text = text;
        this.vocabRef = vocabRef;
    }
    ...
    public static WorkType create(final String text) {
        ...
        return new WorkType(text, com.google.common.base.Optional.<org.dressdiscover.api.vocabularies.vra_core.VocabRef> absent());
    }

    /**
     * Total Nullable factory method
     */
    public static WorkType create(final String text, @javax.annotation.Nullable final org.dressdiscover.api.vocabularies.vra_core.VocabRef vocabRef) {
        ...
        return new WorkType(text, vocabRefOptional);
    }

    /**
     * Optional factory method
     */
    public static WorkType create(final String text, final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
        UncheckedValidator.validate(text, vocabRef);
        return new WorkType(text, vocabRef);
    }
    ...
    public boolean equals(final java.lang.Object otherObject) {
        ...
        if (!(otherObject instanceof WorkType)) {
            return false;
        }
    ...
    public static WorkType readAs(final org.thryft.protocol.InputProtocol iprot, final org.thryft.protocol.Type type, final com.google.common.base.Optional<UnknownFieldCallback> unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
        switch (type) {
        case LIST:
            return readAsList(iprot);
        case STRUCT:
    ...
    public static WorkType readAsStruct(final org.thryft.protocol.InputProtocol iprot, final com.google.common.base.Optional<UnknownFieldCallback> unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
    ...
    public WorkType replaceVocabRef(final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
        UncheckedValidator.validateVocabRef(vocabRef);
        return new WorkType(this.text, vocabRef);
    }

    public WorkType replaceVocabRef(@javax.annotation.Nullable final org.dressdiscover.api.vocabularies.vra_core.VocabRef vocabRef) {
    ...
    public void writeAsStruct(final org.thryft.protocol.OutputProtocol oprot) throws org.thryft.protocol.OutputProtocolException {
        oprot.writeStructBegin("org.dressdiscover.api.vocabularies.vra_core.work_type.WorkType");
        writeFields(oprot);
