...
public final class TextrefName implements org.thryft.Struct {
    public final static class Builder {
        ...
        public Builder readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
            try {
                ...
                type = iprot.readEnum(org.dressdiscover.api.vocabularies.vra_core.textref.TextrefNameType.Factory.getInstance());
                iprot.readListEnd();
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        ...
        TYPE("type", new com.google.common.reflect.TypeToken<org.dressdiscover.api.vocabularies.vra_core.textref.TextrefNameType>() {}, true, (short)2, "type", org.thryft.protocol.Type.STRING);
    ...
    public final static class ReadValidator {
        public static void validate(final String text, final org.dressdiscover.api.vocabularies.vra_core.textref.TextrefNameType type) throws org.thryft.protocol.InputProtocolException {
            validateText(text);
            validateType(type);
        }
        ...
        public static void validateText(final String text) throws org.thryft.protocol.InputProtocolException {
            ...
            if (text.isEmpty()) {
                throw new org.thryft.protocol.InvalidFieldInputProtocolException(FieldMetadata.TEXT, "org.dressdiscover.api.vocabularies.vra_core.textref.TextrefName: text: less than min length 1");
            }
        }

        public static void validateType(final org.dressdiscover.api.vocabularies.vra_core.textref.TextrefNameType type) throws org.thryft.protocol.InputProtocolException {
            if (type == null) {
    ...
    public final static class UncheckedValidator {
        ...
        public static void validateText(final String text) {
            ...
            if (text.isEmpty()) {
                throw new IllegalArgumentException("org.dressdiscover.api.vocabularies.vra_core.textref.TextrefName: text: less than min length 1");
            }
        }
     ...
     */
    protected TextrefName(final String text, final org.dressdiscover.api.vocabularies.vra_core.textref.TextrefNameType type) {
        this.text = text;
        this.type = type;
    }
    ...
    public static TextrefName readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
        String text;
        org.dressdiscover.api.vocabularies.vra_core.textref.TextrefNameType type;
    ...
    public static TextrefName readAsStruct(final org.thryft.protocol.InputProtocol iprot, final com.google.common.base.Optional<UnknownFieldCallback> unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
        ...
        @javax.annotation.Nullable org.dressdiscover.api.vocabularies.vra_core.textref.TextrefNameType type = null;
