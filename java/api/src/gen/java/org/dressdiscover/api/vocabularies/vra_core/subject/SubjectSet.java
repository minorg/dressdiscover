...
public final class SubjectSet implements org.dressdiscover.api.vocabularies.vra_core.ElementSet<org.dressdiscover.api.vocabularies.vra_core.subject.Subject> {
    public final static class Builder implements org.thryft.CompoundType.Builder<Builder, SubjectSet> {
        public Builder() {
            elements = null;
        ...
        public Builder readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
            try {
                ...
                try {
                    this.setElements((new com.google.common.base.Function<org.thryft.protocol.InputProtocol, com.google.common.collect.ImmutableList<org.dressdiscover.api.vocabularies.vra_core.subject.Subject>>() {
                        @Override
    ...
    public final static class Factory implements org.thryft.CompoundType.Factory<SubjectSet> {
        ...
        @Override
        public SubjectSet readAsStruct(final org.thryft.protocol.InputProtocol iprot, final UnknownFieldCallback unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        ELEMENTS("elements", new com.google.common.reflect.TypeToken<com.google.common.collect.ImmutableList<org.dressdiscover.api.vocabularies.vra_core.subject.Subject>>() {}, true, (short)1, "elements", "1:elements", org.thryft.protocol.Type.LIST),
    ...
    public final static class Validator {
        ...
        public static void validateElements(final com.google.common.collect.ImmutableList<org.dressdiscover.api.vocabularies.vra_core.subject.Subject> elements) {
            if (elements == null) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.vra_core.subject.SubjectSet: elements is missing");
            }
            if (elements.isEmpty()) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.vra_core.subject.SubjectSet: elements: less than min length 1");
            }
        }

        public static void validateDisplay(final com.google.common.base.Optional<String> display) {
            if (display == null) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.vra_core.subject.SubjectSet: display is missing");
            }
            if (display.isPresent()) {
                if (display.get().isEmpty()) {
                    throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.vra_core.subject.SubjectSet: display: less than min length 1");
                }
            }
        }
        ...
        public static void validateNotes(final com.google.common.base.Optional<String> notes) {
            if (notes == null) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.vra_core.subject.SubjectSet: notes is missing");
            }
            if (notes.isPresent()) {
                if (notes.get().isEmpty()) {
                    throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.vra_core.subject.SubjectSet: notes: less than min length 1");
                }
            }
        }
    }
     ...
     */
    public SubjectSet(final com.google.common.collect.ImmutableList<org.dressdiscover.api.vocabularies.vra_core.subject.Subject> elements) {
     ...
     * Total constructor
     */
    public SubjectSet(final com.google.common.collect.ImmutableList<org.dressdiscover.api.vocabularies.vra_core.subject.Subject> elements, final com.google.common.base.Optional<String> display, final com.google.common.base.Optional<String> notes) {
        Validator.validate(elements, display, notes);
        this.elements = elements;
        this.display = display;
        this.notes = notes;
     ...
     */
    public SubjectSet(final com.google.common.collect.ImmutableList<org.dressdiscover.api.vocabularies.vra_core.subject.Subject> elements, @javax.annotation.Nullable final String display, @javax.annotation.Nullable final String notes) {
    ...
    public static SubjectSet readAsStruct(final org.thryft.protocol.InputProtocol iprot, final UnknownFieldCallback unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
