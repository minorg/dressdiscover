...
public final class AgentName implements org.thryft.Struct {
    public final static class Builder {
        ...
        protected AgentName _build(final String text, final org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType type, final com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> vocabRef) {
            return new AgentName(text, type, vocabRef, DefaultConstructionValidator.getInstance());
        }
        ...
        public Builder readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
            try {
                ...
                type = iprot.readEnum(org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType.class);
                if (__list.getSize() > 2) {
        ...
        private String text;
        private org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType type;
    ...
    public final static class Factory implements org.thryft.CompoundType.Factory<AgentName> {
        @Override
        public AgentName readAs(final org.thryft.protocol.InputProtocol iprot, final org.thryft.protocol.Type type) throws org.thryft.protocol.InputProtocolException {
            return AgentName.readAs(iprot, type);
        }

        @Override
        public AgentName readAs(final org.thryft.protocol.InputProtocol iprot, final org.thryft.protocol.Type type,
                final com.google.common.base.Optional<org.thryft.CompoundType.UnknownFieldCallback> unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
            return AgentName.readAs(iprot, type, unknownFieldCallback);
        }
        ...
        @Override
        public AgentName readAsStruct(final org.thryft.protocol.InputProtocol iprot,
                final com.google.common.base.Optional<org.thryft.CompoundType.UnknownFieldCallback> unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        ...
        TYPE("type", new com.google.common.reflect.TypeToken<org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType>() {}, true, 2, "type", org.thryft.protocol.Type.STRING),
    ...
    public interface Validator<ExceptionT extends Exception> {
        ...
        public org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType validateType(final org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType type) throws ExceptionT;
    ...
    public static class DefaultConstructionValidator implements ConstructionValidator {
        ...
        public String validateText(final String text) throws RuntimeException {
            if (text == null) {
                throw new NullPointerException("org.dressdiscover.api.vocabularies.vra_core.agent.AgentName: text is null");
            }
            if (text.isEmpty()) {
                throw new IllegalArgumentException("org.dressdiscover.api.vocabularies.vra_core.agent.AgentName: text is less than min length 1");
            }
            return text;
        }

        @Override
        public org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType validateType(final org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType type) throws RuntimeException {
            if (type == null) {
                throw new NullPointerException("org.dressdiscover.api.vocabularies.vra_core.agent.AgentName: type is null");
            }
            return type;
        }
        ...
        public com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> validateVocabRef(final com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> vocabRef) throws RuntimeException {
            if (vocabRef == null) {
                throw new NullPointerException("org.dressdiscover.api.vocabularies.vra_core.agent.AgentName: vocabRef is null");
            }
    ...
    public static class NopConstructionValidator implements ConstructionValidator {
        ...
        @Override
        public org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType validateType(final org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType type) {
            return type;
        }
    ...
    public static class DefaultReadValidator implements ReadValidator {
        ...
        public String validateText(final String text) throws org.thryft.protocol.InputProtocolException {
            if (text == null) {
                throw new org.thryft.protocol.MissingFieldInputProtocolException(FieldMetadata.TEXT, "org.dressdiscover.api.vocabularies.vra_core.agent.AgentName: text is null");
            }
            if (text.isEmpty()) {
                throw new org.thryft.protocol.InvalidFieldInputProtocolException(FieldMetadata.TEXT, "org.dressdiscover.api.vocabularies.vra_core.agent.AgentName: text is less than min length 1");
            }
            return text;
        }

        @Override
        public org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType validateType(final org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType type) throws org.thryft.protocol.InputProtocolException {
            if (type == null) {
                throw new org.thryft.protocol.MissingFieldInputProtocolException(FieldMetadata.TYPE, "org.dressdiscover.api.vocabularies.vra_core.agent.AgentName: type is null");
            }
            return type;
        }
        ...
        public com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> validateVocabRef(final com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> vocabRef) throws org.thryft.protocol.InputProtocolException {
            if (vocabRef == null) {
                throw new org.thryft.protocol.MissingFieldInputProtocolException(FieldMetadata.VOCAB_REF, "org.dressdiscover.api.vocabularies.vra_core.agent.AgentName: vocabRef is null");
            }
            if (!vocabRef.isPresent()) {
                return vocabRef;
            }
    ...
    protected AgentName(final String text, final org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType type, final com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> vocabRef, ConstructionValidator validator) {
     ...
     */
    public static AgentName create(final String text, final org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType type) {
        return new AgentName(text, type, com.google.common.base.Optional.<org.dressdiscover.api.models.VocabRef> absent(), DefaultConstructionValidator.getInstance());
    }

    /**
     * Total Nullable factory method
     */
    public static AgentName create(final String text, final org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType type, final @javax.annotation.Nullable org.dressdiscover.api.models.VocabRef vocabRef) {
        return new AgentName(text, type, com.google.common.base.Optional.fromNullable(vocabRef), DefaultConstructionValidator.getInstance());
    }

    /**
     * Optional factory method
     */
    public static AgentName create(final String text, final org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType type, final com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> vocabRef) {
        return new AgentName(text, type, vocabRef, DefaultConstructionValidator.getInstance());
    }
    ...
    public static AgentName readAs(final org.thryft.protocol.InputProtocol iprot, final org.thryft.protocol.Type type, final com.google.common.base.Optional<UnknownFieldCallback> unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
        switch (type) {
        case LIST:
            return readAsList(iprot);
        case STRUCT:
    ...
    public static AgentName readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
        String text = null;
        org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType type = null;
        ...
        return new AgentName(DefaultReadValidator.getInstance().validateText(text), DefaultReadValidator.getInstance().validateType(type), DefaultReadValidator.getInstance().validateVocabRef(vocabRef), NopConstructionValidator.getInstance());
    }
    ...
    public static AgentName readAsStruct(final org.thryft.protocol.InputProtocol iprot, final com.google.common.base.Optional<UnknownFieldCallback> unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
        String text = null;
        org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType type = null;
        com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> vocabRef = com.google.common.base.Optional.<org.dressdiscover.api.models.VocabRef> absent();
    ...
    public AgentName replaceText(final String text) {
        return new AgentName(DefaultConstructionValidator.getInstance().validateText(text), this.type, this.vocabRef, NopConstructionValidator.getInstance());
    }

    public AgentName replaceType(final org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType type) {
        return new AgentName(this.text, DefaultConstructionValidator.getInstance().validateType(type), this.vocabRef, NopConstructionValidator.getInstance());
    }

    public AgentName replaceVocabRef(final com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> vocabRef) {
        return new AgentName(this.text, this.type, DefaultConstructionValidator.getInstance().validateVocabRef(vocabRef), NopConstructionValidator.getInstance());
    }

    public AgentName replaceVocabRef(final org.dressdiscover.api.models.VocabRef vocabRef) {
