...
public final class AgentName implements org.thryft.Struct {
    public final static class Builder {
        ...
        public Builder readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
            try {
                ...
                type = iprot.readEnum(org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType.Factory.getInstance());
                if (__list.getSize() > 2) {
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        ...
        TYPE("type", new com.google.common.reflect.TypeToken<org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType>() {}, true, (short)2, "type", org.thryft.protocol.Type.STRING),
    ...
    public final static class ReadValidator {
        public static void validate(final String text, final org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType type, final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) throws org.thryft.protocol.InputProtocolException {
            validateText(text);
            validateType(type);
        ...
        public static void validateText(final String text) throws org.thryft.protocol.InputProtocolException {
            ...
            if (text.isEmpty()) {
                throw new org.thryft.protocol.InvalidFieldInputProtocolException(FieldMetadata.TEXT, "org.dressdiscover.api.vocabularies.vra_core.agent.AgentName: text: less than min length 1");
            }
        }

        public static void validateType(final org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType type) throws org.thryft.protocol.InputProtocolException {
            if (type == null) {
    ...
    public final static class UncheckedValidator {
        ...
        public static void validateText(final String text) {
            ...
            if (text.isEmpty()) {
                throw new IllegalArgumentException("org.dressdiscover.api.vocabularies.vra_core.agent.AgentName: text: less than min length 1");
            }
        }
     ...
     */
    protected AgentName(final String text, final org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType type, final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
        this.text = text;
        this.type = type;
        this.vocabRef = vocabRef;
    }
    ...
    public static AgentName create(final String text, final org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType type) {
        ...
        return new AgentName(text, type, com.google.common.base.Optional.<org.dressdiscover.api.vocabularies.vra_core.VocabRef> absent());
    }

    /**
     * Total Nullable factory method
     */
    public static AgentName create(final String text, final org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType type, @javax.annotation.Nullable final org.dressdiscover.api.vocabularies.vra_core.VocabRef vocabRef) {
        ...
        return new AgentName(text, type, vocabRefOptional);
    }

    /**
     * Optional factory method
     */
    public static AgentName create(final String text, final org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType type, final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
        UncheckedValidator.validate(text, type, vocabRef);
        return new AgentName(text, type, vocabRef);
    }
    ...
    public static AgentName readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
        String text;
        org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType type;
    ...
    public static AgentName readAsStruct(final org.thryft.protocol.InputProtocol iprot, final com.google.common.base.Optional<UnknownFieldCallback> unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
        ...
        @javax.annotation.Nullable org.dressdiscover.api.vocabularies.vra_core.agent.AgentNameType type = null;
        com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef = com.google.common.base.Optional.<org.dressdiscover.api.vocabularies.vra_core.VocabRef> absent();
