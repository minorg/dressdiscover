...
public final class ClosurePlacement implements org.thryft.Struct {
    public final static class Builder {
        ...
        protected ClosurePlacement _build(final String text, final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
            return new ClosurePlacement(text, vocabRef);
        }
    ...
    public final static class ReadValidator {
        ...
        public static void validateText(final String text) throws org.thryft.protocol.InputProtocolException {
            if (text == null) {
                throw new org.thryft.protocol.MissingFieldInputProtocolException(FieldMetadata.TEXT, "org.dressdiscover.api.vocabularies.costume_core.closure.ClosurePlacement: text is null");
            }
            if (text.isEmpty()) {
                throw new org.thryft.protocol.InvalidFieldInputProtocolException(FieldMetadata.TEXT, "org.dressdiscover.api.vocabularies.costume_core.closure.ClosurePlacement.text: less than min length 1");
            }
        }
        ...
        public static void validateVocabRef(final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) throws org.thryft.protocol.InputProtocolException {
            if (vocabRef == null) {
                throw new org.thryft.protocol.MissingFieldInputProtocolException(FieldMetadata.VOCAB_REF, "org.dressdiscover.api.vocabularies.costume_core.closure.ClosurePlacement: vocabRef is null");
            }
    ...
    public final static class UncheckedValidator {
        ...
        public static void validateText(final String text) {
            if (text == null) {
                throw new NullPointerException("org.dressdiscover.api.vocabularies.costume_core.closure.ClosurePlacement: text is null");
            }
            if (text.isEmpty()) {
                throw new IllegalArgumentException("org.dressdiscover.api.vocabularies.costume_core.closure.ClosurePlacement.text: less than min length 1");
            }
        }
        ...
        public static void validateVocabRef(final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
            if (vocabRef == null) {
                throw new NullPointerException("org.dressdiscover.api.vocabularies.costume_core.closure.ClosurePlacement: vocabRef is null");
            }
            if (!vocabRef.isPresent()) {
                return;
            }
     ...
     */
    protected ClosurePlacement(final String text, final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
        this.text = text;
        this.vocabRef = vocabRef;
    }
    ...
    public static ClosurePlacement create(final String text) {
        ...
        return new ClosurePlacement(text, com.google.common.base.Optional.<org.dressdiscover.api.vocabularies.vra_core.VocabRef> absent());
    }

    /**
     * Total Nullable factory method
     */
    public static ClosurePlacement create(final String text, @javax.annotation.Nullable final org.dressdiscover.api.vocabularies.vra_core.VocabRef vocabRef) {
        ...
        return new ClosurePlacement(text, vocabRefOptional);
    }

    /**
     * Optional factory method
     */
    public static ClosurePlacement create(final String text, final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
        UncheckedValidator.validate(text, vocabRef);
        return new ClosurePlacement(text, vocabRef);
    }
    ...
    public boolean equals(final java.lang.Object otherObject) {
        ...
        if (!(otherObject instanceof ClosurePlacement)) {
            return false;
        }
    ...
    public ClosurePlacement replaceText(final String text) {
        UncheckedValidator.validateText(text);
        return new ClosurePlacement(text, this.vocabRef);
    }

    public ClosurePlacement replaceVocabRef(final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
        UncheckedValidator.validateVocabRef(vocabRef);
        return new ClosurePlacement(this.text, vocabRef);
    }

    public ClosurePlacement replaceVocabRef(@javax.annotation.Nullable final org.dressdiscover.api.vocabularies.vra_core.VocabRef vocabRef) {
    ...
    public void writeAsStruct(final org.thryft.protocol.OutputProtocol oprot) throws org.thryft.protocol.OutputProtocolException {
        oprot.writeStructBegin("org.dressdiscover.api.vocabularies.costume_core.closure.ClosurePlacement");
        writeFields(oprot);
