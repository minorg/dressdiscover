...
public final class InvalidCollectionIdException extends org.thryft.Exception {
    public final static class Builder {
        ...
        protected InvalidCollectionIdException _build(final String causeMessage) {
            return new InvalidCollectionIdException(causeMessage, DefaultConstructionValidator.getInstance());
        }
    ...
    public static class DefaultConstructionValidator implements ConstructionValidator {
        ...
        public String validateCauseMessage(final String causeMessage) throws RuntimeException {
            if (causeMessage == null) {
                throw new NullPointerException("org.dressdiscover.api.models.collection.InvalidCollectionIdException: causeMessage is null");
            }
            return causeMessage;
        }
    ...
    public static class DefaultReadValidator implements ReadValidator {
        ...
        public String validateCauseMessage(final String causeMessage) throws org.thryft.protocol.InputProtocolException {
            if (causeMessage == null) {
                throw new org.thryft.protocol.MissingFieldInputProtocolException(FieldMetadata.CAUSE_MESSAGE, "org.dressdiscover.api.models.collection.InvalidCollectionIdException: causeMessage is null");
            }
            return causeMessage;
        }
    ...
    protected InvalidCollectionIdException(final String causeMessage, ConstructionValidator validator) {
    ...
    public static InvalidCollectionIdException readAs(final org.thryft.protocol.InputProtocol iprot, final org.thryft.protocol.Type type, final com.google.common.base.Optional<UnknownFieldCallback> unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
        switch (type) {
        case LIST:
            return readAsList(iprot);
        case STRUCT:
    ...
    public static InvalidCollectionIdException readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
        ...
        causeMessage = iprot.readString();
        iprot.readListEnd();
        return new InvalidCollectionIdException(DefaultReadValidator.getInstance().validateCauseMessage(causeMessage), NopConstructionValidator.getInstance());
    }
    ...
    public static InvalidCollectionIdException readAsStruct(final org.thryft.protocol.InputProtocol iprot, final com.google.common.base.Optional<UnknownFieldCallback> unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
        String causeMessage = null;
    ...
    public InvalidCollectionIdException replaceCauseMessage(final String causeMessage) {
        return new InvalidCollectionIdException(DefaultConstructionValidator.getInstance().validateCauseMessage(causeMessage), NopConstructionValidator.getInstance());
    }
