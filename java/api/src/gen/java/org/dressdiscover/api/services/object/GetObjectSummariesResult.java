...
public final class GetObjectSummariesResult implements org.thryft.Struct {
    public final static class Builder implements org.thryft.CompoundType.Builder<Builder, GetObjectSummariesResult> {
        public Builder() {
            hits = null;
            totalHits = 0;
        ...
        public GetObjectSummariesResult build() {
            Validator.validate(hits, totalHits, facets);
        ...
        public Builder readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
            try {
                ...
                try {
                    this.setHits((new com.google.common.base.Function<org.thryft.protocol.InputProtocol, com.google.common.collect.ImmutableList<org.dressdiscover.api.models.object.ObjectSummaryEntry>>() {
                        @Override
                ...
                try {
                    this.setTotalHits(iprot.readI32());
                } catch (final NumberFormatException e) {
                     throw new org.thryft.protocol.InvalidFieldInputProtocolException(FieldMetadata.TOTAL_HITS, e);
                }
                if (__list.getSize() > 2) {
                    this.setFacets(com.google.common.base.Optional.of(org.dressdiscover.api.models.object.ObjectFacets.readAsStruct(iprot)));
                }
                iprot.readListEnd();
                return this;
        ...
        public Builder readAsStruct(final org.thryft.protocol.InputProtocol iprot, final UnknownFieldCallback unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
            try {
                ...
                while (true) {
                    ...
                    case "facets": {
                        this.setFacets(com.google.common.base.Optional.of(org.dressdiscover.api.models.object.ObjectFacets.readAsStruct(iprot, unknownFieldCallback)));
                        break;
                    }
                    default:
        ...
        public Builder setFacets(final com.google.common.base.Optional<org.dressdiscover.api.models.object.ObjectFacets> facets) {
            Validator.validateFacets(facets);
            this.facets = facets;
            return this;
        }
        ...
        public Builder setTotalHits(final int totalHits) {
            Validator.validateTotalHits(totalHits);
    ...
    public final static class Factory implements org.thryft.CompoundType.Factory<GetObjectSummariesResult> {
        ...
        @Override
        public GetObjectSummariesResult readAsStruct(final org.thryft.protocol.InputProtocol iprot, final UnknownFieldCallback unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        HITS("hits", new com.google.common.reflect.TypeToken<com.google.common.collect.ImmutableList<org.dressdiscover.api.models.object.ObjectSummaryEntry>>() {}, true, (short)0, "hits", "hits", org.thryft.protocol.Type.LIST),
        TOTAL_HITS("totalHits", new com.google.common.reflect.TypeToken<Integer>() {}, true, (short)0, "total_hits", "total_hits", org.thryft.protocol.Type.I32),
        FACETS("facets", new com.google.common.reflect.TypeToken<org.dressdiscover.api.models.object.ObjectFacets>() {}, false, (short)0, "facets", "facets", org.thryft.protocol.Type.STRUCT);
    ...
    public final static class Validator {
        ...
        public static void validateHits(final com.google.common.collect.ImmutableList<org.dressdiscover.api.models.object.ObjectSummaryEntry> hits) {
            if (hits == null) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.services.object.GetObjectSummariesResult: hits is missing");
            }
        }
        ...
        public static void validateFacets(final com.google.common.base.Optional<org.dressdiscover.api.models.object.ObjectFacets> facets) {
            if (facets == null) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.services.object.GetObjectSummariesResult: facets is missing");
            }
        }
    }
     ...
     */
    public GetObjectSummariesResult(final com.google.common.collect.ImmutableList<org.dressdiscover.api.models.object.ObjectSummaryEntry> hits, final int totalHits) {
        this(hits, totalHits, com.google.common.base.Optional.<org.dressdiscover.api.models.object.ObjectFacets> absent());
    }

    /**
     * Total constructor
     */
    public GetObjectSummariesResult(final com.google.common.collect.ImmutableList<org.dressdiscover.api.models.object.ObjectSummaryEntry> hits, final int totalHits, final com.google.common.base.Optional<org.dressdiscover.api.models.object.ObjectFacets> facets) {
        Validator.validate(hits, totalHits, facets);
        this.hits = hits;
        this.totalHits = totalHits;
        this.facets = facets;
     ...
     */
    public GetObjectSummariesResult(final com.google.common.collect.ImmutableList<org.dressdiscover.api.models.object.ObjectSummaryEntry> hits, final int totalHits, @javax.annotation.Nullable final org.dressdiscover.api.models.object.ObjectFacets facets) {
        this(hits, totalHits, com.google.common.base.Optional.fromNullable(facets));
    }
    ...
    public static GetObjectSummariesResult readAsStruct(final org.thryft.protocol.InputProtocol iprot, final UnknownFieldCallback unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
