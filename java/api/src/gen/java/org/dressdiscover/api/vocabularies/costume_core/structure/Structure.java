...
public final class Structure implements org.dressdiscover.api.vocabularies.vra_core.Element {
    public final static class Builder implements org.thryft.CompoundType.Builder<Builder, Structure> {
        public Builder() {
            text = null;
            type = null;
        ...
        public Builder readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
            try {
                ...
                this.setType(org.dressdiscover.api.vocabularies.costume_core.structure.StructureType.readAsStruct(iprot));
                if (__list.getSize() > 2) {
                ...
                while (true) {
                    ...
                    case "type": {
                        if (!ifield.hasId() || ifield.getId() == 2) {
                                this.setType(org.dressdiscover.api.vocabularies.costume_core.structure.StructureType.readAsStruct(iprot, unknownFieldCallback));
                        }
                        break;
                    }
                    case "vocab_ref": {
    ...
    public final static class Factory implements org.thryft.CompoundType.Factory<Structure> {
        ...
        @Override
        public Structure readAsStruct(final org.thryft.protocol.InputProtocol iprot, final UnknownFieldCallback unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        ...
        TYPE("type", new com.google.common.reflect.TypeToken<org.dressdiscover.api.vocabularies.costume_core.structure.StructureType>() {}, true, (short)2, "type", "2:type", org.thryft.protocol.Type.STRUCT),
        VOCAB_REF("vocabRef", new com.google.common.reflect.TypeToken<org.dressdiscover.api.vocabularies.vra_core.VocabRef>() {}, false, (short)3, "vocab_ref", "3:vocab_ref", org.thryft.protocol.Type.STRUCT);
    ...
    public final static class Validator {
        ...
        public static void validateText(final String text) {
            if (text == null) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.costume_core.structure.Structure: text is missing");
            }
            if (text.isEmpty()) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.costume_core.structure.Structure: text: less than min length 1");
            }
        }

        public static void validateType(final org.dressdiscover.api.vocabularies.costume_core.structure.StructureType type) {
            if (type == null) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.costume_core.structure.Structure: type is missing");
            }
        }
        ...
        public static void validateVocabRef(final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
            if (vocabRef == null) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.costume_core.structure.Structure: vocabRef is missing");
            }
        }
    }
     ...
     */
    public Structure(final String text, final org.dressdiscover.api.vocabularies.costume_core.structure.StructureType type) {
     ...
     * Total constructor
     */
    public Structure(final String text, final org.dressdiscover.api.vocabularies.costume_core.structure.StructureType type, final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
        Validator.validate(text, type, vocabRef);
        this.text = text;
        this.type = type;
        this.vocabRef = vocabRef;
     ...
     */
    public Structure(final String text, final org.dressdiscover.api.vocabularies.costume_core.structure.StructureType type, @javax.annotation.Nullable final org.dressdiscover.api.vocabularies.vra_core.VocabRef vocabRef) {
    ...
    public static Structure readAsStruct(final org.thryft.protocol.InputProtocol iprot, final UnknownFieldCallback unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
