 ...
 */
public final class Structure implements org.thryft.Struct, org.dressdiscover.api.vocabularies.vra_core.Element {
    public final static class Builder {
        ...
        protected Structure _build(final String text, final org.dressdiscover.api.vocabularies.costume_core.structure.StructureType type, final com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> vocabRef) {
        ...
        private String text;
        private org.dressdiscover.api.vocabularies.costume_core.structure.StructureType type;
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        ...
        TYPE("type", new com.google.common.reflect.TypeToken<org.dressdiscover.api.vocabularies.costume_core.structure.StructureType>() {}, true, 2, "type", org.thryft.protocol.Type.STRUCT),
    ...
    public interface Validator<ExceptionT extends Exception> {
        ...
        public org.dressdiscover.api.vocabularies.costume_core.structure.StructureType validateType(final org.dressdiscover.api.vocabularies.costume_core.structure.StructureType type) throws ExceptionT;
    ...
    public static class DefaultConstructionValidator implements ConstructionValidator {
        ...
        public String validateText(final String text) throws RuntimeException {
            ...
            if (text.isEmpty()) {
                throw new IllegalArgumentException("org.dressdiscover.api.vocabularies.costume_core.structure.Structure: text is less than min length 1");
            }
            return text;
        }

        @Override
        public org.dressdiscover.api.vocabularies.costume_core.structure.StructureType validateType(final org.dressdiscover.api.vocabularies.costume_core.structure.StructureType type) throws RuntimeException {
            if (type == null) {
    ...
    public static class NopConstructionValidator implements ConstructionValidator {
        ...
        @Override
        public org.dressdiscover.api.vocabularies.costume_core.structure.StructureType validateType(final org.dressdiscover.api.vocabularies.costume_core.structure.StructureType type) {
            return type;
        }
    ...
    public static class DefaultReadValidator implements ReadValidator {
        ...
        public String validateText(final String text) throws org.thryft.protocol.InputProtocolException {
            ...
            if (text.isEmpty()) {
                throw new org.thryft.protocol.InvalidFieldInputProtocolException(FieldMetadata.TEXT, "org.dressdiscover.api.vocabularies.costume_core.structure.Structure: text is less than min length 1");
            }
            return text;
        }

        @Override
        public org.dressdiscover.api.vocabularies.costume_core.structure.StructureType validateType(final org.dressdiscover.api.vocabularies.costume_core.structure.StructureType type) throws org.thryft.protocol.InputProtocolException {
            if (type == null) {
    ...
    protected Structure(final String text, final org.dressdiscover.api.vocabularies.costume_core.structure.StructureType type, final com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> vocabRef, ConstructionValidator validator) {
     ...
     */
    public static Structure create(final String text, final org.dressdiscover.api.vocabularies.costume_core.structure.StructureType type, final @javax.annotation.Nullable org.dressdiscover.api.models.VocabRef vocabRef) {
     ...
     */
    public static Structure create(final String text, final org.dressdiscover.api.vocabularies.costume_core.structure.StructureType type, final com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> vocabRef) {
        return new Structure(text, type, vocabRef, DefaultConstructionValidator.getInstance());
    }
    ...
    public static Structure readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
        String text = null;
        org.dressdiscover.api.vocabularies.costume_core.structure.StructureType type = null;
