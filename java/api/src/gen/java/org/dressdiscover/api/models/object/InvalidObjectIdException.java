...
public final class InvalidObjectIdException extends org.thryft.Exception {
    public final static class Builder {
        ...
        protected InvalidObjectIdException _build(final String causeMessage) {
            return new InvalidObjectIdException(causeMessage, DefaultConstructionValidator.getInstance());
        }
    ...
    protected InvalidObjectIdException(final String causeMessage, ConstructionValidator validator) {
    ...
    public static InvalidObjectIdException readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
        ...
        return new InvalidObjectIdException(DefaultReadValidator.getInstance().validateCauseMessage(causeMessage), NopConstructionValidator.getInstance());
    }
    ...
    public InvalidObjectIdException replaceCauseMessage(final String causeMessage) {
        return new InvalidObjectIdException(DefaultConstructionValidator.getInstance().validateCauseMessage(causeMessage), NopConstructionValidator.getInstance());
    }
