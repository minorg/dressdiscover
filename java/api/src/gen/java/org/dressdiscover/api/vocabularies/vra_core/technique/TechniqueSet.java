...
public final class TechniqueSet implements org.dressdiscover.api.vocabularies.vra_core.ElementSet<org.dressdiscover.api.vocabularies.vra_core.technique.Technique> {
    public final static class Builder implements org.thryft.CompoundType.Builder<Builder, TechniqueSet> {
        public Builder() {
            elements = null;
        ...
        public Builder readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
            try {
                ...
                try {
                    this.setElements((new com.google.common.base.Function<org.thryft.protocol.InputProtocol, com.google.common.collect.ImmutableList<org.dressdiscover.api.vocabularies.vra_core.technique.Technique>>() {
                        @Override
                        public com.google.common.collect.ImmutableList<org.dressdiscover.api.vocabularies.vra_core.technique.Technique> apply(final org.thryft.protocol.InputProtocol iprot) {
                            try {
        ...
        public Builder set(final FieldMetadata fieldMetadata, @javax.annotation.Nullable final java.lang.Object value) {
            ...
            case ELEMENTS: setElements((com.google.common.collect.ImmutableList<org.dressdiscover.api.vocabularies.vra_core.technique.Technique>)value); return this;
    ...
    public final static class Factory implements org.thryft.CompoundType.Factory<TechniqueSet> {
        ...
        @Override
        public TechniqueSet readAsStruct(final org.thryft.protocol.InputProtocol iprot, final UnknownFieldCallback unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        ELEMENTS("elements", new com.google.common.reflect.TypeToken<com.google.common.collect.ImmutableList<org.dressdiscover.api.vocabularies.vra_core.technique.Technique>>() {}, true, (short)1, "elements", "1:elements", org.thryft.protocol.Type.LIST),
    ...
    public final static class Validator {
        ...
        public static void validateElements(final com.google.common.collect.ImmutableList<org.dressdiscover.api.vocabularies.vra_core.technique.Technique> elements) {
            if (elements == null) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.vra_core.technique.TechniqueSet: elements is missing");
            }
            if (elements.isEmpty()) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.vra_core.technique.TechniqueSet: elements: less than min length 1");
            }
        }

        public static void validateDisplay(final com.google.common.base.Optional<String> display) {
            if (display == null) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.vra_core.technique.TechniqueSet: display is missing");
            }
            if (display.isPresent()) {
                if (display.get().isEmpty()) {
                    throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.vra_core.technique.TechniqueSet: display: less than min length 1");
                }
            }
        }
        ...
        public static void validateNotes(final com.google.common.base.Optional<String> notes) {
            if (notes == null) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.vra_core.technique.TechniqueSet: notes is missing");
            }
            if (notes.isPresent()) {
                if (notes.get().isEmpty()) {
                    throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.vra_core.technique.TechniqueSet: notes: less than min length 1");
                }
            }
        }
    }
     ...
     */
    public TechniqueSet(final com.google.common.collect.ImmutableList<org.dressdiscover.api.vocabularies.vra_core.technique.Technique> elements) {
     ...
     * Total constructor
     */
    public TechniqueSet(final com.google.common.collect.ImmutableList<org.dressdiscover.api.vocabularies.vra_core.technique.Technique> elements, final com.google.common.base.Optional<String> display, final com.google.common.base.Optional<String> notes) {
        Validator.validate(elements, display, notes);
        this.elements = elements;
        this.display = display;
        this.notes = notes;
     ...
     */
    public TechniqueSet(final com.google.common.collect.ImmutableList<org.dressdiscover.api.vocabularies.vra_core.technique.Technique> elements, @javax.annotation.Nullable final String display, @javax.annotation.Nullable final String notes) {
    ...
    public boolean equals(final java.lang.Object otherObject) {
        ...
        if (!(otherObject instanceof TechniqueSet)) {
            return false;
        }
    ...
    public static TechniqueSet readAsStruct(final org.thryft.protocol.InputProtocol iprot, final UnknownFieldCallback unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
    ...
    public void writeAsStruct(final org.thryft.protocol.OutputProtocol oprot) throws org.thryft.protocol.OutputProtocolException {
        oprot.writeStructBegin("org.dressdiscover.api.vocabularies.vra_core.technique.TechniqueSet");
        writeFields(oprot);
