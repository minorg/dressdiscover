...
public final class CollectionStoreConfiguration implements org.thryft.Struct {
    public final static class Builder implements org.thryft.CompoundType.Builder<Builder, CollectionStoreConfiguration> {
        public Builder() {
            type = null;
    ...
    public final static class Factory implements org.thryft.CompoundType.Factory<CollectionStoreConfiguration> {
        ...
        @Override
        public CollectionStoreConfiguration readAsStruct(final org.thryft.protocol.InputProtocol iprot, final UnknownFieldCallback unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
    ...
    public final static class Validator {
        ...
        public static void validateType(final String type) {
            if (type == null) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.models.configuration.CollectionStoreConfiguration: type is missing");
            }
        }
        ...
        public static void validateParameters(final com.google.common.base.Optional<com.google.common.collect.ImmutableMap<String, String>> parameters) {
            if (parameters == null) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.models.configuration.CollectionStoreConfiguration: parameters is missing");
            }
            if (parameters.isPresent()) {
                if (parameters.get().isEmpty()) {
                    throw new org.thryft.ThryftValidationException("org.dressdiscover.api.models.configuration.CollectionStoreConfiguration: parameters: less than min length 1");
                }
            }
        }
    }
     ...
     */
    public CollectionStoreConfiguration(final String type) {
     ...
     * Total constructor
     */
    public CollectionStoreConfiguration(final String type, final com.google.common.base.Optional<com.google.common.collect.ImmutableMap<String, String>> parameters) {
        Validator.validate(type, parameters);
        this.type = type;
        this.parameters = parameters;
    }
     ...
     */
    public CollectionStoreConfiguration(final String type, @javax.annotation.Nullable final com.google.common.collect.ImmutableMap<String, String> parameters) {
    ...
    public static CollectionStoreConfiguration readAsStruct(final org.thryft.protocol.InputProtocol iprot, final UnknownFieldCallback unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
