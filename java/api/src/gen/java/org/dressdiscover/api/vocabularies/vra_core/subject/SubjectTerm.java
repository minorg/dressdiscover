...
public final class SubjectTerm implements org.thryft.Struct {
    public final static class Builder implements org.thryft.CompoundType.Builder<Builder, SubjectTerm> {
        public Builder() {
            text = null;
            type = null;
        ...
        public Builder readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
            try {
                ...
                this.setType(iprot.readEnum(org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType.Factory.getInstance()));
                if (__list.getSize() > 2) {
    ...
    public final static class Factory implements org.thryft.CompoundType.Factory<SubjectTerm> {
        ...
        @Override
        public SubjectTerm readAsStruct(final org.thryft.protocol.InputProtocol iprot, final UnknownFieldCallback unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        ...
        TYPE("type", new com.google.common.reflect.TypeToken<org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType>() {}, true, (short)2, "type", "2:type", org.thryft.protocol.Type.STRING),
    ...
    public final static class Validator {
        ...
        public static void validateText(final String text) {
            if (text == null) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTerm: text is missing");
            }
            if (text.isEmpty()) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTerm: text: less than min length 1");
            }
        }

        public static void validateType(final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type) {
            if (type == null) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTerm: type is missing");
            }
        }
        ...
        public static void validateVocabRef(final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
            if (vocabRef == null) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTerm: vocabRef is missing");
            }
        }
    }
     ...
     */
    public SubjectTerm(final String text, final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type) {
     ...
     * Total constructor
     */
    public SubjectTerm(final String text, final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type, final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
        Validator.validate(text, type, vocabRef);
        this.text = text;
        this.type = type;
        this.vocabRef = vocabRef;
     ...
     */
    public SubjectTerm(final String text, final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type, @javax.annotation.Nullable final org.dressdiscover.api.vocabularies.vra_core.VocabRef vocabRef) {
    ...
    public static SubjectTerm readAsStruct(final org.thryft.protocol.InputProtocol iprot, final UnknownFieldCallback unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
