...
public final class SubjectTerm implements org.thryft.Struct {
    public final static class Builder {
        ...
        protected SubjectTerm _build(final String text, final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type, final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
        ...
        public final @javax.annotation.Nullable org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType getType() {
            return type;
        }
        ...
        public Builder readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
            try {
                ...
                type = iprot.readEnum(org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType.Factory.getInstance());
                if (__list.getSize() > 2) {
        ...
        public Builder set(final FieldMetadata fieldMetadata, @javax.annotation.Nullable final java.lang.Object value) {
            ...
            case TYPE: setType((org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType)value); return this;
        ...
        public Builder setType(final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type) {
        ...
        private @javax.annotation.Nullable org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type;
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        ...
        TYPE("type", new com.google.common.reflect.TypeToken<org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType>() {}, true, (short)2, "type", org.thryft.protocol.Type.STRING),
    ...
    public final static class ReadValidator {
        public static void validate(final String text, final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type, final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) throws org.thryft.protocol.InputProtocolException {
            validateText(text);
            validateType(type);
        ...
        public static void validateType(final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type) throws org.thryft.protocol.InputProtocolException {
            if (type == null) {
                throw new org.thryft.protocol.MissingFieldInputProtocolException(FieldMetadata.TYPE, "org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTerm: type is null");
            }
        }
    ...
    public final static class UncheckedValidator {
        public static void validate(final String text, final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type, final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
            validateText(text);
            validateType(type);
            validateVocabRef(vocabRef);
        }
        ...
        public static void validateType(final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type) {
            if (type == null) {
                throw new NullPointerException("org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTerm: type is null");
            }
        }
     ...
     */
    protected SubjectTerm(final String text, final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type, final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
        this.text = text;
        this.type = type;
        this.vocabRef = vocabRef;
    }
     ...
     */
    public static SubjectTerm create(final String text, final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type) {
        ...
        return new SubjectTerm(text, type, com.google.common.base.Optional.<org.dressdiscover.api.vocabularies.vra_core.VocabRef> absent());
    }

    /**
     * Total Nullable factory method
     */
    public static SubjectTerm create(final String text, final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type, @javax.annotation.Nullable final org.dressdiscover.api.vocabularies.vra_core.VocabRef vocabRef) {
        ...
        return new SubjectTerm(text, type, vocabRefOptional);
    }

    /**
     * Optional factory method
     */
    public static SubjectTerm create(final String text, final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type, final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
        UncheckedValidator.validate(text, type, vocabRef);
        return new SubjectTerm(text, type, vocabRef);
    }
    ...
    public boolean equals(final java.lang.Object otherObject) {
        ...
        if (!(otherObject instanceof SubjectTerm)) {
            return false;
        }
    ...
    public final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType getType() {
        return type;
    }
    ...
    public static SubjectTerm readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
        String text;
        org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type;
    ...
    public static SubjectTerm readAsStruct(final org.thryft.protocol.InputProtocol iprot, final com.google.common.base.Optional<UnknownFieldCallback> unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
        ...
        @javax.annotation.Nullable org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type = null;
        com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef = com.google.common.base.Optional.<org.dressdiscover.api.vocabularies.vra_core.VocabRef> absent();
    ...
    public SubjectTerm replaceType(final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type) {
        UncheckedValidator.validateType(type);
        return new SubjectTerm(this.text, type, this.vocabRef);
    }

    public SubjectTerm replaceVocabRef(final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
        UncheckedValidator.validateVocabRef(vocabRef);
        return new SubjectTerm(this.text, this.type, vocabRef);
    }

    public SubjectTerm replaceVocabRef(@javax.annotation.Nullable final org.dressdiscover.api.vocabularies.vra_core.VocabRef vocabRef) {
    ...
    public void writeAsStruct(final org.thryft.protocol.OutputProtocol oprot) throws org.thryft.protocol.OutputProtocolException {
        oprot.writeStructBegin("org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTerm");
        writeFields(oprot);
    ...
    private final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type;
