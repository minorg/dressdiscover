...
public final class SubjectTerm implements org.thryft.Struct {
    public final static class Builder {
        ...
        protected SubjectTerm _build(final String text, final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type, final com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> vocabRef) {
        ...
        public Builder readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
            try {
                ...
                type = iprot.readEnum(org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType.class);
                if (__list.getSize() > 2) {
        ...
        private String text;
        private org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type;
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        ...
        TYPE("type", new com.google.common.reflect.TypeToken<org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType>() {}, true, 2, "type", org.thryft.protocol.Type.STRING),
    ...
    public interface Validator<ExceptionT extends Exception> {
        ...
        public org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType validateType(final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type) throws ExceptionT;
    ...
    public static class DefaultConstructionValidator implements ConstructionValidator {
        ...
        public String validateText(final String text) throws RuntimeException {
            ...
            if (text.isEmpty()) {
                throw new IllegalArgumentException("org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTerm: text is less than min length 1");
            }
            return text;
        }

        @Override
        public org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType validateType(final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type) throws RuntimeException {
            if (type == null) {
    ...
    public static class NopConstructionValidator implements ConstructionValidator {
        ...
        @Override
        public org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType validateType(final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type) {
            return type;
        }
    ...
    public static class DefaultReadValidator implements ReadValidator {
        ...
        public String validateText(final String text) throws org.thryft.protocol.InputProtocolException {
            ...
            if (text.isEmpty()) {
                throw new org.thryft.protocol.InvalidFieldInputProtocolException(FieldMetadata.TEXT, "org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTerm: text is less than min length 1");
            }
            return text;
        }

        @Override
        public org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType validateType(final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type) throws org.thryft.protocol.InputProtocolException {
            if (type == null) {
    ...
    protected SubjectTerm(final String text, final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type, final com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> vocabRef, ConstructionValidator validator) {
     ...
     */
    public static SubjectTerm create(final String text, final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type, final @javax.annotation.Nullable org.dressdiscover.api.models.VocabRef vocabRef) {
     ...
     */
    public static SubjectTerm create(final String text, final org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type, final com.google.common.base.Optional<org.dressdiscover.api.models.VocabRef> vocabRef) {
        return new SubjectTerm(text, type, vocabRef, DefaultConstructionValidator.getInstance());
    }
    ...
    public static SubjectTerm readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
        String text = null;
        org.dressdiscover.api.vocabularies.vra_core.subject.SubjectTermType type = null;
