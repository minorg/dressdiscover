...
public final class Color implements org.dressdiscover.api.vocabularies.vra_core.Element {
    public final static class Builder implements org.thryft.CompoundType.Builder<Builder, Color> {
        public Builder() {
            text = null;
            type = null;
        ...
        public Builder readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
            try {
                ...
                this.setType(iprot.readEnum(org.dressdiscover.api.vocabularies.costume_core.color.ColorType.Factory.getInstance()));
                if (__list.getSize() > 2) {
    ...
    public final static class Factory implements org.thryft.CompoundType.Factory<Color> {
        ...
        @Override
        public Color readAsStruct(final org.thryft.protocol.InputProtocol iprot, final UnknownFieldCallback unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        ...
        TYPE("type", new com.google.common.reflect.TypeToken<org.dressdiscover.api.vocabularies.costume_core.color.ColorType>() {}, true, (short)2, "type", "2:type", org.thryft.protocol.Type.STRING),
    ...
    public final static class Validator {
        ...
        public static void validateText(final String text) {
            if (text == null) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.costume_core.color.Color: text is missing");
            }
            if (text.isEmpty()) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.costume_core.color.Color: text: less than min length 1");
            }
        }

        public static void validateType(final org.dressdiscover.api.vocabularies.costume_core.color.ColorType type) {
            if (type == null) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.costume_core.color.Color: type is missing");
            }
        }
        ...
        public static void validateVocabRef(final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
            if (vocabRef == null) {
                throw new org.thryft.ThryftValidationException("org.dressdiscover.api.vocabularies.costume_core.color.Color: vocabRef is missing");
            }
        }
    }
     ...
     */
    public Color(final String text, final org.dressdiscover.api.vocabularies.costume_core.color.ColorType type) {
     ...
     * Total constructor
     */
    public Color(final String text, final org.dressdiscover.api.vocabularies.costume_core.color.ColorType type, final com.google.common.base.Optional<org.dressdiscover.api.vocabularies.vra_core.VocabRef> vocabRef) {
        Validator.validate(text, type, vocabRef);
        this.text = text;
        this.type = type;
        this.vocabRef = vocabRef;
     ...
     */
    public Color(final String text, final org.dressdiscover.api.vocabularies.costume_core.color.ColorType type, @javax.annotation.Nullable final org.dressdiscover.api.vocabularies.vra_core.VocabRef vocabRef) {
    ...
    public static Color readAsStruct(final org.thryft.protocol.InputProtocol iprot, final UnknownFieldCallback unknownFieldCallback) throws org.thryft.protocol.InputProtocolException {
