...
public final class NoSuchObjectException extends org.thryft.waf.api.services.NoSuchModelException {
    public final static class Builder {
        public Builder() {
            id = com.google.common.base.Optional.<org.dressdiscover.api.models.qa.QaObjectId> absent();
        }
        ...
        protected NoSuchObjectException _build(final com.google.common.base.Optional<org.dressdiscover.api.models.qa.QaObjectId> id) {
        ...
        public final com.google.common.base.Optional<org.dressdiscover.api.models.qa.QaObjectId> getId() {
            return id;
        }
        ...
        public Builder readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
            try {
                ...
                if (__list.getSize() > 0) {
                    try {
                        id = com.google.common.base.Optional.of(org.dressdiscover.api.models.qa.QaObjectId.parse(iprot.readString()));
        ...
        public Builder setId(final com.google.common.base.Optional<org.dressdiscover.api.models.qa.QaObjectId> id) {
            this.id = DefaultConstructionValidator.getInstance().validateId(id);
            return this;
        }

        public Builder setId(@javax.annotation.Nullable final org.dressdiscover.api.models.qa.QaObjectId id) {
        ...
        public Builder unsetId() {
            this.id = com.google.common.base.Optional.<org.dressdiscover.api.models.qa.QaObjectId> absent();
            return this;
        }

        private com.google.common.base.Optional<org.dressdiscover.api.models.qa.QaObjectId> id;
    }
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        ID("id", new com.google.common.reflect.TypeToken<org.dressdiscover.api.models.qa.QaObjectId>() {}, false, 0, "id", org.thryft.protocol.Type.STRING);
    ...
    public interface Validator<ExceptionT extends Exception> {
        public com.google.common.base.Optional<org.dressdiscover.api.models.qa.QaObjectId> validateId(final com.google.common.base.Optional<org.dressdiscover.api.models.qa.QaObjectId> id) throws ExceptionT;
    }
    ...
    public static class DefaultConstructionValidator implements ConstructionValidator {
        ...
        @Override
        public com.google.common.base.Optional<org.dressdiscover.api.models.qa.QaObjectId> validateId(final com.google.common.base.Optional<org.dressdiscover.api.models.qa.QaObjectId> id) throws RuntimeException {
            if (id == null) {
                throw new NullPointerException("org.dressdiscover.api.services.qa.NoSuchObjectException: id is null");
            }
            if (!id.isPresent()) {
                return id;
            }
    ...
    public static class NopConstructionValidator implements ConstructionValidator {
        ...
        @Override
        public com.google.common.base.Optional<org.dressdiscover.api.models.qa.QaObjectId> validateId(final com.google.common.base.Optional<org.dressdiscover.api.models.qa.QaObjectId> id) {
            return id;
        }
    ...
    public static class DefaultReadValidator implements ReadValidator {
        ...
        @Override
        public com.google.common.base.Optional<org.dressdiscover.api.models.qa.QaObjectId> validateId(final com.google.common.base.Optional<org.dressdiscover.api.models.qa.QaObjectId> id) throws org.thryft.protocol.InputProtocolException {
            if (id == null) {
                throw new org.thryft.protocol.MissingFieldInputProtocolException(FieldMetadata.ID, "org.dressdiscover.api.services.qa.NoSuchObjectException: id is null");
            }
            if (!id.isPresent()) {
                return id;
            }
    ...
    protected NoSuchObjectException(final com.google.common.base.Optional<org.dressdiscover.api.models.qa.QaObjectId> id, ConstructionValidator validator) {
     ...
     */
    public static NoSuchObjectException create(final @javax.annotation.Nullable org.dressdiscover.api.models.qa.QaObjectId id) {
     ...
     */
    public static NoSuchObjectException create(final com.google.common.base.Optional<org.dressdiscover.api.models.qa.QaObjectId> id) {
        return new NoSuchObjectException(id, DefaultConstructionValidator.getInstance());
    }
    ...
    public boolean equals(final java.lang.Object otherObject) {
        ...
        if (!(otherObject instanceof NoSuchObjectException)) {
            return false;
        }

        final NoSuchObjectException other = (NoSuchObjectException)otherObject;
    ...
    public String getThriftQualifiedClassName() {
        return "dressdiscover.api.services.qa.no_such_object_exception.NoSuchObjectException";
    }
    ...
    public static NoSuchObjectException readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
        com.google.common.base.Optional<org.dressdiscover.api.models.qa.QaObjectId> id = com.google.common.base.Optional.<org.dressdiscover.api.models.qa.QaObjectId> absent();
    ...
    public NoSuchObjectException replaceId(final com.google.common.base.Optional<org.dressdiscover.api.models.qa.QaObjectId> id) {
    ...
    public NoSuchObjectException replaceId(final org.dressdiscover.api.models.qa.QaObjectId id) {
    ...
    public void writeAsMessage(final org.thryft.protocol.OutputProtocol oprot) throws org.thryft.protocol.OutputProtocolException {
        oprot.writeMessageBegin("org.dressdiscover.api.services.qa.NoSuchObjectException", org.thryft.protocol.MessageType.EXCEPTION, null);
    ...
    public void writeAsStruct(final org.thryft.protocol.OutputProtocol oprot) throws org.thryft.protocol.OutputProtocolException {
        oprot.writeStructBegin("org.dressdiscover.api.services.qa.NoSuchObjectException");
        writeFields(oprot);
    ...
    private final com.google.common.base.Optional<org.dressdiscover.api.models.qa.QaObjectId> id;
}
