...
public final class DublinCoreObject implements org.thryft.Struct {
    public final static class Builder {
        public Builder() {
            ...
            provenances = com.google.common.base.Optional.<String> absent();
        ...
        public final com.google.common.base.Optional<String> getProvenances() {
            return provenances;
        }
        ...
        public Builder readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
            try {
                ...
                if (__list.getSize() > 9) {
                    provenances = com.google.common.base.Optional.of(iprot.readString());
                }
        ...
        public Builder set(final FieldMetadata fieldMetadata, @javax.annotation.Nullable final java.lang.Object value) {
            ...
            case PROVENANCES: setProvenances((String)value); return this;
        ...
        public Builder setProvenances(final com.google.common.base.Optional<String> provenances) {
            this.provenances = DefaultConstructionValidator.getInstance().validateProvenances(provenances);
            return this;
        }

        public Builder setProvenances(@javax.annotation.Nullable final String provenances) {
        ...
        public Builder unsetProvenances() {
            this.provenances = com.google.common.base.Optional.<String> absent();
            return this;
        }
        ...
        private com.google.common.base.Optional<String> provenances;
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        ...
        PROVENANCES("provenances", new com.google.common.reflect.TypeToken<String>() {}, false, 10, "provenances", org.thryft.protocol.Type.STRING),
    ...
    public interface Validator<ExceptionT extends Exception> {
        ...
        public com.google.common.base.Optional<String> validateProvenances(final com.google.common.base.Optional<String> provenances) throws ExceptionT;
    ...
    public static class DefaultConstructionValidator implements ConstructionValidator {
        ...
        @Override
        public com.google.common.base.Optional<String> validateProvenances(final com.google.common.base.Optional<String> provenances) throws RuntimeException {
            if (provenances == null) {
    ...
    public static class NopConstructionValidator implements ConstructionValidator {
        ...
        @Override
        public com.google.common.base.Optional<String> validateProvenances(final com.google.common.base.Optional<String> provenances) {
            return provenances;
        }
    ...
    public static class DefaultReadValidator implements ReadValidator {
        ...
        @Override
        public com.google.common.base.Optional<String> validateProvenances(final com.google.common.base.Optional<String> provenances) throws org.thryft.protocol.InputProtocolException {
            if (provenances == null) {
    ...
    public DublinCoreObject(final DublinCoreObject other) {
        this(other.getAudiences(), other.getContributors(), other.getCoverages(), other.getCreators(), other.getDates(), other.getDescriptions(), other.getFormats(), other.getIdentifiers(), other.getLanguages(), other.getProvenances(), other.getPublishers(), other.getRelations(), other.getRights(), other.getRightsHolders(), other.getSources(), other.getSubjects(), other.getTitles(), other.getTypes(), NopConstructionValidator.getInstance());
    }
     ...
     */
    public static DublinCoreObject create(final @javax.annotation.Nullable com.google.common.collect.ImmutableList<String> audiences, final @javax.annotation.Nullable com.google.common.collect.ImmutableList<String> contributors, final @javax.annotation.Nullable com.google.common.collect.ImmutableList<String> coverages, final @javax.annotation.Nullable com.google.common.collect.ImmutableList<String> creators, final @javax.annotation.Nullable com.google.common.collect.ImmutableList<String> dates, final @javax.annotation.Nullable com.google.common.collect.ImmutableList<String> descriptions, final @javax.annotation.Nullable com.google.common.collect.ImmutableList<String> formats, final @javax.annotation.Nullable com.google.common.collect.ImmutableList<String> identifiers, final @javax.annotation.Nullable com.google.common.collect.ImmutableList<String> languages, final @javax.annotation.Nullable String provenances, final @javax.annotation.Nullable com.google.common.collect.ImmutableList<String> publishers, final @javax.annotation.Nullable com.google.common.collect.ImmutableList<String> relations, final @javax.annotation.Nullable com.google.common.collect.ImmutableList<String> rights, final @javax.annotation.Nullable com.google.common.collect.ImmutableList<String> rightsHolders, final @javax.annotation.Nullable com.google.common.collect.ImmutableList<String> sources, final @javax.annotation.Nullable com.google.common.collect.ImmutableList<String> subjects, final @javax.annotation.Nullable com.google.common.collect.ImmutableList<String> titles, final @javax.annotation.Nullable com.google.common.collect.ImmutableList<String> types) {
    ...
    public static DublinCoreObject readAsList(final org.thryft.protocol.InputProtocol iprot) throws org.thryft.protocol.InputProtocolException {
        ...
        com.google.common.base.Optional<String> provenances = com.google.common.base.Optional.<String> absent();
        ...
        return new DublinCoreObject(DefaultReadValidator.getInstance().validateAudiences(audiences), DefaultReadValidator.getInstance().validateContributors(contributors), DefaultReadValidator.getInstance().validateCoverages(coverages), DefaultReadValidator.getInstance().validateCreators(creators), DefaultReadValidator.getInstance().validateDates(dates), DefaultReadValidator.getInstance().validateDescriptions(descriptions), DefaultReadValidator.getInstance().validateFormats(formats), DefaultReadValidator.getInstance().validateIdentifiers(identifiers), DefaultReadValidator.getInstance().validateLanguages(languages), DefaultReadValidator.getInstance().validateProvenances(provenances), DefaultReadValidator.getInstance().validatePublishers(publishers), DefaultReadValidator.getInstance().validateRelations(relations), DefaultReadValidator.getInstance().validateRights(rights), DefaultReadValidator.getInstance().validateRightsHolders(rightsHolders), DefaultReadValidator.getInstance().validateSources(sources), DefaultReadValidator.getInstance().validateSubjects(subjects), DefaultReadValidator.getInstance().validateTitles(titles), DefaultReadValidator.getInstance().validateTypes(types), NopConstructionValidator.getInstance());
    }
    ...
    public DublinCoreObject replaceAudiences(final com.google.common.base.Optional<com.google.common.collect.ImmutableList<String>> audiences) {
        return new DublinCoreObject(DefaultConstructionValidator.getInstance().validateAudiences(audiences), this.contributors, this.coverages, this.creators, this.dates, this.descriptions, this.formats, this.identifiers, this.languages, this.provenances, this.publishers, this.relations, this.rights, this.rightsHolders, this.sources, this.subjects, this.titles, this.types, NopConstructionValidator.getInstance());
    }
    ...
    public DublinCoreObject replaceContributors(final com.google.common.base.Optional<com.google.common.collect.ImmutableList<String>> contributors) {
        return new DublinCoreObject(this.audiences, DefaultConstructionValidator.getInstance().validateContributors(contributors), this.coverages, this.creators, this.dates, this.descriptions, this.formats, this.identifiers, this.languages, this.provenances, this.publishers, this.relations, this.rights, this.rightsHolders, this.sources, this.subjects, this.titles, this.types, NopConstructionValidator.getInstance());
    }
    ...
    public DublinCoreObject replaceCoverages(final com.google.common.base.Optional<com.google.common.collect.ImmutableList<String>> coverages) {
        return new DublinCoreObject(this.audiences, this.contributors, DefaultConstructionValidator.getInstance().validateCoverages(coverages), this.creators, this.dates, this.descriptions, this.formats, this.identifiers, this.languages, this.provenances, this.publishers, this.relations, this.rights, this.rightsHolders, this.sources, this.subjects, this.titles, this.types, NopConstructionValidator.getInstance());
    }
    ...
    public DublinCoreObject replaceCreators(final com.google.common.base.Optional<com.google.common.collect.ImmutableList<String>> creators) {
        return new DublinCoreObject(this.audiences, this.contributors, this.coverages, DefaultConstructionValidator.getInstance().validateCreators(creators), this.dates, this.descriptions, this.formats, this.identifiers, this.languages, this.provenances, this.publishers, this.relations, this.rights, this.rightsHolders, this.sources, this.subjects, this.titles, this.types, NopConstructionValidator.getInstance());
    }
    ...
    public DublinCoreObject replaceDates(final com.google.common.base.Optional<com.google.common.collect.ImmutableList<String>> dates) {
        return new DublinCoreObject(this.audiences, this.contributors, this.coverages, this.creators, DefaultConstructionValidator.getInstance().validateDates(dates), this.descriptions, this.formats, this.identifiers, this.languages, this.provenances, this.publishers, this.relations, this.rights, this.rightsHolders, this.sources, this.subjects, this.titles, this.types, NopConstructionValidator.getInstance());
    }
    ...
    public DublinCoreObject replaceDescriptions(final com.google.common.base.Optional<com.google.common.collect.ImmutableList<String>> descriptions) {
        return new DublinCoreObject(this.audiences, this.contributors, this.coverages, this.creators, this.dates, DefaultConstructionValidator.getInstance().validateDescriptions(descriptions), this.formats, this.identifiers, this.languages, this.provenances, this.publishers, this.relations, this.rights, this.rightsHolders, this.sources, this.subjects, this.titles, this.types, NopConstructionValidator.getInstance());
    }
    ...
    public DublinCoreObject replaceFormats(final com.google.common.base.Optional<com.google.common.collect.ImmutableList<String>> formats) {
        return new DublinCoreObject(this.audiences, this.contributors, this.coverages, this.creators, this.dates, this.descriptions, DefaultConstructionValidator.getInstance().validateFormats(formats), this.identifiers, this.languages, this.provenances, this.publishers, this.relations, this.rights, this.rightsHolders, this.sources, this.subjects, this.titles, this.types, NopConstructionValidator.getInstance());
    }
    ...
    public DublinCoreObject replaceIdentifiers(final com.google.common.base.Optional<com.google.common.collect.ImmutableList<String>> identifiers) {
        return new DublinCoreObject(this.audiences, this.contributors, this.coverages, this.creators, this.dates, this.descriptions, this.formats, DefaultConstructionValidator.getInstance().validateIdentifiers(identifiers), this.languages, this.provenances, this.publishers, this.relations, this.rights, this.rightsHolders, this.sources, this.subjects, this.titles, this.types, NopConstructionValidator.getInstance());
    }
    ...
    public DublinCoreObject replaceLanguages(final com.google.common.base.Optional<com.google.common.collect.ImmutableList<String>> languages) {
        return new DublinCoreObject(this.audiences, this.contributors, this.coverages, this.creators, this.dates, this.descriptions, this.formats, this.identifiers, DefaultConstructionValidator.getInstance().validateLanguages(languages), this.provenances, this.publishers, this.relations, this.rights, this.rightsHolders, this.sources, this.subjects, this.titles, this.types, NopConstructionValidator.getInstance());
    }
    ...
    public DublinCoreObject replaceProvenances(final com.google.common.base.Optional<String> provenances) {
        return new DublinCoreObject(this.audiences, this.contributors, this.coverages, this.creators, this.dates, this.descriptions, this.formats, this.identifiers, this.languages, DefaultConstructionValidator.getInstance().validateProvenances(provenances), this.publishers, this.relations, this.rights, this.rightsHolders, this.sources, this.subjects, this.titles, this.types, NopConstructionValidator.getInstance());
    }

    public DublinCoreObject replaceProvenances(final String provenances) {
    ...
    public DublinCoreObject replacePublishers(final com.google.common.base.Optional<com.google.common.collect.ImmutableList<String>> publishers) {
        return new DublinCoreObject(this.audiences, this.contributors, this.coverages, this.creators, this.dates, this.descriptions, this.formats, this.identifiers, this.languages, this.provenances, DefaultConstructionValidator.getInstance().validatePublishers(publishers), this.relations, this.rights, this.rightsHolders, this.sources, this.subjects, this.titles, this.types, NopConstructionValidator.getInstance());
    }
    ...
    public DublinCoreObject replaceRelations(final com.google.common.base.Optional<com.google.common.collect.ImmutableList<String>> relations) {
        return new DublinCoreObject(this.audiences, this.contributors, this.coverages, this.creators, this.dates, this.descriptions, this.formats, this.identifiers, this.languages, this.provenances, this.publishers, DefaultConstructionValidator.getInstance().validateRelations(relations), this.rights, this.rightsHolders, this.sources, this.subjects, this.titles, this.types, NopConstructionValidator.getInstance());
    }
    ...
    public DublinCoreObject replaceRights(final com.google.common.base.Optional<com.google.common.collect.ImmutableList<String>> rights) {
        return new DublinCoreObject(this.audiences, this.contributors, this.coverages, this.creators, this.dates, this.descriptions, this.formats, this.identifiers, this.languages, this.provenances, this.publishers, this.relations, DefaultConstructionValidator.getInstance().validateRights(rights), this.rightsHolders, this.sources, this.subjects, this.titles, this.types, NopConstructionValidator.getInstance());
    }
    ...
    public DublinCoreObject replaceRightsHolders(final com.google.common.base.Optional<com.google.common.collect.ImmutableList<String>> rightsHolders) {
        return new DublinCoreObject(this.audiences, this.contributors, this.coverages, this.creators, this.dates, this.descriptions, this.formats, this.identifiers, this.languages, this.provenances, this.publishers, this.relations, this.rights, DefaultConstructionValidator.getInstance().validateRightsHolders(rightsHolders), this.sources, this.subjects, this.titles, this.types, NopConstructionValidator.getInstance());
    }
    ...
    public DublinCoreObject replaceSources(final com.google.common.base.Optional<com.google.common.collect.ImmutableList<String>> sources) {
        return new DublinCoreObject(this.audiences, this.contributors, this.coverages, this.creators, this.dates, this.descriptions, this.formats, this.identifiers, this.languages, this.provenances, this.publishers, this.relations, this.rights, this.rightsHolders, DefaultConstructionValidator.getInstance().validateSources(sources), this.subjects, this.titles, this.types, NopConstructionValidator.getInstance());
    }
    ...
    public DublinCoreObject replaceSubjects(final com.google.common.base.Optional<com.google.common.collect.ImmutableList<String>> subjects) {
        return new DublinCoreObject(this.audiences, this.contributors, this.coverages, this.creators, this.dates, this.descriptions, this.formats, this.identifiers, this.languages, this.provenances, this.publishers, this.relations, this.rights, this.rightsHolders, this.sources, DefaultConstructionValidator.getInstance().validateSubjects(subjects), this.titles, this.types, NopConstructionValidator.getInstance());
    }
    ...
    public DublinCoreObject replaceTitles(final com.google.common.base.Optional<com.google.common.collect.ImmutableList<String>> titles) {
        return new DublinCoreObject(this.audiences, this.contributors, this.coverages, this.creators, this.dates, this.descriptions, this.formats, this.identifiers, this.languages, this.provenances, this.publishers, this.relations, this.rights, this.rightsHolders, this.sources, this.subjects, DefaultConstructionValidator.getInstance().validateTitles(titles), this.types, NopConstructionValidator.getInstance());
    }
    ...
    public DublinCoreObject replaceTypes(final com.google.common.base.Optional<com.google.common.collect.ImmutableList<String>> types) {
        return new DublinCoreObject(this.audiences, this.contributors, this.coverages, this.creators, this.dates, this.descriptions, this.formats, this.identifiers, this.languages, this.provenances, this.publishers, this.relations, this.rights, this.rightsHolders, this.sources, this.subjects, this.titles, DefaultConstructionValidator.getInstance().validateTypes(types), NopConstructionValidator.getInstance());
    }
    ...
    public String toString() {
        return com.google.common.base.MoreObjects.toStringHelper(this).omitNullValues().add("audiences", getAudiences().orNull()).add("contributors", getContributors().orNull()).add("coverages", getCoverages().orNull()).add("creators", getCreators().orNull()).add("dates", getDates().orNull()).add("descriptions", getDescriptions().orNull()).add("formats", getFormats().orNull()).add("identifiers", getIdentifiers().orNull()).add("languages", getLanguages().orNull()).add("provenances", getProvenances().orNull()).add("publishers", getPublishers().orNull()).add("relations", getRelations().orNull()).add("rights", getRights().orNull()).add("rights_holders", getRightsHolders().orNull()).add("sources", getSources().orNull()).add("subjects", getSubjects().orNull()).add("titles", getTitles().orNull()).add("types", getTypes().orNull()).toString();
    }

    @Override
    public void writeAsList(final org.thryft.protocol.OutputProtocol oprot) throws org.thryft.protocol.OutputProtocolException {
        oprot.writeListBegin(org.thryft.protocol.Type.VOID_, 18);
        ...
        if (getProvenances().isPresent()) {
            oprot.writeString(getProvenances().get());
        } else {
            oprot.writeNull();
        }
    ...
    public void writeFields(final org.thryft.protocol.OutputProtocol oprot) throws org.thryft.protocol.OutputProtocolException {
        ...
        if (getProvenances().isPresent()) {
            oprot.writeFieldBegin("provenances", org.thryft.protocol.Type.STRING, (short)10);
            oprot.writeString(getProvenances().get());
            oprot.writeFieldEnd();
        }
    ...
    private final com.google.common.base.Optional<String> provenances;
