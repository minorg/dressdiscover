...
final class ObjectSummariesTable extends CustomComponent {
    public ObjectSummariesTable(final ImmutableMap<CollectionId, Collection> collections, final EventBus eventBus,
        ...
        {
            columns.put(ObjectSummary.FieldMetadata.THUMBNAIL.getJavaName(), "");
            columns.put(ObjectSummary.FieldMetadata.TITLE.getJavaName(), "Title");
            if (!objectFacets.getWorkTypeTexts().isEmpty()) {
                columns.put(ObjectSummary.FieldMetadata.WORK_TYPE_TEXTS.getJavaName(), "Type");
            }
            columns.put(ObjectSummary.FieldMetadata.DATE.getJavaName(), "Date");
            columns.put(ObjectSummary.FieldMetadata.INSTITUTION_ID.getJavaName(), "Institution");
            columns.put(ObjectSummary.FieldMetadata.COLLECTION_ID.getJavaName(), "Collection");
            columns.put(ObjectSummary.FieldMetadata.URL.getJavaName(), "URL");
        }
        ...
        table.addGeneratedColumn(ObjectSummary.FieldMetadata.COLLECTION_ID.getJavaName(), new ColumnGenerator() {
            @Override
        ...
        table.addGeneratedColumn(ObjectSummary.FieldMetadata.INSTITUTION_ID.getJavaName(), new ColumnGenerator() {
            @Override
            public java.lang.Object generateCell(final Table source, final java.lang.Object itemId,
                    final java.lang.Object columnId) {
        ...
        table.addGeneratedColumn(ObjectSummary.FieldMetadata.THUMBNAIL.getJavaName(), new ColumnGenerator() {
            @Override
            public java.lang.Object generateCell(final Table source, final java.lang.Object itemId,
                    final java.lang.Object columnId) {
        ...
        table.setCellStyleGenerator(new Table.CellStyleGenerator() {
            ...
            public String getStyle(final Table source, final java.lang.Object itemId,
                ...
                if (propertyId == null) {
                    return null;
                } else if (propertyId.equals(ObjectSummary.FieldMetadata.THUMBNAIL.getJavaName())) {
                    return "thumbnail";
                } else {
                    return null;
                }
        ...
        table.addGeneratedColumn(ObjectSummary.FieldMetadata.TITLE.getJavaName(), new ColumnGenerator() {
            @Override
            public java.lang.Object generateCell(final Table source, final java.lang.Object itemId,
                    final java.lang.Object columnId) {
        ...
        if (columns.containsKey(ObjectSummary.FieldMetadata.URL.getJavaName())) {
            table.addGeneratedColumn(ObjectSummary.FieldMetadata.URL.getJavaName(), new ColumnGenerator() {
                @Override
                public java.lang.Object generateCell(final Table source, final java.lang.Object itemId,
                        final java.lang.Object columnId) {
        ...
        if (!objectFacets.getWorkTypeTexts().isEmpty()) {
            table.addGeneratedColumn(ObjectSummary.FieldMetadata.WORK_TYPE_TEXTS.getJavaName(), new ColumnGenerator() {
                @Override
                public java.lang.Object generateCell(final Table source, final java.lang.Object itemId,
                        final java.lang.Object columnId) {
