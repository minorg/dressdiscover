...
public abstract class AbstractWizardFeaturePresenter<ParametersT extends AbstractWizardFeaturePresenter.Parameters, ViewT extends View>
    ...
    public abstract static class Parameters extends AbstractWizardPresenter.Parameters {
        protected Parameters(final WizardFeature feature, final WizardFeatureSet featureSet) {
            super(featureSet);
            this.feature = checkNotNull(feature);
        }

        public WizardFeature getFeature() {
            return feature;
        }

        @Override
        protected void _toMap(final Builder<String, String> builder) {
            super._toMap(builder);
            builder.put("feature", feature.getName());
        }

        private final WizardFeature feature;
    }
