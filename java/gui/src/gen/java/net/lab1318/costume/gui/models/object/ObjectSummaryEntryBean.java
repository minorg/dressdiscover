...
public class ObjectSummaryEntryBean {
    ...
    public boolean equals(final java.lang.Object otherObject) {
        if (otherObject == this) {
            return true;
        } else if (!(otherObject instanceof ObjectSummaryEntryBean)) {
            return false;
        }

        final ObjectSummaryEntryBean other = (ObjectSummaryEntryBean)otherObject;
        return
