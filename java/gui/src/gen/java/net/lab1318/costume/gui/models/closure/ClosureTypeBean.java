...
public class ClosureTypeBean implements org.thryft.StructBean {
    ...
    public ClosureTypeBean() {
        text = null;
        vocabRef = null;
    }

    public ClosureTypeBean(final net.lab1318.costume.api.models.closure.ClosureType other) {
    ...
    public boolean equals(final java.lang.Object otherObject) {
        if (otherObject == this) {
            return true;
        } else if (!(otherObject instanceof ClosureTypeBean)) {
            return false;
        }

        final ClosureTypeBean other = (ClosureTypeBean)otherObject;
        return
