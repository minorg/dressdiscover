 ...
 */
public class CulturalContextBean implements org.thryft.StructBean {
    ...
    public CulturalContextBean() {
        text = null;
        vocabRef = null;
    }

    public CulturalContextBean(final net.lab1318.costume.api.models.cultural_context.CulturalContext other) {
    ...
    public boolean equals(final java.lang.Object otherObject) {
        if (otherObject == this) {
            return true;
        } else if (!(otherObject instanceof CulturalContextBean)) {
            return false;
        }
