 ...
 */
public class TextrefRefidBean implements org.thryft.StructBean {
    ...
    public TextrefRefidBean() {
        text = null;
        type = null;
        href = null;
    }

    public TextrefRefidBean(final net.lab1318.costume.api.models.textref.TextrefRefid other) {
    ...
    public boolean equals(final java.lang.Object otherObject) {
        if (otherObject == this) {
            return true;
        } else if (!(otherObject instanceof TextrefRefidBean)) {
            return false;
        }

        final TextrefRefidBean other = (TextrefRefidBean)otherObject;
        return
    ...
    public net.lab1318.costume.api.models.textref.TextrefRefidType getType() {
        return type;
    }
    ...
    public void setType(final net.lab1318.costume.api.models.textref.TextrefRefidType type) {
        this.type = type;
    }

    @Override
    public String toString() {
        return com.google.common.base.MoreObjects.toStringHelper(this).omitNullValues().add("text", getText()).add("type", getType()).add("href", getHref()).toString();
    }
