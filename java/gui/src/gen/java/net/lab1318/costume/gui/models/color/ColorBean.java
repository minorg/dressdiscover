 ...
 */
public class ColorBean implements org.thryft.StructBean {
    ...
    public ColorBean(final net.lab1318.costume.api.models.color.Color other) {
    ...
    public boolean equals(final java.lang.Object otherObject) {
        if (otherObject == this) {
            return true;
        } else if (!(otherObject instanceof ColorBean)) {
            return false;
        }

        final ColorBean other = (ColorBean)otherObject;
        return
    ...
    public net.lab1318.costume.api.models.color.ColorType getType() {
        return type;
    }
    ...
    public void setType(final net.lab1318.costume.api.models.color.ColorType type) {
        this.type = type;
    }
