...
public class TextrefNameBean implements org.thryft.StructBean {
    ...
    public TextrefNameBean() {
        text = null;
        type = null;
    }

    public TextrefNameBean(final net.lab1318.costume.api.models.textref.TextrefName other) {
    ...
    public boolean equals(final java.lang.Object otherObject) {
        if (otherObject == this) {
            return true;
        } else if (!(otherObject instanceof TextrefNameBean)) {
            return false;
        }

        final TextrefNameBean other = (TextrefNameBean)otherObject;
        return
    ...
    public net.lab1318.costume.api.models.textref.TextrefNameType getType() {
        return type;
    }
    ...
    public void setType(final net.lab1318.costume.api.models.textref.TextrefNameType type) {
        this.type = type;
    }
