...
public class CollectionBean implements org.thryft.StructBean {
    ...
    public String toString() {
        return com.google.common.base.MoreObjects.toStringHelper(this).omitNullValues().add("institution_id", getInstitutionId()).add("title", getTitle()).add("description", getDescription()).add("external", getExternal()).add("hidden", getHidden()).add("locations", getLocations()).add("object_store_url", getObjectStoreUrl()).add("url", getUrl()).add("work_types", getWorkTypes()).toString();
    }
