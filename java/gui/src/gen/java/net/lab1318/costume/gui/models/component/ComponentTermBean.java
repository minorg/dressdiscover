...
public class ComponentTermBean implements org.thryft.StructBean {
    ...
    public ComponentTermBean() {
        text = null;
        vocabRef = null;
    }

    public ComponentTermBean(final net.lab1318.costume.api.models.component.ComponentTerm other) {
    ...
    public boolean equals(final java.lang.Object otherObject) {
        if (otherObject == this) {
            return true;
        } else if (!(otherObject instanceof ComponentTermBean)) {
            return false;
        }

        final ComponentTermBean other = (ComponentTermBean)otherObject;
        return
