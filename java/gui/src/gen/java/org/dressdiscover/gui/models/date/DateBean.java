package org.dressdiscover.gui.models.date;
...
public class DateBean implements org.thryft.StructBean {
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        EARLIEST_DATE("earliestDate", new com.google.common.reflect.TypeToken<org.dressdiscover.gui.models.date.DateBoundBean>() {}, true, 1, "earliest_date", org.thryft.protocol.Type.STRUCT),
        LATEST_DATE("latestDate", new com.google.common.reflect.TypeToken<org.dressdiscover.gui.models.date.DateBoundBean>() {}, true, 2, "latest_date", org.thryft.protocol.Type.STRUCT),
        TYPE("type", new com.google.common.reflect.TypeToken<org.dressdiscover.api.models.date.DateType>() {}, true, 3, "type", org.thryft.protocol.Type.STRING),
    ...
    public DateBean(final org.dressdiscover.api.models.date.Date other) {
        this.earliestDate = new org.dressdiscover.gui.models.date.DateBoundBean(other.getEarliestDate());
        this.latestDate = new org.dressdiscover.gui.models.date.DateBoundBean(other.getLatestDate());
    ...
    public org.dressdiscover.gui.models.date.DateBoundBean getEarliestDate() {
        return earliestDate;
    }
    ...
    public org.dressdiscover.gui.models.date.DateBoundBean getLatestDate() {
        return latestDate;
    }
    ...
    public org.dressdiscover.api.models.date.DateType getType() {
        return type;
    }
    ...
    public void setLatestDate(final org.dressdiscover.gui.models.date.DateBoundBean latestDate) {
    ...
    public void setType(final org.dressdiscover.api.models.date.DateType type) {
        this.type = type;
    }
    ...
    private org.dressdiscover.gui.models.date.DateBoundBean earliestDate;

    private org.dressdiscover.gui.models.date.DateBoundBean latestDate;

    private org.dressdiscover.api.models.date.DateType type;
