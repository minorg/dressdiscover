...
public class TitleSetBean implements org.thryft.StructBean {
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        ELEMENTS("elements", new com.google.common.reflect.TypeToken<java.util.List<org.dressdiscover.gui.models.title.TitleBean>>() {}, true, 1, "elements", org.thryft.protocol.Type.LIST),
    ...
    public TitleSetBean(final org.dressdiscover.api.models.title.TitleSet other) {
        this.elements = (new com.google.common.base.Function<com.google.common.collect.ImmutableList<org.dressdiscover.api.models.title.Title>, java.util.List<org.dressdiscover.gui.models.title.TitleBean>>() {
            @Override
            public java.util.List<org.dressdiscover.gui.models.title.TitleBean> apply(final com.google.common.collect.ImmutableList<org.dressdiscover.api.models.title.Title> other) {
                final java.util.List<org.dressdiscover.gui.models.title.TitleBean> copy = new java.util.ArrayList<org.dressdiscover.gui.models.title.TitleBean>();
                for (final org.dressdiscover.api.models.title.Title element : other) {
                    copy.add(new org.dressdiscover.gui.models.title.TitleBean(element));
                }
                return copy;
            }
    ...
    public java.util.List<org.dressdiscover.gui.models.title.TitleBean> getElements() {
        return elements;
    }
    ...
    public void setElements(final java.util.List<org.dressdiscover.gui.models.title.TitleBean> elements) {
    ...
    private java.util.List<org.dressdiscover.gui.models.title.TitleBean> elements;
