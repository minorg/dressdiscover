...
public class RelationBean implements org.thryft.StructBean {
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        ...
        RELIDS("relids", new com.google.common.reflect.TypeToken<java.util.Set<String>>() {}, false, 3, "relids", org.thryft.protocol.Type.SET),
    ...
    public RelationBean(final org.dressdiscover.api.models.relation.Relation other) {
        this.type = other.getType();
        this.href = other.getHref().isPresent() ? other.getHref().get() : null;
        this.relids = other.getRelids().isPresent() ? new java.util.LinkedHashSet<String>(other.getRelids().get()) : null;
    ...
    public java.util.Set<String> getRelids() {
        return relids;
    }
    ...
    public org.dressdiscover.api.models.relation.RelationType getType() {
        return type;
    }
    ...
    public void setRelids(final java.util.Set<String> relids) {
        this.relids = relids;
    }
    ...
    public void setType(final org.dressdiscover.api.models.relation.RelationType type) {
        this.type = type;
    }
    ...
    private java.util.Set<String> relids;
