...
public class AgentDatesBean implements org.thryft.StructBean {
    ...
    public AgentDatesBean(final org.dressdiscover.api.models.agent.AgentDates other) {
    ...
    public org.dressdiscover.api.models.agent.AgentDatesType getType() {
        return type;
    }
    ...
    public void setType(final org.dressdiscover.api.models.agent.AgentDatesType type) {
        this.type = type;
    }
