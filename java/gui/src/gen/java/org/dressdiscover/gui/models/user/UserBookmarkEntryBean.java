...
public class UserBookmarkEntryBean implements org.thryft.StructBean {
    ...
    public enum FieldMetadata implements org.thryft.CompoundType.FieldMetadata {
        ...
        MODEL("model", new com.google.common.reflect.TypeToken<org.dressdiscover.gui.models.user.UserBookmarkBean>() {}, true, 0, "model", org.thryft.protocol.Type.STRUCT);
    ...
    public UserBookmarkEntryBean(final org.dressdiscover.api.models.user.UserBookmarkEntry other) {
        this.id = other.getId();
        this.model = new org.dressdiscover.gui.models.user.UserBookmarkBean(other.getModel());
    }
    ...
    public org.dressdiscover.gui.models.user.UserBookmarkBean getModel() {
        return model;
    }
    ...
    public void setModel(final org.dressdiscover.gui.models.user.UserBookmarkBean model) {
        this.model = model;
    }
    ...
    private org.dressdiscover.gui.models.user.UserBookmarkBean model;
}
