...
public class ConfigurationQueryServiceJsonRpcServlet extends javax.servlet.http.HttpServlet {
    ...
    protected void doPost(final javax.servlet.http.HttpServletRequest httpServletRequest, final javax.servlet.http.HttpServletResponse httpServletResponse) throws java.io.IOException, javax.servlet.ServletException {
        ...
        try {
            ...
            if (messageBegin.getName().equals("get_collection_configuration")) {
                doPostGetCollectionConfiguration(httpServletRequest, httpServletResponse, iprot, messageBegin.getId());
            } else if (messageBegin.getName().equals("get_institution_configuration")) {
                doPostGetInstitutionConfiguration(httpServletRequest, httpServletResponse, iprot, messageBegin.getId());
            } else {
    ...
    public void doPostGetCollectionConfiguration(final javax.servlet.http.HttpServletRequest httpServletRequest, final javax.servlet.http.HttpServletResponse httpServletResponse, final org.thryft.waf.lib.protocol.json.JsonRpcInputProtocol iprot, final Object jsonRpcRequestId) throws java.io.IOException {
        final org.dressdiscover.api.services.configuration.ConfigurationQueryService.Messages.GetCollectionConfigurationRequest serviceRequest;
        try {
        ...
        final org.dressdiscover.api.models.configuration.CollectionConfiguration result;
        try {
            result = service.getCollectionConfiguration(serviceRequest.getCollectionId());
    ...
    public void doPostGetInstitutionConfiguration(final javax.servlet.http.HttpServletRequest httpServletRequest, final javax.servlet.http.HttpServletResponse httpServletResponse, final org.thryft.waf.lib.protocol.json.JsonRpcInputProtocol iprot, final Object jsonRpcRequestId) throws java.io.IOException {
        final org.dressdiscover.api.services.configuration.ConfigurationQueryService.Messages.GetInstitutionConfigurationRequest serviceRequest;
        try {
        ...
        final org.dressdiscover.api.models.configuration.InstitutionConfiguration result;
        try {
