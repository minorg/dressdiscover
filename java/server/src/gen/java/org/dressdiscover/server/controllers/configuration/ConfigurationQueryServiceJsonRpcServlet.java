...
public class ConfigurationQueryServiceJsonRpcServlet extends javax.servlet.http.HttpServlet {
    ...
    public void doPostGetCollectionConfiguration(final javax.servlet.http.HttpServletRequest httpServletRequest, final javax.servlet.http.HttpServletResponse httpServletResponse, final org.thryft.waf.lib.protocols.json.JsonRpcInputProtocol iprot, final Object jsonRpcRequestId) throws java.io.IOException {
        final Messages.GetCollectionConfigurationRequest serviceRequest;
        try {
            serviceRequest = Messages.GetCollectionConfigurationRequest.readAs(iprot, iprot.getCurrentFieldType(), unknownFieldCallback);
    ...
    public void doPostGetInstitutionConfiguration(final javax.servlet.http.HttpServletRequest httpServletRequest, final javax.servlet.http.HttpServletResponse httpServletResponse, final org.thryft.waf.lib.protocols.json.JsonRpcInputProtocol iprot, final Object jsonRpcRequestId) throws java.io.IOException {
        final Messages.GetInstitutionConfigurationRequest serviceRequest;
        try {
            serviceRequest = Messages.GetInstitutionConfigurationRequest.readAs(iprot, iprot.getCurrentFieldType(), unknownFieldCallback);
        } catch (final IllegalArgumentException | org.thryft.protocol.InputProtocolException | NullPointerException e) {
            logger.debug("error deserializing service request: ", e);
            __doPostError(httpServletRequest, httpServletResponse, new org.thryft.waf.lib.protocols.json.JsonRpcErrorResponse(e, -32602, e.getMessage() != null ? e.getMessage() : "invalid JSON-RPC request method parameters"), jsonRpcRequestId);
            return;
