...
public class AnswerQueryServiceJsonRpcServlet extends javax.servlet.http.HttpServlet {
    @com.google.inject.Inject
    public AnswerQueryServiceJsonRpcServlet(final org.dressdiscover.api.services.qa.AnswerQueryService service) {
    ...
    public void doPostGetAnswers(final javax.servlet.http.HttpServletRequest httpServletRequest, final javax.servlet.http.HttpServletResponse httpServletResponse, final org.thryft.waf.lib.protocols.json.JsonRpcInputProtocol iprot, final Object jsonRpcRequestId) throws java.io.IOException {
        final org.dressdiscover.api.services.qa.AnswerQueryService.Messages.GetAnswersRequest serviceRequest;
        try {
            serviceRequest = org.dressdiscover.api.services.qa.AnswerQueryService.Messages.GetAnswersRequest.readAs(iprot, iprot.getCurrentFieldType(), unknownFieldCallback);
    ...
    private final static org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(AnswerQueryServiceJsonRpcServlet.class);
    ...
    private final org.dressdiscover.api.services.qa.AnswerQueryService service;
}
