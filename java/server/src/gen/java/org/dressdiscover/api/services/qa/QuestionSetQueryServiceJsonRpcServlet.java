...
public class QuestionSetQueryServiceJsonRpcServlet extends javax.servlet.http.HttpServlet {
    @com.google.inject.Inject
    public QuestionSetQueryServiceJsonRpcServlet(final org.dressdiscover.api.services.qa.QuestionSetQueryService service) {
    ...
    protected void doPost(final javax.servlet.http.HttpServletRequest httpServletRequest, final javax.servlet.http.HttpServletResponse httpServletResponse) throws java.io.IOException, javax.servlet.ServletException {
        ...
        try {
            ...
            if (messageBegin.getName().equals("get_question_sets")) {
    ...
    public void doPostGetQuestionSets(final javax.servlet.http.HttpServletRequest httpServletRequest, final javax.servlet.http.HttpServletResponse httpServletResponse, final org.thryft.waf.lib.protocols.json.JsonRpcInputProtocol iprot, final Object jsonRpcRequestId) throws java.io.IOException {
        final org.dressdiscover.api.services.qa.QuestionSetQueryService.Messages.GetQuestionSetsRequest serviceRequest;
        try {
            serviceRequest = org.dressdiscover.api.services.qa.QuestionSetQueryService.Messages.GetQuestionSetsRequest.readAs(iprot, iprot.getCurrentFieldType(), unknownFieldCallback);
    ...
    private final static org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(QuestionSetQueryServiceJsonRpcServlet.class);
    ...
    private final org.dressdiscover.api.services.qa.QuestionSetQueryService service;
}
