...
public class QuestionQueryServiceJsonRpcServlet extends javax.servlet.http.HttpServlet {
    @com.google.inject.Inject
    public QuestionQueryServiceJsonRpcServlet(final org.dressdiscover.api.services.qa.QuestionQueryService service) {
    ...
    protected void doPost(final javax.servlet.http.HttpServletRequest httpServletRequest, final javax.servlet.http.HttpServletResponse httpServletResponse) throws java.io.IOException, javax.servlet.ServletException {
        ...
        try {
            ...
            if (messageBegin.getName().equals("get_questions")) {
    ...
    public void doPostGetQuestions(final javax.servlet.http.HttpServletRequest httpServletRequest, final javax.servlet.http.HttpServletResponse httpServletResponse, final org.thryft.waf.lib.protocols.json.JsonRpcInputProtocol iprot, final Object jsonRpcRequestId) throws java.io.IOException {
        final org.dressdiscover.api.services.qa.QuestionQueryService.Messages.GetQuestionsRequest serviceRequest;
        try {
            serviceRequest = org.dressdiscover.api.services.qa.QuestionQueryService.Messages.GetQuestionsRequest.readAs(iprot, iprot.getCurrentFieldType(), unknownFieldCallback);
    ...
    private final static org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(QuestionQueryServiceJsonRpcServlet.class);
    ...
    private final org.dressdiscover.api.services.qa.QuestionQueryService service;
}
