...
public class InstitutionQueryServiceJsonRpcServlet extends javax.servlet.http.HttpServlet {
    ...
    public InstitutionQueryServiceJsonRpcServlet(final net.lab1318.costume.api.services.institution.InstitutionQueryService service) {
    ...
    public void doPostGetInstitutionById(final javax.servlet.http.HttpServletRequest httpServletRequest, final javax.servlet.http.HttpServletResponse httpServletResponse, final org.thryft.protocol.JsonRpcInputProtocol iprot, final Object jsonRpcRequestId) throws java.io.IOException {
        final net.lab1318.costume.api.services.institution.InstitutionQueryService.Messages.GetInstitutionByIdRequest serviceRequest;
        try {
            serviceRequest = net.lab1318.costume.api.services.institution.InstitutionQueryService.Messages.GetInstitutionByIdRequest.readAs(iprot, iprot.getCurrentFieldType());
        ...
        final net.lab1318.costume.api.models.institution.Institution result;
        try {
    ...
    public void doPostGetInstitutions(final javax.servlet.http.HttpServletRequest httpServletRequest, final javax.servlet.http.HttpServletResponse httpServletResponse, final org.thryft.protocol.JsonRpcInputProtocol iprot, final Object jsonRpcRequestId) throws java.io.IOException {
        final com.google.common.collect.ImmutableList<net.lab1318.costume.api.models.institution.InstitutionEntry> result;
        try {
        ...
        final String httpServletResponseBody;
        {
            ...
            try {
                ...
                for (final net.lab1318.costume.api.models.institution.InstitutionEntry _iter0 : result) {
    ...
    public void doPostGetInstitutionsByIds(final javax.servlet.http.HttpServletRequest httpServletRequest, final javax.servlet.http.HttpServletResponse httpServletResponse, final org.thryft.protocol.JsonRpcInputProtocol iprot, final Object jsonRpcRequestId) throws java.io.IOException {
        final net.lab1318.costume.api.services.institution.InstitutionQueryService.Messages.GetInstitutionsByIdsRequest serviceRequest;
        try {
            serviceRequest = net.lab1318.costume.api.services.institution.InstitutionQueryService.Messages.GetInstitutionsByIdsRequest.readAs(iprot, iprot.getCurrentFieldType());
        } catch (final IllegalArgumentException | org.thryft.protocol.InputProtocolException | NullPointerException e) {
            logger.debug("error deserializing service request: ", e);
            __doPostError(httpServletRequest, httpServletResponse, new org.thryft.protocol.JsonRpcErrorResponse(e, -32602, "invalid JSON-RPC request method parameters: " + String.valueOf(e.getMessage())), jsonRpcRequestId);
            return;
        ...
        final com.google.common.collect.ImmutableList<net.lab1318.costume.api.models.institution.Institution> result;
        try {
        ...
        final String httpServletResponseBody;
        {
            ...
            try {
                ...
                oprot.writeMessageBegin("", org.thryft.protocol.MessageType.REPLY, jsonRpcRequestId);
                oprot.writeListBegin(org.thryft.protocol.Type.STRUCT, result.size());
                for (final net.lab1318.costume.api.models.institution.Institution _iter0 : result) {
                    _iter0.writeAsStruct(oprot);
                }
                oprot.writeListEnd();
                oprot.writeMessageEnd();
    ...
    private final net.lab1318.costume.api.services.institution.InstitutionQueryService service;
}
