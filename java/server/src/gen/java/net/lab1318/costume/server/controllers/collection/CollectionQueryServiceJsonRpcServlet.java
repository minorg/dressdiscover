...
public class CollectionQueryServiceJsonRpcServlet extends javax.servlet.http.HttpServlet {
    @com.google.inject.Inject
    public CollectionQueryServiceJsonRpcServlet(final net.lab1318.costume.api.services.collection.CollectionQueryService service) {
    ...
    protected void doPost(final javax.servlet.http.HttpServletRequest httpServletRequest, final javax.servlet.http.HttpServletResponse httpServletResponse) throws java.io.IOException, javax.servlet.ServletException {
        ...
        try {
            ...
            if (messageBegin.getName().equals("get_collection_by_id")) {
                doPostGetCollectionById(httpServletRequest, httpServletResponse, iprot, messageBegin.getId());
            } else if (messageBegin.getName().equals("get_collections")) {
                doPostGetCollections(httpServletRequest, httpServletResponse, iprot, messageBegin.getId());
            } else if (messageBegin.getName().equals("get_collections_by_ids")) {
                doPostGetCollectionsByIds(httpServletRequest, httpServletResponse, iprot, messageBegin.getId());
            } else if (messageBegin.getName().equals("get_collections_by_institution_id")) {
                doPostGetCollectionsByInstitutionId(httpServletRequest, httpServletResponse, iprot, messageBegin.getId());
            } else {
    ...
    public void doPostGetCollectionById(final javax.servlet.http.HttpServletRequest httpServletRequest, final javax.servlet.http.HttpServletResponse httpServletResponse, final org.thryft.protocol.JsonRpcInputProtocol iprot, final Object jsonRpcRequestId) throws java.io.IOException {
        final net.lab1318.costume.api.services.collection.CollectionQueryService.Messages.GetCollectionByIdRequest serviceRequest;
        try {
            serviceRequest = net.lab1318.costume.api.services.collection.CollectionQueryService.Messages.GetCollectionByIdRequest.readAs(iprot, iprot.getCurrentFieldType());
    ...
    public void doPostGetCollections(final javax.servlet.http.HttpServletRequest httpServletRequest, final javax.servlet.http.HttpServletResponse httpServletResponse, final org.thryft.protocol.JsonRpcInputProtocol iprot, final Object jsonRpcRequestId) throws java.io.IOException {
        final com.google.common.collect.ImmutableList<net.lab1318.costume.api.models.collection.CollectionEntry> result;
        try {
            result = service.getCollections();
        } catch (final net.lab1318.costume.api.services.IoException e) {
            __doPostError(httpServletRequest, httpServletResponse, new org.thryft.protocol.JsonRpcErrorResponse(e, 1, e.getClass().getCanonicalName() + ": " + String.valueOf(e.getMessage())), jsonRpcRequestId);
            return;
        }
        ...
        final String httpServletResponseBody;
        {
            ...
            try {
                ...
                for (final net.lab1318.costume.api.models.collection.CollectionEntry _iter0 : result) {
    ...
    public void doPostGetCollectionsByIds(final javax.servlet.http.HttpServletRequest httpServletRequest, final javax.servlet.http.HttpServletResponse httpServletResponse, final org.thryft.protocol.JsonRpcInputProtocol iprot, final Object jsonRpcRequestId) throws java.io.IOException {
        final net.lab1318.costume.api.services.collection.CollectionQueryService.Messages.GetCollectionsByIdsRequest serviceRequest;
        try {
            serviceRequest = net.lab1318.costume.api.services.collection.CollectionQueryService.Messages.GetCollectionsByIdsRequest.readAs(iprot, iprot.getCurrentFieldType());
        } catch (final IllegalArgumentException | org.thryft.protocol.InputProtocolException | NullPointerException e) {
            logger.debug("error deserializing service request: ", e);
            __doPostError(httpServletRequest, httpServletResponse, new org.thryft.protocol.JsonRpcErrorResponse(e, -32602, "invalid JSON-RPC request method parameters: " + String.valueOf(e.getMessage())), jsonRpcRequestId);
            return;
        ...
        final com.google.common.collect.ImmutableList<net.lab1318.costume.api.models.collection.Collection> result;
        try {
            result = service.getCollectionsByIds(serviceRequest.getIds());
        } catch (final net.lab1318.costume.api.services.IoException e) {
            __doPostError(httpServletRequest, httpServletResponse, new org.thryft.protocol.JsonRpcErrorResponse(e, 1, e.getClass().getCanonicalName() + ": " + String.valueOf(e.getMessage())), jsonRpcRequestId);
            return;
        } catch (final net.lab1318.costume.api.services.collection.NoSuchCollectionException e) {
        ...
        final String httpServletResponseBody;
        {
            ...
            try {
                ...
                oprot.writeMessageBegin("", org.thryft.protocol.MessageType.REPLY, jsonRpcRequestId);
                oprot.writeListBegin(org.thryft.protocol.Type.STRUCT, result.size());
                for (final net.lab1318.costume.api.models.collection.Collection _iter0 : result) {
                    _iter0.writeAsStruct(oprot);
                }
                oprot.writeListEnd();
                oprot.writeMessageEnd();
    ...
    public void doPostGetCollectionsByInstitutionId(final javax.servlet.http.HttpServletRequest httpServletRequest, final javax.servlet.http.HttpServletResponse httpServletResponse, final org.thryft.protocol.JsonRpcInputProtocol iprot, final Object jsonRpcRequestId) throws java.io.IOException {
        final net.lab1318.costume.api.services.collection.CollectionQueryService.Messages.GetCollectionsByInstitutionIdRequest serviceRequest;
        try {
            serviceRequest = net.lab1318.costume.api.services.collection.CollectionQueryService.Messages.GetCollectionsByInstitutionIdRequest.readAs(iprot, iprot.getCurrentFieldType());
        } catch (final IllegalArgumentException | org.thryft.protocol.InputProtocolException | NullPointerException e) {
            logger.debug("error deserializing service request: ", e);
            __doPostError(httpServletRequest, httpServletResponse, new org.thryft.protocol.JsonRpcErrorResponse(e, -32602, "invalid JSON-RPC request method parameters: " + String.valueOf(e.getMessage())), jsonRpcRequestId);
            return;
        ...
        final com.google.common.collect.ImmutableList<net.lab1318.costume.api.models.collection.CollectionEntry> result;
        try {
            result = service.getCollectionsByInstitutionId(serviceRequest.getInstitutionId());
        } catch (final net.lab1318.costume.api.services.IoException e) {
            __doPostError(httpServletRequest, httpServletResponse, new org.thryft.protocol.JsonRpcErrorResponse(e, 1, e.getClass().getCanonicalName() + ": " + String.valueOf(e.getMessage())), jsonRpcRequestId);
            return;
        }
    ...
    private final static org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(CollectionQueryServiceJsonRpcServlet.class);
    private final net.lab1318.costume.api.services.collection.CollectionQueryService service;
}
