...
public class ValidatingUserCommandService implements net.lab1318.costume.api.services.user.UserCommandService {
    ...
    @Override
    public final void deleteUserBookmarkById(final org.dressdiscover.api.models.user.UserBookmarkId id) throws net.lab1318.costume.api.services.IoException, net.lab1318.costume.api.services.user.NoSuchUserBookmarkException {
    ...
    @Override
    public final void deleteUserById(final org.dressdiscover.api.models.user.UserId id) throws net.lab1318.costume.api.services.IoException, net.lab1318.costume.api.services.user.NoSuchUserException {
    ...
    @Override
    public final org.dressdiscover.api.models.user.UserId postUser(final net.lab1318.costume.api.models.user.User user) throws net.lab1318.costume.api.services.user.DuplicateUserException, net.lab1318.costume.api.services.IoException {
    ...
    @Override
    public final org.dressdiscover.api.models.user.UserBookmarkId postUserBookmark(final net.lab1318.costume.api.models.user.UserBookmark userBookmark) throws net.lab1318.costume.api.services.user.DuplicateUserBookmarkException, net.lab1318.costume.api.services.IoException {
    ...
    @Override
    public final void putUser(final org.dressdiscover.api.models.user.UserId id, final net.lab1318.costume.api.models.user.User user) throws net.lab1318.costume.api.services.IoException, net.lab1318.costume.api.services.user.NoSuchUserException {
        _validatePutUserParameters(id, user);
        delegate.putUser(id, user);
    }

    protected void _validatePutUserParameters(final org.dressdiscover.api.models.user.UserId id, final net.lab1318.costume.api.models.user.User user) {
