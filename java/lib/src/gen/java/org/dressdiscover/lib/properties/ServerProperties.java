...
public final class ServerProperties implements org.thryft.Struct, org.thryft.waf.lib.Properties {
    ...
    public static class DefaultConstructionValidator implements ConstructionValidator {
        ...
        public String validateGoogleApiKey(final String googleApiKey) throws RuntimeException {
            if (googleApiKey == null) {
                throw new NullPointerException("org.dressdiscover.lib.properties.ServerProperties: googleApiKey is null");
            }
            if (googleApiKey.isEmpty()) {
                throw new IllegalArgumentException("org.dressdiscover.lib.properties.ServerProperties: googleApiKey is less than min length 1");
            }
            return googleApiKey;
        }
        ...
        public String validateGoogleOauthKey(final String googleOauthKey) throws RuntimeException {
            if (googleOauthKey == null) {
                throw new NullPointerException("org.dressdiscover.lib.properties.ServerProperties: googleOauthKey is null");
            }
            if (googleOauthKey.isEmpty()) {
                throw new IllegalArgumentException("org.dressdiscover.lib.properties.ServerProperties: googleOauthKey is less than min length 1");
            }
            return googleOauthKey;
        }
        ...
        public String validateGoogleOauthSecret(final String googleOauthSecret) throws RuntimeException {
            if (googleOauthSecret == null) {
                throw new NullPointerException("org.dressdiscover.lib.properties.ServerProperties: googleOauthSecret is null");
            }
            if (googleOauthSecret.isEmpty()) {
                throw new IllegalArgumentException("org.dressdiscover.lib.properties.ServerProperties: googleOauthSecret is less than min length 1");
            }
            return googleOauthSecret;
        }
    ...
    public static class DefaultReadValidator implements ReadValidator {
        ...
        public String validateGoogleApiKey(final String googleApiKey) throws org.thryft.protocol.InputProtocolException {
            if (googleApiKey == null) {
                throw new org.thryft.protocol.MissingFieldInputProtocolException(FieldMetadata.GOOGLE_API_KEY, "org.dressdiscover.lib.properties.ServerProperties: googleApiKey is null");
            }
            if (googleApiKey.isEmpty()) {
                throw new org.thryft.protocol.InvalidFieldInputProtocolException(FieldMetadata.GOOGLE_API_KEY, "org.dressdiscover.lib.properties.ServerProperties: googleApiKey is less than min length 1");
            }
            return googleApiKey;
        }
        ...
        public String validateGoogleOauthKey(final String googleOauthKey) throws org.thryft.protocol.InputProtocolException {
            if (googleOauthKey == null) {
                throw new org.thryft.protocol.MissingFieldInputProtocolException(FieldMetadata.GOOGLE_OAUTH_KEY, "org.dressdiscover.lib.properties.ServerProperties: googleOauthKey is null");
            }
            if (googleOauthKey.isEmpty()) {
                throw new org.thryft.protocol.InvalidFieldInputProtocolException(FieldMetadata.GOOGLE_OAUTH_KEY, "org.dressdiscover.lib.properties.ServerProperties: googleOauthKey is less than min length 1");
            }
            return googleOauthKey;
        }
        ...
        public String validateGoogleOauthSecret(final String googleOauthSecret) throws org.thryft.protocol.InputProtocolException {
            if (googleOauthSecret == null) {
                throw new org.thryft.protocol.MissingFieldInputProtocolException(FieldMetadata.GOOGLE_OAUTH_SECRET, "org.dressdiscover.lib.properties.ServerProperties: googleOauthSecret is null");
            }
            if (googleOauthSecret.isEmpty()) {
                throw new org.thryft.protocol.InvalidFieldInputProtocolException(FieldMetadata.GOOGLE_OAUTH_SECRET, "org.dressdiscover.lib.properties.ServerProperties: googleOauthSecret is less than min length 1");
            }
            return googleOauthSecret;
        }
    ...
    public void writeAsStruct(final org.thryft.protocol.OutputProtocol oprot) throws org.thryft.protocol.OutputProtocolException {
        oprot.writeStructBegin("org.dressdiscover.lib.properties.ServerProperties");
        writeFields(oprot);
