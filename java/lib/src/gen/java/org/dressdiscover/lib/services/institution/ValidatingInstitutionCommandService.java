...
public class ValidatingInstitutionCommandService implements net.lab1318.costume.api.services.institution.InstitutionCommandService {
    ...
    @Override
    public final void deleteInstitutionById(final org.dressdiscover.api.models.institution.InstitutionId id) throws net.lab1318.costume.api.services.IoException, net.lab1318.costume.api.services.institution.NoSuchInstitutionException {
    ...
    @Override
    public final void putInstitution(final org.dressdiscover.api.models.institution.InstitutionId id, final net.lab1318.costume.api.models.institution.Institution institution) throws net.lab1318.costume.api.services.IoException {
        _validatePutInstitutionParameters(id, institution);
        delegate.putInstitution(id, institution);
    }

    protected void _validatePutInstitutionParameters(final org.dressdiscover.api.models.institution.InstitutionId id, final net.lab1318.costume.api.models.institution.Institution institution) {
