...
public class LoggingWorksheetQueryService implements org.dressdiscover.api.services.worksheet.WorksheetQueryService {
    public final static class WorksheetQueryServiceLogMarkers {
        ...
        static {
            ...
            WORKSHEET_QUERY_SERVICE.add(GET_WORKSHEET_DEFINITION);
    ...
    public org.dressdiscover.api.models.worksheet.WorksheetDefinition getWorksheetDefinition() throws org.dressdiscover.api.services.IoException {
        ...
        __logMessageArgs[__logMessageArgs.length - 1] = PRE_RETURN_VALUE;
        logger.debug(WorksheetQueryServiceLogMarkers.GET_WORKSHEET_DEFINITION, LogMessages.GET_WORKSHEET_DEFINITION, __logMessageArgs);

        try {
            final org.dressdiscover.api.models.worksheet.WorksheetDefinition __returnValue = delegate.getWorksheetDefinition();

            __logMessageArgs[__logMessageArgs.length - 1] = __returnValue;
            logger.info(WorksheetQueryServiceLogMarkers.GET_WORKSHEET_DEFINITION, LogMessages.GET_WORKSHEET_DEFINITION, __logMessageArgs);

            return __returnValue;
        } catch (final org.dressdiscover.api.services.IoException e) {
            __logMessageArgs[__logMessageArgs.length - 1] = e.toString();
            logger.error(WorksheetQueryServiceLogMarkers.GET_WORKSHEET_DEFINITION, LogMessages.GET_WORKSHEET_DEFINITION, __logMessageArgs);
            throw e;
        } catch (final RuntimeException e) {
            __logMessageArgs[__logMessageArgs.length - 1] = e;
            logger.error(WorksheetQueryServiceLogMarkers.GET_WORKSHEET_DEFINITION, LogMessages.GET_WORKSHEET_DEFINITION, __logMessageArgs);
