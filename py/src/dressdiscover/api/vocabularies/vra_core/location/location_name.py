...
import dressdiscover.api.vocabularies.vra_core.location.location_name_type
...
class LocationName(object):
    class Builder(object):
        def __init__(
            ...
            '''
            :type text: str
            :type type: dressdiscover.api.vocabularies.vra_core.location.location_name_type.LocationNameType
        ...
        def set_type(self, type):  # @ReservedAssignment
            ...
            if not isinstance(type, dressdiscover.api.vocabularies.vra_core.location.location_name_type.LocationNameType):
                raise TypeError("expected type to be a dressdiscover.api.vocabularies.vra_core.location.location_name_type.LocationNameType but it is a %s" % getattr(__builtin__, 'type')(type))
            self.__type = type
            return self
        ...
        def type(self):  # @ReservedAssignment
            '''
            :rtype: dressdiscover.api.vocabularies.vra_core.location.location_name_type.LocationNameType
            '''
    ...
    class FieldMetadata(object):
        ...
        @classmethod
        def values(cls):
            return (cls.TEXT, cls.TYPE, cls.EXTENT, cls.VOCAB_REF,)

    FieldMetadata.TEXT = FieldMetadata('text', str, {u'minLength': 1})
    FieldMetadata.TYPE = FieldMetadata('type', dressdiscover.api.vocabularies.vra_core.location.location_name_type.LocationNameType, None)
    ...
    def read(cls, iprot):
        ...
        :rtype: dressdiscover.api.vocabularies.vra_core.location.location_name.LocationName
        '''
        ...
        while True:
            ...
            if ifield_type == 0: # STOP
                ...
                init_kwds['type'] = dressdiscover.api.vocabularies.vra_core.location.location_name_type.LocationNameType.value_of(iprot.read_string().strip().upper())
    ...
    def replace(
        ...
        :type type: dressdiscover.api.vocabularies.vra_core.location.location_name_type.LocationNameType or None
        :type extent: str or None
        :type vocab_ref: dressdiscover.api.models.vocab_ref.VocabRef or None
        :rtype: dressdiscover.api.vocabularies.vra_core.location.location_name.LocationName
        '''
