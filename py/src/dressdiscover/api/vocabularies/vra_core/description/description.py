import __builtin__
import dressdiscover.api.vocabularies.vra_core.description.description_type
...
class Description(object):
    class Builder(object):
        def __init__(
            ...
            :type type: dressdiscover.api.vocabularies.vra_core.description.description_type.DescriptionType or None
            '''
        ...
        def set_type(self, type):  # @ReservedAssignment
            ...
            if type is not None:
                if not isinstance(type, dressdiscover.api.vocabularies.vra_core.description.description_type.DescriptionType):
                    raise TypeError("expected type to be a dressdiscover.api.vocabularies.vra_core.description.description_type.DescriptionType but it is a %s" % getattr(__builtin__, 'type')(type))
            self.__type = type
            return self
        ...
        def type(self):  # @ReservedAssignment
            '''
            :rtype: dressdiscover.api.vocabularies.vra_core.description.description_type.DescriptionType
            '''
    ...
    class FieldMetadata(object):
        ...
        @classmethod
        def values(cls):
            return (cls.TEXT, cls.SOURCE, cls.TYPE,)

    FieldMetadata.TEXT = FieldMetadata('text', str, {u'minLength': 1})
    FieldMetadata.SOURCE = FieldMetadata('source', str, {u'minLength': 1})
    FieldMetadata.TYPE = FieldMetadata('type', dressdiscover.api.vocabularies.vra_core.description.description_type.DescriptionType, None)
    ...
    def __iter__(self):
        return iter((self.text, self.source, self.type,))
    ...
    def read(cls, iprot):
        ...
        :rtype: dressdiscover.api.vocabularies.vra_core.description.description.Description
        '''
        ...
        while True:
            ...
            if ifield_type == 0: # STOP
                ...
                try:
                    init_kwds['type'] = dressdiscover.api.vocabularies.vra_core.description.description_type.DescriptionType.value_of(iprot.read_string().strip().upper())
                except (TypeError,):
                    pass
