...
import dressdiscover.api.vocabularies.vra_core.agent.agent_name_type
...
class AgentName(object):
    class Builder(object):
        def __init__(
            ...
            '''
            :type text: str
            :type type: dressdiscover.api.vocabularies.vra_core.agent.agent_name_type.AgentNameType
        ...
        def set_type(self, type):  # @ReservedAssignment
            ...
            if not isinstance(type, dressdiscover.api.vocabularies.vra_core.agent.agent_name_type.AgentNameType):
                raise TypeError("expected type to be a dressdiscover.api.vocabularies.vra_core.agent.agent_name_type.AgentNameType but it is a %s" % getattr(__builtin__, 'type')(type))
            self.__type = type
            return self
        ...
        def type(self):  # @ReservedAssignment
            '''
            :rtype: dressdiscover.api.vocabularies.vra_core.agent.agent_name_type.AgentNameType
            '''
    ...
    FieldMetadata.TYPE = FieldMetadata('type', dressdiscover.api.vocabularies.vra_core.agent.agent_name_type.AgentNameType, None)
    ...
    def read(cls, iprot):
        ...
        while True:
            ...
            if ifield_type == 0: # STOP
                ...
                init_kwds['type'] = dressdiscover.api.vocabularies.vra_core.agent.agent_name_type.AgentNameType.value_of(iprot.read_string().strip().upper())
    ...
    def replace(
        ...
        :type type: dressdiscover.api.vocabularies.vra_core.agent.agent_name_type.AgentNameType or None
        :type vocab_ref: dressdiscover.api.models.vocab_ref.VocabRef or None
        :rtype: dressdiscover.api.vocabularies.vra_core.agent.agent_name.AgentName
        '''
