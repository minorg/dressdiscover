...
import dressdiscover.api.vocabularies.vra_core.material.material_type
...
class Material(object):
    class Builder(object):
        def __init__(
            ...
            '''
            :type text: str
            :type type: dressdiscover.api.vocabularies.vra_core.material.material_type.MaterialType
        ...
        def build(self):
            return Material(text=self.__text, type=self.__type, vocab_ref=self.__vocab_ref)
        ...
        def set_type(self, type):  # @ReservedAssignment
            ...
            if not isinstance(type, dressdiscover.api.vocabularies.vra_core.material.material_type.MaterialType):
                raise TypeError("expected type to be a dressdiscover.api.vocabularies.vra_core.material.material_type.MaterialType but it is a %s" % getattr(__builtin__, 'type')(type))
            self.__type = type
            return self
        ...
        def type(self):  # @ReservedAssignment
            '''
            :rtype: dressdiscover.api.vocabularies.vra_core.material.material_type.MaterialType
            '''
    ...
    FieldMetadata.TYPE = FieldMetadata('type', dressdiscover.api.vocabularies.vra_core.material.material_type.MaterialType, None)
    ...
    def read(cls, iprot):
        ...
        :rtype: dressdiscover.api.vocabularies.vra_core.material.material.Material
        '''
        ...
        while True:
            ...
            if ifield_type == 0: # STOP
                ...
                init_kwds['type'] = dressdiscover.api.vocabularies.vra_core.material.material_type.MaterialType.value_of(iprot.read_string().strip().upper())
    ...
    def replace(
        ...
        :type type: dressdiscover.api.vocabularies.vra_core.material.material_type.MaterialType or None
        :type vocab_ref: dressdiscover.api.models.vocab_ref.VocabRef or None
        :rtype: dressdiscover.api.vocabularies.vra_core.material.material.Material
        '''
