import __builtin__
import datetime
import dressdiscover.api.vocabularies.vra_core.date.date_time_granularity
...
class DateBound(object):
    class Builder(object):
        def __init__(
            ...
            :type parsed_date_time: datetime.datetime or None
            :type parsed_date_time_granularity: dressdiscover.api.vocabularies.vra_core.date.date_time_granularity.DateTimeGranularity or None
            '''
        ...
        def parsed_date_time_granularity(self):
            '''
            :rtype: dressdiscover.api.vocabularies.vra_core.date.date_time_granularity.DateTimeGranularity
            '''
        ...
        def set_parsed_date_time(self, parsed_date_time):
            ...
            if parsed_date_time is not None:
                if not isinstance(parsed_date_time, datetime.datetime):
                    raise TypeError("expected parsed_date_time to be a datetime.datetime but it is a %s" % getattr(__builtin__, 'type')(parsed_date_time))
            self.__parsed_date_time = parsed_date_time
            return self
        ...
        def set_parsed_date_time_granularity(self, parsed_date_time_granularity):
            ...
            if parsed_date_time_granularity is not None:
                if not isinstance(parsed_date_time_granularity, dressdiscover.api.vocabularies.vra_core.date.date_time_granularity.DateTimeGranularity):
                    raise TypeError("expected parsed_date_time_granularity to be a dressdiscover.api.vocabularies.vra_core.date.date_time_granularity.DateTimeGranularity but it is a %s" % getattr(__builtin__, 'type')(parsed_date_time_granularity))
            self.__parsed_date_time_granularity = parsed_date_time_granularity
            return self
    ...
    class FieldMetadata(object):
        ...
        @classmethod
        def values(cls):
            return (cls.TEXT, cls.CIRCA, cls.PARSED_DATE_TIME, cls.PARSED_DATE_TIME_GRANULARITY,)

    FieldMetadata.TEXT = FieldMetadata('text', str, {u'minLength': 1})
    FieldMetadata.CIRCA = FieldMetadata('circa', bool, None)
    FieldMetadata.PARSED_DATE_TIME = FieldMetadata('parsed_date_time', datetime.datetime, None)
    FieldMetadata.PARSED_DATE_TIME_GRANULARITY = FieldMetadata('parsed_date_time_granularity', dressdiscover.api.vocabularies.vra_core.date.date_time_granularity.DateTimeGranularity, None)
    ...
    def read(cls, iprot):
        ...
        while True:
            ...
            if ifield_type == 0: # STOP
                ...
                try:
                    init_kwds['parsed_date_time_granularity'] = dressdiscover.api.vocabularies.vra_core.date.date_time_granularity.DateTimeGranularity.value_of(iprot.read_string().strip().upper())
                except (TypeError,):
                    pass
