import __builtin__
import dressdiscover.api.vocabularies.vra_core.date.date_bound
import dressdiscover.api.vocabularies.vra_core.date.date_type
...
class Date(object):
    class Builder(object):
        def __init__(
            ...
            '''
            :type earliest_date: dressdiscover.api.vocabularies.vra_core.date.date_bound.DateBound
            :type latest_date: dressdiscover.api.vocabularies.vra_core.date.date_bound.DateBound
            :type type: dressdiscover.api.vocabularies.vra_core.date.date_type.DateType
        ...
        def earliest_date(self):
            '''
            :rtype: dressdiscover.api.vocabularies.vra_core.date.date_bound.DateBound
            '''
        ...
        def set_earliest_date(self, earliest_date):
            ...
            if not isinstance(earliest_date, dressdiscover.api.vocabularies.vra_core.date.date_bound.DateBound):
                raise TypeError("expected earliest_date to be a dressdiscover.api.vocabularies.vra_core.date.date_bound.DateBound but it is a %s" % getattr(__builtin__, 'type')(earliest_date))
            self.__earliest_date = earliest_date
            return self
        ...
        def set_latest_date(self, latest_date):
            ...
            if not isinstance(latest_date, dressdiscover.api.vocabularies.vra_core.date.date_bound.DateBound):
                raise TypeError("expected latest_date to be a dressdiscover.api.vocabularies.vra_core.date.date_bound.DateBound but it is a %s" % getattr(__builtin__, 'type')(latest_date))
            self.__latest_date = latest_date
            return self
        ...
        def set_type(self, type):  # @ReservedAssignment
            ...
            if not isinstance(type, dressdiscover.api.vocabularies.vra_core.date.date_type.DateType):
                raise TypeError("expected type to be a dressdiscover.api.vocabularies.vra_core.date.date_type.DateType but it is a %s" % getattr(__builtin__, 'type')(type))
            self.__type = type
            return self
        ...
        def type(self):  # @ReservedAssignment
            '''
            :rtype: dressdiscover.api.vocabularies.vra_core.date.date_type.DateType
            '''
    ...
    class FieldMetadata(object):
        ...
        @classmethod
        def values(cls):
            return (cls.EARLIEST_DATE, cls.LATEST_DATE, cls.TYPE, cls.HREF, cls.SOURCE,)

    FieldMetadata.EARLIEST_DATE = FieldMetadata('earliest_date', dressdiscover.api.vocabularies.vra_core.date.date_bound.DateBound, None)
    FieldMetadata.LATEST_DATE = FieldMetadata('latest_date', dressdiscover.api.vocabularies.vra_core.date.date_bound.DateBound, None)
    FieldMetadata.TYPE = FieldMetadata('type', dressdiscover.api.vocabularies.vra_core.date.date_type.DateType, None)
    FieldMetadata.HREF = FieldMetadata('href', str, None)
    FieldMetadata.SOURCE = FieldMetadata('source', str, {u'minLength': 1})
    ...
    def read(cls, iprot):
        ...
        :rtype: dressdiscover.api.vocabularies.vra_core.date.date.Date
        '''
        ...
        while True:
            ...
            if ifield_type == 0: # STOP
                ...
                init_kwds['earliest_date'] = dressdiscover.api.vocabularies.vra_core.date.date_bound.DateBound.read(iprot)
            elif ifield_name == 'latest_date' and ifield_id == 2:
                init_kwds['latest_date'] = dressdiscover.api.vocabularies.vra_core.date.date_bound.DateBound.read(iprot)
            elif ifield_name == 'type' and ifield_id == 3:
                init_kwds['type'] = dressdiscover.api.vocabularies.vra_core.date.date_type.DateType.value_of(iprot.read_string().strip().upper())
    ...
    def replace(
        ...
        :type earliest_date: dressdiscover.api.vocabularies.vra_core.date.date_bound.DateBound or None
        :type latest_date: dressdiscover.api.vocabularies.vra_core.date.date_bound.DateBound or None
        :type type: dressdiscover.api.vocabularies.vra_core.date.date_type.DateType or None
        :type href: str or None
        :type source: str or None
        :rtype: dressdiscover.api.vocabularies.vra_core.date.date.Date
        '''
