...
import dressdiscover.api.vocabularies.costume_core.color.color_type
...
class Color(object):
    class Builder(object):
        def __init__(
            ...
            '''
            :type text: str
            :type type: dressdiscover.api.vocabularies.costume_core.color.color_type.ColorType
        ...
        def set_type(self, type):  # @ReservedAssignment
            ...
            if not isinstance(type, dressdiscover.api.vocabularies.costume_core.color.color_type.ColorType):
                raise TypeError("expected type to be a dressdiscover.api.vocabularies.costume_core.color.color_type.ColorType but it is a %s" % getattr(__builtin__, 'type')(type))
            self.__type = type
            return self
        ...
        def type(self):  # @ReservedAssignment
            '''
            :rtype: dressdiscover.api.vocabularies.costume_core.color.color_type.ColorType
            '''
    ...
    FieldMetadata.TYPE = FieldMetadata('type', dressdiscover.api.vocabularies.costume_core.color.color_type.ColorType, None)
    ...
    def read(cls, iprot):
        ...
        :rtype: dressdiscover.api.vocabularies.costume_core.color.color.Color
        '''
        ...
        while True:
            ...
            if ifield_type == 0: # STOP
                ...
                init_kwds['type'] = dressdiscover.api.vocabularies.costume_core.color.color_type.ColorType.value_of(iprot.read_string().strip().upper())
    ...
    def replace(
        ...
        :type type: dressdiscover.api.vocabularies.costume_core.color.color_type.ColorType or None
        :type vocab_ref: dressdiscover.api.models.vocab_ref.VocabRef or None
        :rtype: dressdiscover.api.vocabularies.costume_core.color.color.Color
        '''
