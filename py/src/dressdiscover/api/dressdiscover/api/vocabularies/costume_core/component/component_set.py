...
import __builtin__
import dressdiscover.api.vocabularies.costume_core.component.component
...
class ComponentSet(object):
    class Builder(object):
        def __init__(
            ...
            '''
            :type elements: tuple(dressdiscover.api.vocabularies.costume_core.component.component.Component)
        ...
        def build(self):
            return ComponentSet(elements=self.__elements, display=self.__display, notes=self.__notes)
        ...
        def elements(self):
            '''
            :rtype: tuple(dressdiscover.api.vocabularies.costume_core.component.component.Component)
            '''
        ...
        def set_elements(self, elements):
            ...
            if not (isinstance(elements, tuple) and len(list(ifilterfalse(lambda _: isinstance(_, dressdiscover.api.vocabularies.costume_core.component.component.Component), elements))) == 0):
                raise TypeError("expected elements to be a tuple(dressdiscover.api.vocabularies.costume_core.component.component.Component) but it is a %s" % getattr(__builtin__, 'type')(elements))
            if len(elements) < 1:
        ...
        def update(self, component_set):
            ...
            if isinstance(component_set, ComponentSet):
                self.set_elements(component_set.elements)
                self.set_display(component_set.display)
                self.set_notes(component_set.notes)
            elif isinstance(component_set, dict):
                for key, value in component_set.iteritems():
                    getattr(self, 'set_' + key)(value)
            else:
                raise TypeError(component_set)
            return self
    ...
    def __repr__(self):
        ...
        return 'ComponentSet(' + ', '.join(field_reprs) + ')'
    ...
    def read(cls, iprot):
        ...
        while True:
            ...
            if ifield_type == 0: # STOP
                ...
                init_kwds['elements'] = tuple([dressdiscover.api.vocabularies.costume_core.component.component.Component.read(iprot) for _ in xrange(iprot.read_list_begin()[1])] + (iprot.read_list_end() is None and []))
    ...
    def replace(
        ...
        :type elements: tuple(dressdiscover.api.vocabularies.costume_core.component.component.Component) or None
        :type display: str or None
        :type notes: str or None
        :rtype: dressdiscover.api.vocabularies.costume_core.component.component_set.ComponentSet
        '''
    ...
    def write(self, oprot):
        ...
        oprot.write_struct_begin('ComponentSet')
