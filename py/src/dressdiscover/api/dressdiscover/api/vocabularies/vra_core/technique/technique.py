...
class Technique(object):
    class Builder(object):
        ...
        def build(self):
            return Technique(text=self.__text, vocab_ref=self.__vocab_ref)
        ...
        def update(self, technique):
            ...
            if isinstance(technique, Technique):
                ...
                self.set_vocab_ref(technique.vocab_ref)
    ...
    def read(cls, iprot):
        ...
        :rtype: dressdiscover.api.vocabularies.vra_core.technique.technique.Technique
        '''
