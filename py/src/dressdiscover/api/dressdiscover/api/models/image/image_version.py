...
class ImageVersion(object):
    ...
    class FieldMetadata(object):
        ...
        @classmethod
        def values(cls):
            return (cls.URL, cls.HEIGHT_PX, cls.WIDTH_PX,)

    FieldMetadata.URL = FieldMetadata('url', str, None)
    FieldMetadata.HEIGHT_PX = FieldMetadata('height_px', int, None)
    FieldMetadata.WIDTH_PX = FieldMetadata('width_px', int, None)
    ...
    def read(cls, iprot):
        ...
        while True:
            ...
            if ifield_type == 0: # STOP
                ...
                try:
                    init_kwds['height_px'] = iprot.read_i32()
                except (TypeError, ValueError,):
                    pass
            elif ifield_name == 'width_px' and ifield_id == 3:
                try:
                    init_kwds['width_px'] = iprot.read_i32()
                except (TypeError, ValueError,):
                    pass
    ...
    def write(self, oprot):
        ...
        if self.height_px is not None:
            ...
            oprot.write_i32(self.height_px)
            oprot.write_field_end()

        if self.width_px is not None:
            oprot.write_field_begin(name='width_px', type=8, id=3)
            oprot.write_i32(self.width_px)
            oprot.write_field_end()
