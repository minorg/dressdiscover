...
class GetObjectSummariesResult(object):
    ...
    class FieldMetadata(object):
        ...
        @classmethod
        def values(cls):
            return (cls.HITS, cls.TOTAL_HITS, cls.FACETS,)

    FieldMetadata.HITS = FieldMetadata('hits', tuple, None)
    FieldMetadata.TOTAL_HITS = FieldMetadata('total_hits', int, None)
    FieldMetadata.FACETS = FieldMetadata('facets', dressdiscover.api.models.object.object_facets.ObjectFacets, None)
    ...
    def read(cls, iprot):
        ...
        while True:
            ...
            if ifield_type == 0: # STOP
                ...
                init_kwds['total_hits'] = iprot.read_i32()
    ...
    def write(self, oprot):
        ...
        oprot.write_i32(self.total_hits)
        oprot.write_field_end()
