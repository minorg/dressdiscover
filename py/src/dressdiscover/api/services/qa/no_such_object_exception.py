...
class NoSuchObjectException(Exception):
    class Builder(object):
        ...
        def build(self):
            return NoSuchObjectException(id=self.__id)
        ...
        def update(self, no_such_object_exception):
            '''
            :type id: str or None
            '''

            if isinstance(no_such_object_exception, NoSuchObjectException):
                self.set_id(no_such_object_exception.id)
            elif isinstance(no_such_object_exception, dict):
                for key, value in no_such_object_exception.iteritems():
                    getattr(self, 'set_' + key)(value)
            else:
                raise TypeError(no_such_object_exception)
            return self
    ...
    def read(cls, iprot):
        ...
        :rtype: dressdiscover.api.services.qa.no_such_object_exception.NoSuchObjectException
        '''
