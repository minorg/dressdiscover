import __builtin__
import dressdiscover.api.models.structure.structure_type
...
class Structure(object):
    class Builder(object):
        def __init__(
            ...
            '''
            :type text: str
            :type type: dressdiscover.api.models.structure.structure_type.StructureType
        ...
        def type(self):  # @ReservedAssignment
            '''
            :rtype: dressdiscover.api.models.structure.structure_type.StructureType
            '''
    ...
    def __init__(
        ...
        if not isinstance(type, dressdiscover.api.models.structure.structure_type.StructureType):
            raise TypeError("expected type to be a dressdiscover.api.models.structure.structure_type.StructureType but it is a %s" % getattr(__builtin__, 'type')(type))
        self.__type = type
    ...
    def read(cls, iprot):
        ...
        :rtype: dressdiscover.api.models.structure.structure.Structure
        '''
        ...
        while True:
            ...
            if ifield_type == 0: # STOP
                ...
                init_kwds['type'] = dressdiscover.api.models.structure.structure_type.StructureType.read(iprot)
    ...
    def replace(
        ...
        :type type: dressdiscover.api.models.structure.structure_type.StructureType or None
        :type vocab_ref: dressdiscover.api.models.vocab_ref.VocabRef or None
        :rtype: dressdiscover.api.models.structure.structure.Structure
        '''
