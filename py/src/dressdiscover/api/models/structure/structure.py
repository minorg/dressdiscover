import __builtin__
import costume.api.models.structure.structure_type
...
class Structure(object):
    class Builder(object):
        def __init__(
            ...
            '''
            :type text: str
            :type type: costume.api.models.structure.structure_type.StructureType
        ...
        def type(self):  # @ReservedAssignment
            '''
            :rtype: costume.api.models.structure.structure_type.StructureType
            '''
    ...
    def __init__(
        ...
        if not isinstance(type, costume.api.models.structure.structure_type.StructureType):
            raise TypeError("expected type to be a costume.api.models.structure.structure_type.StructureType but it is a %s" % getattr(__builtin__, 'type')(type))
        self.__type = type
    ...
    def read(cls, iprot):
        ...
        :rtype: costume.api.models.structure.structure.Structure
        '''
        ...
        while True:
            ...
            if ifield_type == 0: # STOP
                ...
                init_kwds['type'] = costume.api.models.structure.structure_type.StructureType.read(iprot)
    ...
    def replace(
        ...
        :type type: costume.api.models.structure.structure_type.StructureType or None
        :type vocab_ref: costume.api.models.vocab_ref.VocabRef or None
        :rtype: costume.api.models.structure.structure.Structure
        '''
