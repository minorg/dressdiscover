...
class InvalidInstitutionIdException(Exception):
    class Builder(object):
        ...
        def build(self):
            return InvalidInstitutionIdException(cause_message=self.__cause_message)
        ...
        def update(self, invalid_institution_id_exception):
            '''
            :type cause_message: str
            '''

            if isinstance(invalid_institution_id_exception, InvalidInstitutionIdException):
                self.set_cause_message(invalid_institution_id_exception.cause_message)
            elif isinstance(invalid_institution_id_exception, dict):
                for key, value in invalid_institution_id_exception.iteritems():
                    getattr(self, 'set_' + key)(value)
            else:
                raise TypeError(invalid_institution_id_exception)
            return self
    ...
    def __repr__(self):
        ...
        return 'InvalidInstitutionIdException(' + ', '.join(field_reprs) + ')'
    ...
    def read(cls, iprot):
        ...
        :rtype: dressdiscover.api.models.institution.invalid_institution_id_exception.InvalidInstitutionIdException
        '''
    ...
    def write(self, oprot):
        ...
        oprot.write_struct_begin('InvalidInstitutionIdException')
