...
class ObjectServiceConfiguration(object):
    class Builder(object):
        ...
        def build(self):
            return ObjectServiceConfiguration(type=self.__type, parameters=self.__parameters)
        ...
        def update(self, object_service_configuration):
            '''
            :type type: str
            :type parameters: dict(str: str) or None
            '''

            if isinstance(object_service_configuration, ObjectServiceConfiguration):
                self.set_type(object_service_configuration.type)
                self.set_parameters(object_service_configuration.parameters)
            elif isinstance(object_service_configuration, dict):
                for key, value in object_service_configuration.iteritems():
                    getattr(self, 'set_' + key)(value)
            else:
                raise TypeError(object_service_configuration)
            return self
    ...
    def __repr__(self):
        ...
        return 'ObjectServiceConfiguration(' + ', '.join(field_reprs) + ')'
    ...
    def write(self, oprot):
        ...
        oprot.write_struct_begin('ObjectServiceConfiguration')
