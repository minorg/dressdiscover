...
class ObjectFacetFilters(object):
    class Builder(object):
        def __init__(
            ...
            :type exclude_genders: frozenset(dressdiscover.api.vocabularies.costume_core.gender.gender.Gender) or None
            ...
            :type include_genders: frozenset(dressdiscover.api.vocabularies.costume_core.gender.gender.Gender) or None
        ...
        def build(self):
            return ObjectFacetFilters(exclude_all=self.__exclude_all, exclude_categories=self.__exclude_categories, exclude_collections=self.__exclude_collections, exclude_color_texts=self.__exclude_color_texts, exclude_cultural_context_texts=self.__exclude_cultural_context_texts, exclude_genders=self.__exclude_genders, exclude_institutions=self.__exclude_institutions, exclude_location_name_texts=self.__exclude_location_name_texts, exclude_material_texts=self.__exclude_material_texts, exclude_subject_term_texts=self.__exclude_subject_term_texts, exclude_technique_texts=self.__exclude_technique_texts, exclude_work_type_texts=self.__exclude_work_type_texts, include_categories=self.__include_categories, include_collections=self.__include_collections, include_color_texts=self.__include_color_texts, include_cultural_context_texts=self.__include_cultural_context_texts, include_genders=self.__include_genders, include_institutions=self.__include_institutions, include_location_name_texts=self.__include_location_name_texts, include_material_texts=self.__include_material_texts, include_subject_term_texts=self.__include_subject_term_texts, include_technique_texts=self.__include_technique_texts, include_work_type_texts=self.__include_work_type_texts)
        ...
        def exclude_genders(self):
            '''
            :rtype: frozenset(dressdiscover.api.vocabularies.costume_core.gender.gender.Gender)
            '''
        ...
        def set_exclude_genders(self, exclude_genders):
            ...
            if exclude_genders is not None:
                if not (isinstance(exclude_genders, frozenset) and len(list(ifilterfalse(lambda _: isinstance(_, dressdiscover.api.vocabularies.costume_core.gender.gender.Gender), exclude_genders))) == 0):
                    raise TypeError("expected exclude_genders to be a frozenset(dressdiscover.api.vocabularies.costume_core.gender.gender.Gender) but it is a %s" % getattr(__builtin__, 'type')(exclude_genders))
        ...
        def set_include_genders(self, include_genders):
            ...
            if include_genders is not None:
                if not (isinstance(include_genders, frozenset) and len(list(ifilterfalse(lambda _: isinstance(_, dressdiscover.api.vocabularies.costume_core.gender.gender.Gender), include_genders))) == 0):
                    raise TypeError("expected include_genders to be a frozenset(dressdiscover.api.vocabularies.costume_core.gender.gender.Gender) but it is a %s" % getattr(__builtin__, 'type')(include_genders))
    ...
    class FieldMetadata(object):
        ...
        @classmethod
        def values(cls):
            return (cls.EXCLUDE_ALL, cls.EXCLUDE_CATEGORIES, cls.EXCLUDE_COLLECTIONS, cls.EXCLUDE_COLOR_TEXTS, cls.EXCLUDE_CULTURAL_CONTEXT_TEXTS, cls.EXCLUDE_GENDERS, cls.EXCLUDE_INSTITUTIONS, cls.EXCLUDE_LOCATION_NAME_TEXTS, cls.EXCLUDE_MATERIAL_TEXTS, cls.EXCLUDE_SUBJECT_TERM_TEXTS, cls.EXCLUDE_TECHNIQUE_TEXTS, cls.EXCLUDE_WORK_TYPE_TEXTS, cls.INCLUDE_CATEGORIES, cls.INCLUDE_COLLECTIONS, cls.INCLUDE_COLOR_TEXTS, cls.INCLUDE_CULTURAL_CONTEXT_TEXTS, cls.INCLUDE_GENDERS, cls.INCLUDE_INSTITUTIONS, cls.INCLUDE_LOCATION_NAME_TEXTS, cls.INCLUDE_MATERIAL_TEXTS, cls.INCLUDE_SUBJECT_TERM_TEXTS, cls.INCLUDE_TECHNIQUE_TEXTS, cls.INCLUDE_WORK_TYPE_TEXTS,)

    FieldMetadata.EXCLUDE_ALL = FieldMetadata('exclude_all', bool, {u'acceptance': True})
    FieldMetadata.EXCLUDE_CATEGORIES = FieldMetadata('exclude_categories', frozenset, {u'minLength': 1})
    FieldMetadata.EXCLUDE_COLLECTIONS = FieldMetadata('exclude_collections', frozenset, {u'minLength': 1})
    FieldMetadata.EXCLUDE_COLOR_TEXTS = FieldMetadata('exclude_color_texts', frozenset, {u'minLength': 1})
    FieldMetadata.EXCLUDE_CULTURAL_CONTEXT_TEXTS = FieldMetadata('exclude_cultural_context_texts', frozenset, {u'minLength': 1})
    FieldMetadata.EXCLUDE_GENDERS = FieldMetadata('exclude_genders', frozenset, {u'minLength': 1})
    FieldMetadata.EXCLUDE_INSTITUTIONS = FieldMetadata('exclude_institutions', frozenset, {u'minLength': 1})
    FieldMetadata.EXCLUDE_LOCATION_NAME_TEXTS = FieldMetadata('exclude_location_name_texts', frozenset, {u'minLength': 1})
    FieldMetadata.EXCLUDE_MATERIAL_TEXTS = FieldMetadata('exclude_material_texts', frozenset, {u'minLength': 1})
    FieldMetadata.EXCLUDE_SUBJECT_TERM_TEXTS = FieldMetadata('exclude_subject_term_texts', frozenset, {u'minLength': 1})
    FieldMetadata.EXCLUDE_TECHNIQUE_TEXTS = FieldMetadata('exclude_technique_texts', frozenset, {u'minLength': 1})
    FieldMetadata.EXCLUDE_WORK_TYPE_TEXTS = FieldMetadata('exclude_work_type_texts', frozenset, {u'minLength': 1})
    FieldMetadata.INCLUDE_CATEGORIES = FieldMetadata('include_categories', frozenset, {u'minLength': 1})
    FieldMetadata.INCLUDE_COLLECTIONS = FieldMetadata('include_collections', frozenset, {u'minLength': 1})
    FieldMetadata.INCLUDE_COLOR_TEXTS = FieldMetadata('include_color_texts', frozenset, {u'minLength': 1})
    FieldMetadata.INCLUDE_CULTURAL_CONTEXT_TEXTS = FieldMetadata('include_cultural_context_texts', frozenset, {u'minLength': 1})
    FieldMetadata.INCLUDE_GENDERS = FieldMetadata('include_genders', frozenset, {u'minLength': 1})
    FieldMetadata.INCLUDE_INSTITUTIONS = FieldMetadata('include_institutions', frozenset, {u'minLength': 1})
    FieldMetadata.INCLUDE_LOCATION_NAME_TEXTS = FieldMetadata('include_location_name_texts', frozenset, {u'minLength': 1})
    FieldMetadata.INCLUDE_MATERIAL_TEXTS = FieldMetadata('include_material_texts', frozenset, {u'minLength': 1})
    FieldMetadata.INCLUDE_SUBJECT_TERM_TEXTS = FieldMetadata('include_subject_term_texts', frozenset, {u'minLength': 1})
    FieldMetadata.INCLUDE_TECHNIQUE_TEXTS = FieldMetadata('include_technique_texts', frozenset, {u'minLength': 1})
    FieldMetadata.INCLUDE_WORK_TYPE_TEXTS = FieldMetadata('include_work_type_texts', frozenset, {u'minLength': 1})
