    ...
    def read(cls, iprot):
        ...
        while True:
            ...
            if ifield_type == 0: # STOP
                ...
                try:
                    init_kwds['more_like_object_id'] = dressdiscover.api.models.object.object_id.ObjectId.parse(iprot.read_string())
                except (dressdiscover.api.models.object.InvalidObjectIdException,):
                    pass
            elif ifield_name == 'object_ids':
                init_kwds['object_ids'] = frozenset([dressdiscover.api.models.object.object_id.ObjectId.parse(iprot.read_string()) for _ in xrange(iprot.read_set_begin()[1])] + (iprot.read_set_end() is None and []))
