import __builtin__
import dressdiscover.api.models.subject.subject_term_type
...
class SubjectTerm(object):
    class Builder(object):
        def __init__(
            ...
            '''
            :type text: str
            :type type: dressdiscover.api.models.subject.subject_term_type.SubjectTermType
        ...
        def type(self):  # @ReservedAssignment
            '''
            :rtype: dressdiscover.api.models.subject.subject_term_type.SubjectTermType
            '''
    ...
    def __init__(
        ...
        if not isinstance(type, dressdiscover.api.models.subject.subject_term_type.SubjectTermType):
            raise TypeError("expected type to be a dressdiscover.api.models.subject.subject_term_type.SubjectTermType but it is a %s" % getattr(__builtin__, 'type')(type))
        self.__type = type
    ...
    def read(cls, iprot):
        ...
        :rtype: dressdiscover.api.models.subject.subject_term.SubjectTerm
        '''
        ...
        while True:
            ...
            if ifield_type == 0: # STOP
                ...
                init_kwds['type'] = dressdiscover.api.models.subject.subject_term_type.SubjectTermType.value_of(iprot.read_string().strip().upper())
    ...
    def replace(
        ...
        :type type: dressdiscover.api.models.subject.subject_term_type.SubjectTermType or None
        :type vocab_ref: dressdiscover.api.models.vocab_ref.VocabRef or None
        :rtype: dressdiscover.api.models.subject.subject_term.SubjectTerm
        '''
