...
class InvalidUserIdException(Exception):
    class Builder(object):
        ...
        def build(self):
            return InvalidUserIdException(cause_message=self.__cause_message)
        ...
        def update(self, invalid_user_id_exception):
            '''
            :type cause_message: str
            '''

            if isinstance(invalid_user_id_exception, InvalidUserIdException):
                self.set_cause_message(invalid_user_id_exception.cause_message)
            elif isinstance(invalid_user_id_exception, dict):
                for key, value in invalid_user_id_exception.iteritems():
                    getattr(self, 'set_' + key)(value)
            else:
                raise TypeError(invalid_user_id_exception)
            return self
    ...
    def __repr__(self):
        ...
        return 'InvalidUserIdException(' + ', '.join(field_reprs) + ')'
    ...
    def read(cls, iprot):
        ...
        :rtype: dressdiscover.api.models.user.invalid_user_id_exception.InvalidUserIdException
        '''
    ...
    def write(self, oprot):
        ...
        oprot.write_struct_begin('InvalidUserIdException')
