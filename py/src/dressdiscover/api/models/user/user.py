...
class User(object):
    class Builder(object):
        ...
        def set_ctime(self, ctime):
            ...
            if not isinstance(ctime, datetime.datetime):
                raise TypeError("expected ctime to be a datetime.datetime but it is a %s" % getattr(__builtin__, 'type')(ctime))
            self.__ctime = ctime
            return self
    ...
    class FieldMetadata(object):
        ...
        @classmethod
        def values(cls):
            return (cls.CTIME, cls.EMAIL_ADDRESS,)

    FieldMetadata.CTIME = FieldMetadata('ctime', datetime.datetime, None)
    FieldMetadata.EMAIL_ADDRESS = FieldMetadata('email_address', str, None)
    ...
    def replace(
        ...
        :type ctime: datetime.datetime or None
