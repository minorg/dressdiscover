...
class UserBookmark(object):
    ...
    class FieldMetadata(object):
        ...
        @classmethod
        def values(cls):
            return (cls.NAME, cls.USER_ID, cls.FOLDER, cls.OBJECT_ID, cls.OBJECT_QUERY,)
    ...
    def read(cls, iprot):
        ...
        while True:
            ...
            if ifield_type == 0: # STOP
                ...
                try:
                    init_kwds['object_id'] = dressdiscover.api.models.object.object_id.ObjectId.parse(iprot.read_string())
