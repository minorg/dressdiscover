...
class UserEntry(object):
    class Builder(object):
        def __init__(
            ...
            '''
            :type id: str
            :type model: costume.api.models.user.user.User
            '''
    ...
    def __init__(
        ...
        if not isinstance(model, costume.api.models.user.user.User):
            raise TypeError("expected model to be a costume.api.models.user.user.User but it is a %s" % getattr(__builtin__, 'type')(model))
        self.__model = model
    ...
    def read(cls, iprot):
        ...
        while True:
            ...
            if ifield_type == 0: # STOP
                ...
                init_kwds['model'] = costume.api.models.user.user.User.read(iprot)
    ...
    def replace(
        ...
        :type id: str or None
        :type model: costume.api.models.user.user.User or None
        :rtype: costume.api.models.user.user_entry.UserEntry
        '''
