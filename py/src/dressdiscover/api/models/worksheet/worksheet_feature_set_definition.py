...
class WorksheetFeatureSetDefinition(object):
    class Builder(object):
        ...
        def build(self):
            return WorksheetFeatureSetDefinition(feature_ids=self.__feature_ids, id=self.__id, display_name=self.__display_name, extent_ids=self.__extent_ids)
    ...
    class FieldMetadata(object):
        ...
        @classmethod
        def values(cls):
            return (cls.FEATURE_IDS, cls.ID, cls.DISPLAY_NAME, cls.EXTENT_IDS,)
    ...
    def __hash__(self):
        return hash((self.feature_ids, self.id, self.display_name, self.extent_ids,))

    def __iter__(self):
        return iter((self.feature_ids, self.id, self.display_name, self.extent_ids,))
