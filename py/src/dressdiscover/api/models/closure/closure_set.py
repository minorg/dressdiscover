...
import __builtin__
import costume.api.models.closure.closure
...
class ClosureSet(object):
    class Builder(object):
        ...
        def elements(self):
            '''
            :rtype: tuple(costume.api.models.closure.closure.Closure)
            '''
    ...
    def read(cls, iprot):
        ...
        while True:
            ...
            if ifield_type == 0: # STOP
                ...
                init_kwds['elements'] = tuple([costume.api.models.closure.closure.Closure.read(iprot) for _ in xrange(iprot.read_list_begin()[1])] + (iprot.read_list_end() is None and []))
    ...
    def replace(
        ...
        :type elements: tuple(costume.api.models.closure.closure.Closure) or None
        :type display: str or None
        :type notes: str or None
        :rtype: costume.api.models.closure.closure_set.ClosureSet
        '''
