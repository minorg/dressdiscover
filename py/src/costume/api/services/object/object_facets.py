...
class ObjectFacets(object):
    class Builder(object):
        ...
        def build(self):
            return ObjectFacets(collection_hits=self.__collection_hits, institution_hits=self.__institution_hits)
    ...
    def __hash__(self):
        return hash((self.collection_hits,self.institution_hits,))
    ...
    def as_dict(self):
        ...
        return {'collection_hits': self.collection_hits, 'institution_hits': self.institution_hits}
    ...
    def as_tuple(self):
        ...
        return (self.collection_hits, self.institution_hits,)
    ...
    def replace(
        ...
        return self.__class__(collection_hits=collection_hits, institution_hits=institution_hits)
