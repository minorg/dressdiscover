...
class ObjectSummary(object):
    ...
    def __hash__(self):
        return hash((self.collection_id,self.institution_id,self.model_metadata,self.title,self.agent_name_texts,self.categories,self.color_texts,self.cultural_context_texts,self.date,self.description,self.gender,self.relation_texts,self.material_texts,self.subject_term_texts,self.technique_texts,self.thumbnail,self.url,self.work_type_texts,))
