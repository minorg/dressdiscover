namespace DressDiscover.Api.Models.Worksheet
{
    public sealed class WorksheetRights
    {
        ...
        public static WorksheetRights FromBuiltins(System.Collections.Generic.IDictionary<string, object> _dictionary)
        {
            string author= null;
            string license= null;
        ...
        public static WorksheetRights FromJson(Newtonsoft.Json.Linq.JObject _dictionary)
        {
            string author= null;
            string license= null;
            string sourceName= null;
