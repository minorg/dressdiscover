namespace DressDiscover.Api.Services.Worksheet
{
    public sealed class NoSuchWorksheetFeatureSetDefinitionException : System.Exception
    {
        ...
        public static NoSuchWorksheetFeatureSetDefinitionException FromBuiltins(System.Collections.Generic.IDictionary<string, object> _dictionary)
        {
            string id= null;
        ...
        public static NoSuchWorksheetFeatureSetDefinitionException FromJson(Newtonsoft.Json.Linq.JObject _dictionary)
        {
            string id= null;
