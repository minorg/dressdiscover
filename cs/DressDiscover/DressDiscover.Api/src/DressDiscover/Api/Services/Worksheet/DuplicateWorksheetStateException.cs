namespace DressDiscover.Api.Services.Worksheet
{
    public sealed class DuplicateWorksheetStateException : System.Exception
    {
        ...
        public static DuplicateWorksheetStateException FromBuiltins(System.Collections.Generic.IDictionary<string, object> _dictionary)
        {
            string id= null;
        ...
        public static DuplicateWorksheetStateException FromJson(Newtonsoft.Json.Linq.JObject _dictionary)
        {
            string id= null;
